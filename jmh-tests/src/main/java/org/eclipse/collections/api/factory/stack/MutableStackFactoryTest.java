...
public class MutableStackFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private MutableStackFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableStackFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableStackFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableStackFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableStackFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableStackFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableStackFactoryTest> ofAllReversed;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableStackFactoryTest::with;
            this.payloads.of = MutableStackFactoryTest::of;
            this.payloads.ofAll = MutableStackFactoryTest::ofAll;
