...
public class MutableFloatLongMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private MutableFloatLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableFloatLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableFloatLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableFloatLongMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableFloatLongMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableFloatLongMapFactoryTest::with;
            this.payloads.of = MutableFloatLongMapFactoryTest::of;
        }
    }
}
