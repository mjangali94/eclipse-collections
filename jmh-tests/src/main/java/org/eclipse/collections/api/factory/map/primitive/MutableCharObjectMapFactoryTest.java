...
public class MutableCharObjectMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private MutableCharObjectMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableCharObjectMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableCharObjectMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableCharObjectMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableCharObjectMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableCharObjectMapFactoryTest::with;
            this.payloads.of = MutableCharObjectMapFactoryTest::of;
        }
    }
}
