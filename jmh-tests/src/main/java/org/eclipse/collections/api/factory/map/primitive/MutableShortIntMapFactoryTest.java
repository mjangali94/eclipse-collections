...
public class MutableShortIntMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private MutableShortIntMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableShortIntMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableShortIntMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableShortIntMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableShortIntMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableShortIntMapFactoryTest::with;
            this.payloads.of = MutableShortIntMapFactoryTest::of;
        }
    }
}
