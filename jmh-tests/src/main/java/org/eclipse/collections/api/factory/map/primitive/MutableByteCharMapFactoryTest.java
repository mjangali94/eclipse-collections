...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableByteCharMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteCharMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableByteCharMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteCharMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteCharMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableByteCharMapFactoryTest::with;
            this.payloads.of = MutableByteCharMapFactoryTest::of;
        }
    }
*/
}
