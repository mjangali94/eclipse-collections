...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableByteShortMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteShortMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableByteShortMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteShortMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByteShortMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableByteShortMapFactoryTest::with;
            this.payloads.of = MutableByteShortMapFactoryTest::of;
        }
    }
*/
}
