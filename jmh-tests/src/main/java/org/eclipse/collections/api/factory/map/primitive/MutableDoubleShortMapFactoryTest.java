...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableDoubleShortMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableDoubleShortMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableDoubleShortMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableDoubleShortMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableDoubleShortMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableDoubleShortMapFactoryTest::with;
            this.payloads.of = MutableDoubleShortMapFactoryTest::of;
        }
    }
*/
}
