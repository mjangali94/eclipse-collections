...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableLongFloatMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongFloatMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableLongFloatMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongFloatMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongFloatMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableLongFloatMapFactoryTest::with;
            this.payloads.of = MutableLongFloatMapFactoryTest::of;
        }
    }
*/
}
