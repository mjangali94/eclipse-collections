...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableLongLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new MutableLongLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongLongMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableLongLongMapFactoryTest> of;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.with = MutableLongLongMapFactoryTest::with;
            this.payloads.of = MutableLongLongMapFactoryTest::of;
        }
    }
*/
}
