...
public class ObjectBooleanHashMapWithHashingStrategyKeyValuesViewTest extends AbstractObjectBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractObjectBooleanMapKeyValuesViewTestCase._Benchmark {

        private ObjectBooleanHashMapWithHashingStrategyKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectBooleanHashMapWithHashingStrategyKeyValuesViewTest();
        }

        @java.lang.Override
        public ObjectBooleanHashMapWithHashingStrategyKeyValuesViewTest implementation() {
