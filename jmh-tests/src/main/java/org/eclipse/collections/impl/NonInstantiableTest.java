...
public class NonInstantiableTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<NonInstantiableTest> payload) throws java.lang.Throwable {
            this.instance = new NonInstantiableTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<NonInstantiableTest> generatedNonInstantiableClassesThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<NonInstantiableTest> handCodedNonInstantiableClassesThrow;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.generatedNonInstantiableClassesThrow = NonInstantiableTest::generatedNonInstantiableClassesThrow;
