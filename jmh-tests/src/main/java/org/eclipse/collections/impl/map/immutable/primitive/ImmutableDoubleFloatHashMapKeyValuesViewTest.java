...
public class ImmutableDoubleFloatHashMapKeyValuesViewTest extends AbstractDoubleFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableDoubleFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableDoubleFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableDoubleFloatHashMapKeyValuesViewTest implementation() {
