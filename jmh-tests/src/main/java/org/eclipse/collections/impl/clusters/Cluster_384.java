    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.bag.immutable.ImmutableArrayBagTest._Benchmark _Benchmark_benchmark_4;
        ...
        public void benchmark_Cluster_384() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.clear);
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.toImmutable);
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.add);
        }
