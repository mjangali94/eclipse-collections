...
public abstract class AbstractImmutableMultimapTestCase {
    ...
    public static class _Benchmark {
        ...
        private AbstractImmutableMultimapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractImmutableMultimapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> allowDuplicates;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> noDuplicates;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> toMap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> newWithout;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> newWithAll_newWithoutAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> testSerialization;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> selectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> rejectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> selectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> rejectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> collectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> collectKeyMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> collectValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractImmutableMultimapTestCase> flip;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.size = AbstractImmutableMultimapTestCase::size;
            this.payloads.allowDuplicates = AbstractImmutableMultimapTestCase::allowDuplicates;
            this.payloads.noDuplicates = AbstractImmutableMultimapTestCase::noDuplicates;
            this.payloads.isEmpty = AbstractImmutableMultimapTestCase::isEmpty;
            this.payloads.keySet = AbstractImmutableMultimapTestCase::keySet;
            this.payloads.get = AbstractImmutableMultimapTestCase::get;
            this.payloads.toMap = AbstractImmutableMultimapTestCase::toMap;
            this.payloads.newWithout = AbstractImmutableMultimapTestCase::newWithout;
            this.payloads.newWithAll_newWithoutAll = AbstractImmutableMultimapTestCase::newWithAll_newWithoutAll;
            this.payloads.toImmutable = AbstractImmutableMultimapTestCase::toImmutable;
            this.payloads.testSerialization = AbstractImmutableMultimapTestCase::testSerialization;
            this.payloads.selectKeysValues = AbstractImmutableMultimapTestCase::selectKeysValues;
            this.payloads.rejectKeysValues = AbstractImmutableMultimapTestCase::rejectKeysValues;
            this.payloads.selectKeysMultiValues = AbstractImmutableMultimapTestCase::selectKeysMultiValues;
            this.payloads.rejectKeysMultiValues = AbstractImmutableMultimapTestCase::rejectKeysMultiValues;
            this.payloads.collectKeysValues = AbstractImmutableMultimapTestCase::collectKeysValues;
            this.payloads.collectKeyMultiValues = AbstractImmutableMultimapTestCase::collectKeyMultiValues;
            this.payloads.collectValues = AbstractImmutableMultimapTestCase::collectValues;
            this.payloads.flip = AbstractImmutableMultimapTestCase::flip;
        }
    }
}
