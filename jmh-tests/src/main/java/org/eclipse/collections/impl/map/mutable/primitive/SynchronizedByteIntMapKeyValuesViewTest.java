...
public class SynchronizedByteIntMapKeyValuesViewTest extends AbstractByteIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedByteIntMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedByteIntMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedByteIntMapKeyValuesViewTest implementation() {
