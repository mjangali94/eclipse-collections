...
public class ImmutableLongObjectMapKeyValuesViewTest extends AbstractLongObjectMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongObjectMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableLongObjectMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableLongObjectMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableLongObjectMapKeyValuesViewTest implementation() {
