...
public final class MutableFloat extends Number implements Comparable<MutableFloat> {
    ...
    public static class _Benchmark {
        ...
        private MutableFloat instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableFloat> payload) throws java.lang.Throwable {
            this.instance = new MutableFloat();
