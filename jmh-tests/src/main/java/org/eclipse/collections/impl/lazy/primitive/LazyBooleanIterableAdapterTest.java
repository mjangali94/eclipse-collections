...
/*
    ...
    public static class _Benchmark {
        ...
        private LazyBooleanIterableAdapterTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> payload) throws java.lang.Throwable {
            this.instance = new LazyBooleanIterableAdapterTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> booleanIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> empty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> detectIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> lazyCollectPrimitives;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> containsAllArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> containsAllIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LazyBooleanIterableAdapterTest> toBag;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.booleanIterator = LazyBooleanIterableAdapterTest::booleanIterator;
            this.payloads.forEach = LazyBooleanIterableAdapterTest::forEach;
            this.payloads.size = LazyBooleanIterableAdapterTest::size;
            this.payloads.empty = LazyBooleanIterableAdapterTest::empty;
            this.payloads.count = LazyBooleanIterableAdapterTest::count;
            this.payloads.anySatisfy = LazyBooleanIterableAdapterTest::anySatisfy;
            this.payloads.allSatisfy = LazyBooleanIterableAdapterTest::allSatisfy;
            this.payloads.select = LazyBooleanIterableAdapterTest::select;
            this.payloads.reject = LazyBooleanIterableAdapterTest::reject;
            this.payloads.detectIfNone = LazyBooleanIterableAdapterTest::detectIfNone;
            this.payloads.collect = LazyBooleanIterableAdapterTest::collect;
            this.payloads.lazyCollectPrimitives = LazyBooleanIterableAdapterTest::lazyCollectPrimitives;
            this.payloads.toArray = LazyBooleanIterableAdapterTest::toArray;
            this.payloads.contains = LazyBooleanIterableAdapterTest::contains;
            this.payloads.containsAllArray = LazyBooleanIterableAdapterTest::containsAllArray;
            this.payloads.containsAllIterable = LazyBooleanIterableAdapterTest::containsAllIterable;
            this.payloads.toList = LazyBooleanIterableAdapterTest::toList;
            this.payloads.toSet = LazyBooleanIterableAdapterTest::toSet;
