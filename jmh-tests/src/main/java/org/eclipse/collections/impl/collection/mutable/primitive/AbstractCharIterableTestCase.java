...
public abstract class AbstractCharIterableTestCase {
    ...
    public static class _Benchmark {
        ...
        private AbstractCharIterableTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractCharIterableTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> newCollectionWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> newCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> tap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsAllArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsAllIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsAnyArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsAnyIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsNoneArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> containsNoneIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> charIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> charIterator_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> charIterator_throws_non_empty_collection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> collectWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> flatCollectWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> flatCollectIterableWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> collectPrimitivesToLists;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> collectPrimitivesToSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> selectWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> rejectWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> detectIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> max_throws_emptyCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> min_throws_emptyCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> summaryStatistics;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> averageIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> medianIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toArrayWithTargetArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSortedListByComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSortedListByFunctionNaturalOrder;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSortedListByFunctionWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectInto;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoBoolean;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoByte;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoChar;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoShort;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> injectIntoDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> reduceOnEmptyThrows;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> reduce;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> reduceIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharIterableTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.newCollectionWith = AbstractCharIterableTestCase::newCollectionWith;
            this.payloads.newCollection = AbstractCharIterableTestCase::newCollection;
            this.payloads.isEmpty = AbstractCharIterableTestCase::isEmpty;
            this.payloads.notEmpty = AbstractCharIterableTestCase::notEmpty;
            this.payloads.tap = AbstractCharIterableTestCase::tap;
            this.payloads.contains = AbstractCharIterableTestCase::contains;
            this.payloads.containsAllArray = AbstractCharIterableTestCase::containsAllArray;
            this.payloads.containsAllIterable = AbstractCharIterableTestCase::containsAllIterable;
            this.payloads.containsAnyArray = AbstractCharIterableTestCase::containsAnyArray;
            this.payloads.containsAnyIterable = AbstractCharIterableTestCase::containsAnyIterable;
            this.payloads.containsNoneArray = AbstractCharIterableTestCase::containsNoneArray;
            this.payloads.containsNoneIterable = AbstractCharIterableTestCase::containsNoneIterable;
            this.payloads.charIterator = AbstractCharIterableTestCase::charIterator;
            this.payloads.charIterator_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::charIterator_throws, java.util.NoSuchElementException.class);
            this.payloads.charIterator_throws_non_empty_collection = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::charIterator_throws_non_empty_collection, java.util.NoSuchElementException.class);
            this.payloads.forEach = AbstractCharIterableTestCase::forEach;
            this.payloads.size = AbstractCharIterableTestCase::size;
            this.payloads.count = AbstractCharIterableTestCase::count;
            this.payloads.anySatisfy = AbstractCharIterableTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractCharIterableTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractCharIterableTestCase::noneSatisfy;
            this.payloads.collect = AbstractCharIterableTestCase::collect;
            this.payloads.collectWithTarget = AbstractCharIterableTestCase::collectWithTarget;
            this.payloads.flatCollectWithTarget = AbstractCharIterableTestCase::flatCollectWithTarget;
            this.payloads.flatCollectIterableWithTarget = AbstractCharIterableTestCase::flatCollectIterableWithTarget;
            this.payloads.collectPrimitivesToLists = AbstractCharIterableTestCase::collectPrimitivesToLists;
            this.payloads.collectPrimitivesToSets = AbstractCharIterableTestCase::collectPrimitivesToSets;
            this.payloads.select = AbstractCharIterableTestCase::select;
            this.payloads.selectWithTarget = AbstractCharIterableTestCase::selectWithTarget;
            this.payloads.reject = AbstractCharIterableTestCase::reject;
            this.payloads.rejectWithTarget = AbstractCharIterableTestCase::rejectWithTarget;
            this.payloads.detectIfNone = AbstractCharIterableTestCase::detectIfNone;
            this.payloads.max = AbstractCharIterableTestCase::max;
            this.payloads.max_throws_emptyCollection = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::max_throws_emptyCollection, java.util.NoSuchElementException.class);
            this.payloads.min = AbstractCharIterableTestCase::min;
            this.payloads.min_throws_emptyCollection = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::min_throws_emptyCollection, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractCharIterableTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractCharIterableTestCase::maxIfEmpty;
            this.payloads.sum = AbstractCharIterableTestCase::sum;
            this.payloads.summaryStatistics = AbstractCharIterableTestCase::summaryStatistics;
            this.payloads.average = AbstractCharIterableTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.averageIfEmpty = AbstractCharIterableTestCase::averageIfEmpty;
            this.payloads.median = AbstractCharIterableTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.medianIfEmpty = AbstractCharIterableTestCase::medianIfEmpty;
            this.payloads.toArray = AbstractCharIterableTestCase::toArray;
            this.payloads.toArrayWithTargetArray = AbstractCharIterableTestCase::toArrayWithTargetArray;
            this.payloads.toSortedArray = AbstractCharIterableTestCase::toSortedArray;
            this.payloads.testEquals = AbstractCharIterableTestCase::testEquals;
            this.payloads.testHashCode = AbstractCharIterableTestCase::testHashCode;
            this.payloads.testToString = AbstractCharIterableTestCase::testToString;
            this.payloads.makeString = AbstractCharIterableTestCase::makeString;
            this.payloads.appendString = AbstractCharIterableTestCase::appendString;
            this.payloads.toList = AbstractCharIterableTestCase::toList;
            this.payloads.toSortedList = AbstractCharIterableTestCase::toSortedList;
            this.payloads.toSortedListByComparator = AbstractCharIterableTestCase::toSortedListByComparator;
            this.payloads.toSortedListByFunctionNaturalOrder = AbstractCharIterableTestCase::toSortedListByFunctionNaturalOrder;
            this.payloads.toSortedListByFunctionWithComparator = AbstractCharIterableTestCase::toSortedListByFunctionWithComparator;
            this.payloads.toSet = AbstractCharIterableTestCase::toSet;
            this.payloads.toBag = AbstractCharIterableTestCase::toBag;
            this.payloads.asLazy = AbstractCharIterableTestCase::asLazy;
            this.payloads.injectInto = AbstractCharIterableTestCase::injectInto;
            this.payloads.injectIntoBoolean = AbstractCharIterableTestCase::injectIntoBoolean;
            this.payloads.injectIntoByte = AbstractCharIterableTestCase::injectIntoByte;
            this.payloads.injectIntoChar = AbstractCharIterableTestCase::injectIntoChar;
            this.payloads.injectIntoShort = AbstractCharIterableTestCase::injectIntoShort;
            this.payloads.injectIntoInt = AbstractCharIterableTestCase::injectIntoInt;
            this.payloads.injectIntoFloat = AbstractCharIterableTestCase::injectIntoFloat;
            this.payloads.injectIntoLong = AbstractCharIterableTestCase::injectIntoLong;
            this.payloads.injectIntoDouble = AbstractCharIterableTestCase::injectIntoDouble;
            this.payloads.reduceOnEmptyThrows = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharIterableTestCase::reduceOnEmptyThrows, java.util.NoSuchElementException.class);
            this.payloads.reduce = AbstractCharIterableTestCase::reduce;
            this.payloads.reduceIfEmpty = AbstractCharIterableTestCase::reduceIfEmpty;
