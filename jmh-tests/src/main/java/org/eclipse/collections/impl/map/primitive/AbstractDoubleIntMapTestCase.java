...
public abstract class AbstractDoubleIntMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 31.0, 32.0), this.newWithKeysValues(0.0, 0, 31.0, 31, 32.0, 32).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0.0, 0, 1.0, 1, 32.0, 32).hashCode(), this.newWithKeysValues(32.0, 32, 0.0, 0, 1.0, 1).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50.0, 0, 60.0, 1, 70.0, 33).hashCode(), this.newWithKeysValues(50.0, 0, 60.0, 1, 70.0, 33).hashCode());
    ...
    public void injectIntoKeyValue() {
        DoubleIntMap map0 = this.newWithKeysValues(0.0, 1, 3.0, 4);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, double eachKey, int eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        DoubleIntMap copy = map0.injectIntoKeyValue(DoubleIntMaps.mutable.empty(), MutableDoubleIntMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0, 2, 3.0, 3).toList().equals(IntArrayList.newListWith(2, 3)) || this.newWithKeysValues(2.0, 2, 3.0, 3).toList().equals(IntArrayList.newListWith(3, 2)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(IntBags.mutable.with(1)).toSet(), this.newWithKeysValues(1.0, 1).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0, 1).chunk(-1));
    }
    ...
    public static class _Benchmark {
        ...
        private AbstractDoubleIntMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractDoubleIntMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> intIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleIntMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractDoubleIntMapTestCase::keySet;
            this.payloads.values = AbstractDoubleIntMapTestCase::values;
            this.payloads.get = AbstractDoubleIntMapTestCase::get;
            this.payloads.getIfAbsent = AbstractDoubleIntMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractDoubleIntMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractDoubleIntMapTestCase::containsKey;
            this.payloads.containsValue = AbstractDoubleIntMapTestCase::containsValue;
            this.payloads.contains = AbstractDoubleIntMapTestCase::contains;
            this.payloads.containsAll = AbstractDoubleIntMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractDoubleIntMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractDoubleIntMapTestCase::size;
            this.payloads.isEmpty = AbstractDoubleIntMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractDoubleIntMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractDoubleIntMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractDoubleIntMapTestCase::testHashCode;
            this.payloads.testToString = AbstractDoubleIntMapTestCase::testToString;
            this.payloads.forEach = AbstractDoubleIntMapTestCase::forEach;
            this.payloads.forEachValue = AbstractDoubleIntMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractDoubleIntMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractDoubleIntMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractDoubleIntMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractDoubleIntMapTestCase::makeString;
            this.payloads.appendString = AbstractDoubleIntMapTestCase::appendString;
            this.payloads.select = AbstractDoubleIntMapTestCase::select;
            this.payloads.reject = AbstractDoubleIntMapTestCase::reject;
            this.payloads.select_value = AbstractDoubleIntMapTestCase::select_value;
            this.payloads.reject_value = AbstractDoubleIntMapTestCase::reject_value;
            this.payloads.collect = AbstractDoubleIntMapTestCase::collect;
            this.payloads.count = AbstractDoubleIntMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractDoubleIntMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractDoubleIntMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractDoubleIntMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractDoubleIntMapTestCase::noneSatisfy;
            this.payloads.max = AbstractDoubleIntMapTestCase::max;
            this.payloads.min = AbstractDoubleIntMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleIntMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleIntMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractDoubleIntMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractDoubleIntMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractDoubleIntMapTestCase::sum;
            this.payloads.average = AbstractDoubleIntMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleIntMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractDoubleIntMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleIntMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractDoubleIntMapTestCase::toList;
            this.payloads.toSortedList = AbstractDoubleIntMapTestCase::toSortedList;
            this.payloads.toSet = AbstractDoubleIntMapTestCase::toSet;
            this.payloads.toBag = AbstractDoubleIntMapTestCase::toBag;
            this.payloads.intIterator = AbstractDoubleIntMapTestCase::intIterator;
            this.payloads.asLazy = AbstractDoubleIntMapTestCase::asLazy;
            this.payloads.keysView = AbstractDoubleIntMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractDoubleIntMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractDoubleIntMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractDoubleIntMapTestCase::toArray;
            this.payloads.toImmutable = AbstractDoubleIntMapTestCase::toImmutable;
            this.payloads.chunk = AbstractDoubleIntMapTestCase::chunk;
        }
    }
}
