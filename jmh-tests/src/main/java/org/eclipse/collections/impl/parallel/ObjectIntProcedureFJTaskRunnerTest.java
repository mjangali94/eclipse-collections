...
public class ObjectIntProcedureFJTaskRunnerTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectIntProcedureFJTaskRunnerTest> payload) throws java.lang.Throwable {
            this.instance = new ObjectIntProcedureFJTaskRunnerTest();
            this.instance.setUp();
        ...
        private static class _Payloads {
            ...
            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectIntProcedureFJTaskRunnerTest> taskCompletedUsingNonCombineOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectIntProcedureFJTaskRunnerTest> joinUsingNonCombineOne;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.taskCompletedUsingNonCombineOne = ObjectIntProcedureFJTaskRunnerTest::taskCompletedUsingNonCombineOne;
