...
public class SynchronizedIntCharMapKeyValuesViewTest extends AbstractIntCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedIntCharMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedIntCharMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedIntCharMapKeyValuesViewTest implementation() {
