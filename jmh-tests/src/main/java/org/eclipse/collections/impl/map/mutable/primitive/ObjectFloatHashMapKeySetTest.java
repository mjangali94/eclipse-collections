...
public class ObjectFloatHashMapKeySetTest extends ObjectFloatHashMapKeySetTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.ObjectFloatHashMapKeySetTestCase._Benchmark {
        ...
        private ObjectFloatHashMapKeySetTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectFloatHashMapKeySetTest();
        }

        @java.lang.Override
        public ObjectFloatHashMapKeySetTest implementation() {
