...
public class DoubleLongHashMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private DoubleLongHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleLongHashMapKeysViewTest();
        }

        @java.lang.Override
        public DoubleLongHashMapKeysViewTest implementation() {
