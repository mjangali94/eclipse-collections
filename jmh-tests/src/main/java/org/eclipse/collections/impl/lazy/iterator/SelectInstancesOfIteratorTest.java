...
/*
    ...
    public static class _Benchmark {
        ...
        private SelectInstancesOfIteratorTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SelectInstancesOfIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new SelectInstancesOfIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SelectInstancesOfIteratorTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SelectInstancesOfIteratorTest> noSuchElementException;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SelectInstancesOfIteratorTest> remove;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.iterator = SelectInstancesOfIteratorTest::iterator;
            this.payloads.noSuchElementException = SelectInstancesOfIteratorTest::noSuchElementException;
            this.payloads.remove = SelectInstancesOfIteratorTest::remove;
        }
    }
*/
}
