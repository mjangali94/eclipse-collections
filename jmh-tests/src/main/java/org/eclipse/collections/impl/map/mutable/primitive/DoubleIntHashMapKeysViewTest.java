...
public class DoubleIntHashMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private DoubleIntHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleIntHashMapKeysViewTest();
        }

        @java.lang.Override
        public DoubleIntHashMapKeysViewTest implementation() {
