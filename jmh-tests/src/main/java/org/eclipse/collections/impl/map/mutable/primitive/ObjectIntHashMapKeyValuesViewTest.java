...
public class ObjectIntHashMapKeyValuesViewTest extends AbstractObjectIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private ObjectIntHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectIntHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ObjectIntHashMapKeyValuesViewTest implementation() {
