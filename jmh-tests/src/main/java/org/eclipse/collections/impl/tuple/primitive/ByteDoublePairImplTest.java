...
public class ByteDoublePairImplTest {
    ...
    public static class _Benchmark {
        ...
        private ByteDoublePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new ByteDoublePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoublePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = ByteDoublePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = ByteDoublePairImplTest::getOne;
            this.payloads.getTwo = ByteDoublePairImplTest::getTwo;
            this.payloads.testToString = ByteDoublePairImplTest::testToString;
            this.payloads.compareTo = ByteDoublePairImplTest::compareTo;
        }
    }
}
