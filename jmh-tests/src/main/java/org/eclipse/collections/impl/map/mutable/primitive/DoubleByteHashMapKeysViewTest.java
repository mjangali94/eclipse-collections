...
public class DoubleByteHashMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private DoubleByteHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleByteHashMapKeysViewTest();
        }

        @java.lang.Override
        public DoubleByteHashMapKeysViewTest implementation() {
