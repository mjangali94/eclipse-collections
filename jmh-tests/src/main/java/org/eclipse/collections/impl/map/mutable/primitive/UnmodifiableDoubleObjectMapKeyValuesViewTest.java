...
public class UnmodifiableDoubleObjectMapKeyValuesViewTest extends AbstractDoubleObjectMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleObjectMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableDoubleObjectMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableDoubleObjectMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableDoubleObjectMapKeyValuesViewTest implementation() {
