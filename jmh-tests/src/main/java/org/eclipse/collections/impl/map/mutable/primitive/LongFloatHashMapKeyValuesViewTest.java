...
public class LongFloatHashMapKeyValuesViewTest extends AbstractLongFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private LongFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LongFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public LongFloatHashMapKeyValuesViewTest implementation() {
