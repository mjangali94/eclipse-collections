...
public class SynchronizedShortCharMapKeyValuesViewTest extends AbstractShortCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortCharMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortCharMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortCharMapKeyValuesViewTest implementation() {
