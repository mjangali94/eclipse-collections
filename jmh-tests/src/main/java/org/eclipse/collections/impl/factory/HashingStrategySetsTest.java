...
public class HashingStrategySetsTest {
    ...
    public void mutable() {
        ...
        MutableSet<Person> people = Sets.mutable.of(new Person("Alex", "Smith"), new Person("John", "Smith"), new Person("John", "Brown"));
        Assert.assertEquals(UnifiedSetWithHashingStrategy.newSetWith(HashingStrategies.fromFunction(Person::getLastName)).withAll(people), factory.fromFunction(Person::getLastName).withAll(people));
        Assert.assertEquals(UnifiedSetWithHashingStrategy.newSetWith(HashingStrategies.fromFunction(Person::getLastName)).withAll(people), factory.fromFunction(Person::getFirstName).withAll(people));
    }
    ...
    public static class _Benchmark {
        ...
        private HashingStrategySetsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategySetsTest> payload) throws java.lang.Throwable {
            this.instance = new HashingStrategySetsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategySetsTest> immutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategySetsTest> mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategySetsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutable = HashingStrategySetsTest::immutable;
            this.payloads.mutable = HashingStrategySetsTest::mutable;
            this.payloads.classIsNonInstantiable = HashingStrategySetsTest::classIsNonInstantiable;
        }
    }
}
