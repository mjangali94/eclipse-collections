    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.list.mutable.ArrayListAdapterTest._Benchmark _Benchmark_benchmark_5;
        ...
        public void benchmark_Cluster_279() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.groupByUniqueKey_target_throws);
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.groupByUniqueKey_throws_for_duplicate);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.toMapOfItemToCount);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.ifPresentApply);
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.ifPresentApply);
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.groupByUniqueKey_throws_for_duplicate);
        }
