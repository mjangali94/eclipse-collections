...
public class ObjectBooleanMapFactoryTest {
    ...
    public void of() {
        ...
        Assert.assertEquals(ObjectBooleanMaps.mutable.of("2", true, 3, false), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false));
        Assert.assertEquals(ObjectBooleanMaps.mutable.of("2", true, 3, false, 4, false), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false, 4, false));
        Assert.assertEquals(ObjectBooleanMaps.mutable.of("2", true, 3, false, 4, false, 5, true), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false, 4, false, 5, true));
    }
    ...
    public void with() {
        ...
        Assert.assertEquals(ObjectBooleanMaps.mutable.with("2", true, 3, false), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false));
        Assert.assertEquals(ObjectBooleanMaps.mutable.with("2", true, 3, false, 4, false), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false, 4, false));
        Assert.assertEquals(ObjectBooleanMaps.mutable.with("2", true, 3, false, 4, false, 5, true), ObjectBooleanHashMap.newWithKeysValues("2", true, 3, false, 4, false, 5, true));
    }
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectBooleanMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ObjectBooleanMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectBooleanMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectBooleanMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectBooleanMapFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectBooleanMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ObjectBooleanMapFactoryTest::of;
            this.payloads.with = ObjectBooleanMapFactoryTest::with;
            this.payloads.ofAll = ObjectBooleanMapFactoryTest::ofAll;
