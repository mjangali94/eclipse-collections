...
public class ObjectIntHashMapKeysViewTest extends AbstractObjectIntMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectIntMapKeysViewTestCase._Benchmark {
        ...
        private ObjectIntHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectIntHashMapKeysViewTest();
        }

        @java.lang.Override
        public ObjectIntHashMapKeysViewTest implementation() {
