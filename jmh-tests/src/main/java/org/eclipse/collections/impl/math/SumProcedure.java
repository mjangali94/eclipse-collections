...
/*
    ...
    public static class _Benchmark {
        ...
        private SumProcedure instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SumProcedure> payload) throws java.lang.Throwable {
            this.instance = new SumProcedure();
