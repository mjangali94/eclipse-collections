...
public class SynchronizedObjectCharMapKeysViewTest extends AbstractObjectCharMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectCharMapKeysViewTestCase._Benchmark {
        ...
        private SynchronizedObjectCharMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedObjectCharMapKeysViewTest();
        }

        @java.lang.Override
        public SynchronizedObjectCharMapKeysViewTest implementation() {
