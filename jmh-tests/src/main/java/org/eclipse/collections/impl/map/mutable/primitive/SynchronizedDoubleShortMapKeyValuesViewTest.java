...
public class SynchronizedDoubleShortMapKeyValuesViewTest extends AbstractDoubleShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedDoubleShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedDoubleShortMapKeyValuesViewTest implementation() {
