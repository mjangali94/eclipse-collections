...
public class LongLongPairImplTest {
    ...
    public static class _Benchmark {
        ...
        private LongLongPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new LongLongPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = LongLongPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = LongLongPairImplTest::getOne;
            this.payloads.getTwo = LongLongPairImplTest::getTwo;
            this.payloads.testToString = LongLongPairImplTest::testToString;
            this.payloads.compareTo = LongLongPairImplTest::compareTo;
        }
    }
}
