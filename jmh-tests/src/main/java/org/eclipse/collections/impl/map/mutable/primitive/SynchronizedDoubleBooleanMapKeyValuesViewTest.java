...
public class SynchronizedDoubleBooleanMapKeyValuesViewTest extends AbstractDoubleBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedDoubleBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedDoubleBooleanMapKeyValuesViewTest implementation() {
