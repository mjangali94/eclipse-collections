...
public class ObjectFloatHashMapKeysViewTest extends AbstractObjectFloatMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectFloatMapKeysViewTestCase._Benchmark {
        ...
        private ObjectFloatHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectFloatHashMapKeysViewTest();
        }

        @java.lang.Override
        public ObjectFloatHashMapKeysViewTest implementation() {
