...
/*
    ...
    public static class _Benchmark {
        ...
        private IntegerPredicatesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> payload) throws java.lang.Throwable {
            this.instance = new IntegerPredicatesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> isOdd;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> isEven;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> attributeIsOdd;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> attributeIsEven;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> attributeIsZero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> attributeIsPositive;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> attributeIsNegative;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> isZero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> isPositive;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> isNegative;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntegerPredicatesTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.isOdd = IntegerPredicatesTest::isOdd;
            this.payloads.isEven = IntegerPredicatesTest::isEven;
            this.payloads.attributeIsOdd = IntegerPredicatesTest::attributeIsOdd;
            this.payloads.attributeIsEven = IntegerPredicatesTest::attributeIsEven;
            this.payloads.attributeIsZero = IntegerPredicatesTest::attributeIsZero;
            this.payloads.attributeIsPositive = IntegerPredicatesTest::attributeIsPositive;
            this.payloads.attributeIsNegative = IntegerPredicatesTest::attributeIsNegative;
            this.payloads.isZero = IntegerPredicatesTest::isZero;
            this.payloads.isPositive = IntegerPredicatesTest::isPositive;
            this.payloads.isNegative = IntegerPredicatesTest::isNegative;
