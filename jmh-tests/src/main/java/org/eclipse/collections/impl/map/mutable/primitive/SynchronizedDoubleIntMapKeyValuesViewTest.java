...
public class SynchronizedDoubleIntMapKeyValuesViewTest extends AbstractDoubleIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedDoubleIntMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleIntMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedDoubleIntMapKeyValuesViewTest implementation() {
