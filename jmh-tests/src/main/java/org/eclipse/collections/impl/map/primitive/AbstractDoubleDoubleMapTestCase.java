...
public abstract class AbstractDoubleDoubleMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(DoubleHashSet.newSetWith(0.0, 31.0, 32.0), this.newWithKeysValues(0.0, 0.0, 31.0, 31.0, 32.0, 32.0).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0.0, 0.0, 1.0, 1.0, 32.0, 32.0).hashCode(), this.newWithKeysValues(32.0, 32.0, 0.0, 0.0, 1.0, 1.0).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50.0, 0.0, 60.0, 1.0, 70.0, 33.0).hashCode(), this.newWithKeysValues(50.0, 0.0, 60.0, 1.0, 70.0, 33.0).hashCode());
    ...
    public void injectIntoKeyValue() {
        DoubleDoubleMap map0 = this.newWithKeysValues(0.0, 1.0, 3.0, 4.0);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, double eachKey, double eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        DoubleDoubleMap copy = map0.injectIntoKeyValue(DoubleDoubleMaps.mutable.empty(), MutableDoubleDoubleMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0, 2.0, 3.0, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0)) || this.newWithKeysValues(2.0, 2.0, 3.0, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(DoubleBags.mutable.with(1.0)).toSet(), this.newWithKeysValues(1.0, 1.0).chunk(1).toSet());
    ...
    public static class _Benchmark {
        ...
        private AbstractDoubleDoubleMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractDoubleDoubleMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> doubleIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractDoubleDoubleMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractDoubleDoubleMapTestCase::keySet;
            this.payloads.values = AbstractDoubleDoubleMapTestCase::values;
            this.payloads.get = AbstractDoubleDoubleMapTestCase::get;
            this.payloads.getIfAbsent = AbstractDoubleDoubleMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractDoubleDoubleMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractDoubleDoubleMapTestCase::containsKey;
            this.payloads.containsValue = AbstractDoubleDoubleMapTestCase::containsValue;
            this.payloads.contains = AbstractDoubleDoubleMapTestCase::contains;
            this.payloads.containsAll = AbstractDoubleDoubleMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractDoubleDoubleMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractDoubleDoubleMapTestCase::size;
            this.payloads.isEmpty = AbstractDoubleDoubleMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractDoubleDoubleMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractDoubleDoubleMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractDoubleDoubleMapTestCase::testHashCode;
            this.payloads.testToString = AbstractDoubleDoubleMapTestCase::testToString;
            this.payloads.forEach = AbstractDoubleDoubleMapTestCase::forEach;
            this.payloads.forEachValue = AbstractDoubleDoubleMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractDoubleDoubleMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractDoubleDoubleMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractDoubleDoubleMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractDoubleDoubleMapTestCase::makeString;
            this.payloads.appendString = AbstractDoubleDoubleMapTestCase::appendString;
            this.payloads.select = AbstractDoubleDoubleMapTestCase::select;
            this.payloads.reject = AbstractDoubleDoubleMapTestCase::reject;
            this.payloads.select_value = AbstractDoubleDoubleMapTestCase::select_value;
            this.payloads.reject_value = AbstractDoubleDoubleMapTestCase::reject_value;
            this.payloads.collect = AbstractDoubleDoubleMapTestCase::collect;
            this.payloads.count = AbstractDoubleDoubleMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractDoubleDoubleMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractDoubleDoubleMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractDoubleDoubleMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractDoubleDoubleMapTestCase::noneSatisfy;
            this.payloads.max = AbstractDoubleDoubleMapTestCase::max;
            this.payloads.min = AbstractDoubleDoubleMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleDoubleMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleDoubleMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractDoubleDoubleMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractDoubleDoubleMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractDoubleDoubleMapTestCase::sum;
            this.payloads.average = AbstractDoubleDoubleMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleDoubleMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractDoubleDoubleMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractDoubleDoubleMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractDoubleDoubleMapTestCase::toList;
            this.payloads.toSortedList = AbstractDoubleDoubleMapTestCase::toSortedList;
            this.payloads.toSet = AbstractDoubleDoubleMapTestCase::toSet;
            this.payloads.toBag = AbstractDoubleDoubleMapTestCase::toBag;
            this.payloads.doubleIterator = AbstractDoubleDoubleMapTestCase::doubleIterator;
            this.payloads.asLazy = AbstractDoubleDoubleMapTestCase::asLazy;
            this.payloads.keysView = AbstractDoubleDoubleMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractDoubleDoubleMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractDoubleDoubleMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractDoubleDoubleMapTestCase::toArray;
            this.payloads.toImmutable = AbstractDoubleDoubleMapTestCase::toImmutable;
