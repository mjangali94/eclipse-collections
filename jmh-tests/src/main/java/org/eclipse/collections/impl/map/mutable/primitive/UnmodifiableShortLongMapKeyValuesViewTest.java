...
public class UnmodifiableShortLongMapKeyValuesViewTest extends AbstractShortLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableShortLongMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableShortLongMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableShortLongMapKeyValuesViewTest implementation() {
