...
public class SynchronizedFloatObjectMapKeysViewTest extends AbstractLazyFloatIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyFloatIterableTestCase._Benchmark {
        ...
        private SynchronizedFloatObjectMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedFloatObjectMapKeysViewTest();
        }

        @java.lang.Override
        public SynchronizedFloatObjectMapKeysViewTest implementation() {
