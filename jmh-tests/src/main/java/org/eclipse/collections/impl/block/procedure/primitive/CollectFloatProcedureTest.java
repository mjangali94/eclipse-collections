...
/*
    ...
    public static class _Benchmark {
        ...
        private CollectFloatProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CollectFloatProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new CollectFloatProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CollectFloatProcedureTest> basicCase;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.basicCase = CollectFloatProcedureTest::basicCase;
        }
    }
*/
}
