...
public class UnmodifiableByteByteMapKeyValuesViewTest extends AbstractByteByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableByteByteMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableByteByteMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableByteByteMapKeyValuesViewTest implementation() {
