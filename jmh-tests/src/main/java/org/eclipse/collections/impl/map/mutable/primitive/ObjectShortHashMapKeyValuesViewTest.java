...
public class ObjectShortHashMapKeyValuesViewTest extends AbstractObjectShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private ObjectShortHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectShortHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ObjectShortHashMapKeyValuesViewTest implementation() {
