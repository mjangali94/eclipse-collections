...
public final class MutableDouble extends Number implements Comparable<MutableDouble> {
    ...
    public static class _Benchmark {
        ...
        private MutableDouble instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableDouble> payload) throws java.lang.Throwable {
            this.instance = new MutableDouble();
