...
public class SynchronizedCharBooleanMapKeyValuesViewTest extends AbstractCharBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractCharBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedCharBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedCharBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedCharBooleanMapKeyValuesViewTest implementation() {
