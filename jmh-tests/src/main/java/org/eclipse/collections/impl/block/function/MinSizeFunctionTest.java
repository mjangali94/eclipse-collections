...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MinSizeFunctionTest> payload) throws java.lang.Throwable {
            this.instance = new MinSizeFunctionTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinSizeFunctionTest> minSizeCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinSizeFunctionTest> minSizeMap;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.minSizeCollection = MinSizeFunctionTest::minSizeCollection;
