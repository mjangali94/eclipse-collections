...
public class StacksTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> payload) throws java.lang.Throwable {
            this.instance = new StacksTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> emptyStack;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> newStackWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> newStackWithArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> newStackWithStack;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> newStackWithWithStack;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<StacksTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = StacksTest::immutables;
            this.payloads.mutables = StacksTest::mutables;
            this.payloads.emptyStack = StacksTest::emptyStack;
            this.payloads.newStackWith = StacksTest::newStackWith;
            this.payloads.newStackWithArray = StacksTest::newStackWithArray;
            this.payloads.newStackWithStack = StacksTest::newStackWithStack;
            this.payloads.newStackWithWithStack = StacksTest::newStackWithWithStack;
            this.payloads.classIsNonInstantiable = StacksTest::classIsNonInstantiable;
        }
    }
}
