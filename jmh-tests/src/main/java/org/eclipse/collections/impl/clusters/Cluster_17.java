...
public class Cluster_17 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.map.mutable.primitive.LongBooleanHashMapValuesTest._Benchmark _Benchmark_benchmark_11;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_11 = new org.eclipse.collections.impl.map.mutable.primitive.LongBooleanHashMapValuesTest._Benchmark();
        ...
        public void benchmark_Cluster_17() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_6.runBenchmark(this._Benchmark_benchmark_6.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.collectLongWithTarget);
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.collectLongWithTarget);
            this._Benchmark_benchmark_9.runBenchmark(this._Benchmark_benchmark_9.payloads.collectLongWithBagTarget);
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.collectLongWithTarget);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.without);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.addAllArray);
        }
