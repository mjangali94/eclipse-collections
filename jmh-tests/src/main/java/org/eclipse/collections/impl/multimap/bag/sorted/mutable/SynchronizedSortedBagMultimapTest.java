...
public class SynchronizedSortedBagMultimapTest extends AbstractMutableSortedBagMultimapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.multimap.bag.sorted.mutable.AbstractMutableSortedBagMultimapTestCase._Benchmark {

        private SynchronizedSortedBagMultimapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedSortedBagMultimapTest();
        }

        @java.lang.Override
        public SynchronizedSortedBagMultimapTest implementation() {
