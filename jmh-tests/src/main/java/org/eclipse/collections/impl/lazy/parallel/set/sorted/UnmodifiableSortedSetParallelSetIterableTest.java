...
public class UnmodifiableSortedSetParallelSetIterableTest extends NonParallelSortedSetIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.parallel.set.sorted.NonParallelSortedSetIterableTestCase._Benchmark {

        private UnmodifiableSortedSetParallelSetIterableTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableSortedSetParallelSetIterableTest();
        }

        @java.lang.Override
        public UnmodifiableSortedSetParallelSetIterableTest implementation() {
