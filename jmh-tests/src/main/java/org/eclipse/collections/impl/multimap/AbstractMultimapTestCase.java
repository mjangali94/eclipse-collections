...
public abstract class AbstractMultimapTestCase {
    ...
    public void forEachKeyMultiValue() {
        ...
        MutableSet<Pair<Integer, MutableCollection<String>>> expected = Sets.mutable.with(Tuples.pair(2, this.createCollection("2", "1")), Tuples.pair(3, this.createCollection("3", "3")));
    ...
    public static class _Benchmark {
        ...
        private AbstractMultimapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractMultimapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimapWithKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimapWithWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimapWithWithWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimapWithWithWithWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testNewMultimapWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> newMultimapFromPairs;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> forEachKeyMultiValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> valuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> multiValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> keysWithMultiValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> keyValuePairsView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> keyBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> serialization;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> newEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> sizeDistinct;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> selectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> rejectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> selectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> rejectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> collectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> collectKeyMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> collectValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMultimapTestCase> flip;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testNewMultimap = AbstractMultimapTestCase::testNewMultimap;
            this.payloads.testNewMultimapWithKeyValue = AbstractMultimapTestCase::testNewMultimapWithKeyValue;
            this.payloads.testNewMultimapWithWith = AbstractMultimapTestCase::testNewMultimapWithWith;
            this.payloads.testNewMultimapWithWithWith = AbstractMultimapTestCase::testNewMultimapWithWithWith;
            this.payloads.testNewMultimapWithWithWithWith = AbstractMultimapTestCase::testNewMultimapWithWithWithWith;
            this.payloads.testNewMultimapWith = AbstractMultimapTestCase::testNewMultimapWith;
            this.payloads.newMultimapFromPairs = AbstractMultimapTestCase::newMultimapFromPairs;
            this.payloads.isEmpty = AbstractMultimapTestCase::isEmpty;
            this.payloads.forEachKeyValue = AbstractMultimapTestCase::forEachKeyValue;
            this.payloads.forEachKeyMultiValue = AbstractMultimapTestCase::forEachKeyMultiValue;
            this.payloads.forEachValue = AbstractMultimapTestCase::forEachValue;
            this.payloads.valuesView = AbstractMultimapTestCase::valuesView;
            this.payloads.multiValuesView = AbstractMultimapTestCase::multiValuesView;
            this.payloads.forEachKey = AbstractMultimapTestCase::forEachKey;
            this.payloads.notEmpty = AbstractMultimapTestCase::notEmpty;
            this.payloads.keysWithMultiValuesView = AbstractMultimapTestCase::keysWithMultiValuesView;
            this.payloads.keyValuePairsView = AbstractMultimapTestCase::keyValuePairsView;
            this.payloads.keyBag = AbstractMultimapTestCase::keyBag;
            this.payloads.testEquals = AbstractMultimapTestCase::testEquals;
            this.payloads.testHashCode = AbstractMultimapTestCase::testHashCode;
            this.payloads.serialization = AbstractMultimapTestCase::serialization;
            this.payloads.newEmpty = AbstractMultimapTestCase::newEmpty;
            this.payloads.keysView = AbstractMultimapTestCase::keysView;
            this.payloads.keySet = AbstractMultimapTestCase::keySet;
            this.payloads.sizeDistinct = AbstractMultimapTestCase::sizeDistinct;
            this.payloads.selectKeysValues = AbstractMultimapTestCase::selectKeysValues;
            this.payloads.rejectKeysValues = AbstractMultimapTestCase::rejectKeysValues;
            this.payloads.selectKeysMultiValues = AbstractMultimapTestCase::selectKeysMultiValues;
            this.payloads.rejectKeysMultiValues = AbstractMultimapTestCase::rejectKeysMultiValues;
            this.payloads.collectKeysValues = AbstractMultimapTestCase::collectKeysValues;
            this.payloads.collectKeyMultiValues = AbstractMultimapTestCase::collectKeyMultiValues;
            this.payloads.collectValues = AbstractMultimapTestCase::collectValues;
