...
public class Procedures2Test {
    ...
    public void throwingWithSuccessfulCompletion() {
        ...
        ThrowingProcedure2<Integer, Integer> throwingProcedure2 = (object, parameter) -> list.add(PrimitiveTuples.pair(object.intValue(), parameter.intValue()));
    ...
    public static class _Benchmark {
        ...
        private Procedures2Test instance;
        ...
        public void benchmark_asProcedure2() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.asProcedure2);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> payload) throws java.lang.Throwable {
            this.instance = new Procedures2Test();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> throwing;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> throwingWithSuccessfulCompletion;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> throwingWithUserSpecifiedException;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> asProcedure2;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> summarizeDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> summarizeFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> summarizeLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<Procedures2Test> summarizeInt;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.throwing = Procedures2Test::throwing;
            this.payloads.throwingWithSuccessfulCompletion = Procedures2Test::throwingWithSuccessfulCompletion;
            this.payloads.throwingWithUserSpecifiedException = Procedures2Test::throwingWithUserSpecifiedException;
            this.payloads.asProcedure2 = Procedures2Test::asProcedure2;
            this.payloads.classIsNonInstantiable = Procedures2Test::classIsNonInstantiable;
            this.payloads.summarizeDouble = Procedures2Test::summarizeDouble;
            this.payloads.summarizeFloat = Procedures2Test::summarizeFloat;
            this.payloads.summarizeLong = Procedures2Test::summarizeLong;
