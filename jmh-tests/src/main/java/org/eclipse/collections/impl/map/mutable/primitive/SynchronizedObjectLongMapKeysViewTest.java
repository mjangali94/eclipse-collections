...
public class SynchronizedObjectLongMapKeysViewTest extends AbstractObjectLongMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectLongMapKeysViewTestCase._Benchmark {
        ...
        private SynchronizedObjectLongMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedObjectLongMapKeysViewTest();
        }

        @java.lang.Override
        public SynchronizedObjectLongMapKeysViewTest implementation() {
