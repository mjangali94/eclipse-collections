...
public class SynchronizedIntBooleanMapTest extends AbstractMutableIntBooleanMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableIntBooleanMapTestCase._Benchmark {
        ...
        private SynchronizedIntBooleanMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedIntBooleanMapTest();
        }

        @java.lang.Override
        public SynchronizedIntBooleanMapTest implementation() {
