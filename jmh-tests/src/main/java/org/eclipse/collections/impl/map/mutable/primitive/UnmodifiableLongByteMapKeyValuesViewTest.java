...
public class UnmodifiableLongByteMapKeyValuesViewTest extends AbstractLongByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableLongByteMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableLongByteMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableLongByteMapKeyValuesViewTest implementation() {
