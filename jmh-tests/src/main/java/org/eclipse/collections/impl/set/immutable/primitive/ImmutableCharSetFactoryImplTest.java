...
public class ImmutableCharSetFactoryImplTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private ImmutableCharSetFactoryImplTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableCharSetFactoryImplTest();
        }

        @java.lang.Override
        public ImmutableCharSetFactoryImplTest implementation() {
