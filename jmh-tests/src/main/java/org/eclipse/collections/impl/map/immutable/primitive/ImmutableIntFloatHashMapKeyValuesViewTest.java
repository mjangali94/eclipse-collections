...
public class ImmutableIntFloatHashMapKeyValuesViewTest extends AbstractIntFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableIntFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableIntFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableIntFloatHashMapKeyValuesViewTest implementation() {
