...
public class SingletonBooleanIteratorTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonBooleanIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new SingletonBooleanIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonBooleanIteratorTest> hasNext;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonBooleanIteratorTest> next;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.hasNext = SingletonBooleanIteratorTest::hasNext;
            this.payloads.next = SingletonBooleanIteratorTest::next;
        }
    }
}
