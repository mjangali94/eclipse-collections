...
public class ObjectLongMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private ObjectLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ObjectLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectLongMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectLongMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectLongMapFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectLongMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ObjectLongMapFactoryTest::of;
            this.payloads.with = ObjectLongMapFactoryTest::with;
            this.payloads.ofAll = ObjectLongMapFactoryTest::ofAll;
            this.payloads.from = ObjectLongMapFactoryTest::from;
        }
    }
}
