...
public class FloatBytePairImplTest {
    ...
    public static class _Benchmark {
        ...
        private FloatBytePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new FloatBytePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBytePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = FloatBytePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = FloatBytePairImplTest::getOne;
            this.payloads.getTwo = FloatBytePairImplTest::getTwo;
            this.payloads.testToString = FloatBytePairImplTest::testToString;
            this.payloads.compareTo = FloatBytePairImplTest::compareTo;
        }
    }
}
