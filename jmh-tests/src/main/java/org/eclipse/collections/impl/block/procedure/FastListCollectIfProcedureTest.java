...
public class FastListCollectIfProcedureTest {
    ...
    public static class _Benchmark {
        ...
        private FastListCollectIfProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FastListCollectIfProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new FastListCollectIfProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FastListCollectIfProcedureTest> value;
        }
