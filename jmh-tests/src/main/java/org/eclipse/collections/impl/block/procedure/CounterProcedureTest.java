...
public class CounterProcedureTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CounterProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new CounterProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CounterProcedureTest> getCount;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CounterProcedureTest> toStringTest;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.getCount = CounterProcedureTest::getCount;
