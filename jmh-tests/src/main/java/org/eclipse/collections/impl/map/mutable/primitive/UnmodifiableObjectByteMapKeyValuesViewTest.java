...
public class UnmodifiableObjectByteMapKeyValuesViewTest extends AbstractObjectByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectByteMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectByteMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectByteMapKeyValuesViewTest implementation() {
