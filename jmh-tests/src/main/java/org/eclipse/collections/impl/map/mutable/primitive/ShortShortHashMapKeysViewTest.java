...
public class ShortShortHashMapKeysViewTest extends AbstractLazyShortIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyShortIterableTestCase._Benchmark {
        ...
        private ShortShortHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortShortHashMapKeysViewTest();
        }

        @java.lang.Override
        public ShortShortHashMapKeysViewTest implementation() {
