...
public class PartitionHashBagTest {
    ...
    public static class _Benchmark {
        ...
        private PartitionHashBagTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionHashBagTest> payload) throws java.lang.Throwable {
            this.instance = new PartitionHashBagTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionHashBagTest> toImmutable;
        }
