...
public class UnmodifiableShortBooleanMapKeyValuesViewTest extends AbstractShortBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableShortBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableShortBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableShortBooleanMapKeyValuesViewTest implementation() {
