...
/*
    ...
    public static class _Benchmark {
        ...
        private SumOfCharProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SumOfCharProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new SumOfCharProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SumOfCharProcedureTest> getResult;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.getResult = SumOfCharProcedureTest::getResult;
        }
    }
*/
}
