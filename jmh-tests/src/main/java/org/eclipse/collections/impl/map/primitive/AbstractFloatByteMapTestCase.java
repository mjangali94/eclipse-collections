...
public abstract class AbstractFloatByteMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(FloatHashSet.newSetWith(0.0f, 31.0f, 32.0f), this.newWithKeysValues(0.0f, (byte) 0, 31.0f, (byte) 31, 32.0f, (byte) 32).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0.0f, (byte) 0, 1.0f, (byte) 1, 32.0f, (byte) 32).hashCode(), this.newWithKeysValues(32.0f, (byte) 32, 0.0f, (byte) 0, 1.0f, (byte) 1).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50.0f, (byte) 0, 60.0f, (byte) 1, 70.0f, (byte) 33).hashCode(), this.newWithKeysValues(50.0f, (byte) 0, 60.0f, (byte) 1, 70.0f, (byte) 33).hashCode());
    ...
    public void injectIntoKeyValue() {
        FloatByteMap map0 = this.newWithKeysValues(0.0f, (byte) 1, 3.0f, (byte) 4);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, float eachKey, byte eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        FloatByteMap copy = map0.injectIntoKeyValue(FloatByteMaps.mutable.empty(), MutableFloatByteMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues(2.0f, (byte) 2, 3.0f, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 2, (byte) 3)) || this.newWithKeysValues(2.0f, (byte) 2, 3.0f, (byte) 3).toList().equals(ByteArrayList.newListWith((byte) 3, (byte) 2)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(ByteBags.mutable.with((byte) 1)).toSet(), this.newWithKeysValues(1.0f, (byte) 1).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1.0f, (byte) 1).chunk(-1));
    }
...
/*
    ...
    public static class _Benchmark {
        ...
        private AbstractFloatByteMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractFloatByteMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> byteIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatByteMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractFloatByteMapTestCase::keySet;
            this.payloads.values = AbstractFloatByteMapTestCase::values;
            this.payloads.get = AbstractFloatByteMapTestCase::get;
            this.payloads.getIfAbsent = AbstractFloatByteMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractFloatByteMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractFloatByteMapTestCase::containsKey;
            this.payloads.containsValue = AbstractFloatByteMapTestCase::containsValue;
            this.payloads.contains = AbstractFloatByteMapTestCase::contains;
            this.payloads.containsAll = AbstractFloatByteMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractFloatByteMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractFloatByteMapTestCase::size;
            this.payloads.isEmpty = AbstractFloatByteMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractFloatByteMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractFloatByteMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractFloatByteMapTestCase::testHashCode;
            this.payloads.testToString = AbstractFloatByteMapTestCase::testToString;
            this.payloads.forEach = AbstractFloatByteMapTestCase::forEach;
            this.payloads.forEachValue = AbstractFloatByteMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractFloatByteMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractFloatByteMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractFloatByteMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractFloatByteMapTestCase::makeString;
            this.payloads.appendString = AbstractFloatByteMapTestCase::appendString;
            this.payloads.select = AbstractFloatByteMapTestCase::select;
            this.payloads.reject = AbstractFloatByteMapTestCase::reject;
            this.payloads.select_value = AbstractFloatByteMapTestCase::select_value;
            this.payloads.reject_value = AbstractFloatByteMapTestCase::reject_value;
            this.payloads.collect = AbstractFloatByteMapTestCase::collect;
            this.payloads.count = AbstractFloatByteMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractFloatByteMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractFloatByteMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractFloatByteMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractFloatByteMapTestCase::noneSatisfy;
            this.payloads.max = AbstractFloatByteMapTestCase::max;
            this.payloads.min = AbstractFloatByteMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractFloatByteMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractFloatByteMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractFloatByteMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractFloatByteMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractFloatByteMapTestCase::sum;
            this.payloads.average = AbstractFloatByteMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractFloatByteMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractFloatByteMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractFloatByteMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractFloatByteMapTestCase::toList;
            this.payloads.toSortedList = AbstractFloatByteMapTestCase::toSortedList;
            this.payloads.toSet = AbstractFloatByteMapTestCase::toSet;
            this.payloads.toBag = AbstractFloatByteMapTestCase::toBag;
            this.payloads.byteIterator = AbstractFloatByteMapTestCase::byteIterator;
            this.payloads.asLazy = AbstractFloatByteMapTestCase::asLazy;
            this.payloads.keysView = AbstractFloatByteMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractFloatByteMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractFloatByteMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractFloatByteMapTestCase::toArray;
            this.payloads.toImmutable = AbstractFloatByteMapTestCase::toImmutable;
            this.payloads.chunk = AbstractFloatByteMapTestCase::chunk;
        }
    }
*/
}
