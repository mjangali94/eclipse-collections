...
public class ObjectDoubleHashingStrategyMapsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private ObjectDoubleHashingStrategyMapsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectDoubleHashingStrategyMapsTest();
        }

        @java.lang.Override
        public ObjectDoubleHashingStrategyMapsTest implementation() {
