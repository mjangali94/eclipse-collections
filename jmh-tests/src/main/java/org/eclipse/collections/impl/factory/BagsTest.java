...
public class BagsTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> payload) throws java.lang.Throwable {
            this.instance = new BagsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> emptyBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> newBagWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> withInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> ofInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> newBagWithArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> newBagWithBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> multiReader;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BagsTest> withAllEmptyImmutableSame;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.mutables = BagsTest::mutables;
            this.payloads.immutables = BagsTest::immutables;
            this.payloads.emptyBag = BagsTest::emptyBag;
            this.payloads.newBagWith = BagsTest::newBagWith;
            this.payloads.withInitialCapacity = BagsTest::withInitialCapacity;
            this.payloads.ofInitialCapacity = BagsTest::ofInitialCapacity;
            this.payloads.newBagWithArray = BagsTest::newBagWithArray;
            this.payloads.newBagWithBag = BagsTest::newBagWithBag;
            this.payloads.multiReader = BagsTest::multiReader;
            this.payloads.classIsNonInstantiable = BagsTest::classIsNonInstantiable;
