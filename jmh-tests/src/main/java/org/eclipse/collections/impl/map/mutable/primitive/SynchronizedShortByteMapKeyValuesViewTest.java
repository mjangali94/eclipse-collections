...
public class SynchronizedShortByteMapKeyValuesViewTest extends AbstractShortByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortByteMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortByteMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortByteMapKeyValuesViewTest implementation() {
