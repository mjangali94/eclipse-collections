...
public class SynchronizedObjectShortMapKeysViewTest extends AbstractObjectShortMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectShortMapKeysViewTestCase._Benchmark {
        ...
        private SynchronizedObjectShortMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedObjectShortMapKeysViewTest();
        }

        @java.lang.Override
        public SynchronizedObjectShortMapKeysViewTest implementation() {
