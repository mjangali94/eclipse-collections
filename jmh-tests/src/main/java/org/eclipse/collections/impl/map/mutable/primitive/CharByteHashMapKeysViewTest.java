...
public class CharByteHashMapKeysViewTest extends AbstractLazyCharIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyCharIterableTestCase._Benchmark {
        ...
        private CharByteHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CharByteHashMapKeysViewTest();
        }

        @java.lang.Override
        public CharByteHashMapKeysViewTest implementation() {
