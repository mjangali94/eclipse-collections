...
public class BooleanBagsTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> payload) throws java.lang.Throwable {
            this.instance = new BooleanBagsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> emptyBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> newBagWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> newBagWithArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> newBagWithBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> newBagWithWithBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BooleanBagsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = BooleanBagsTest::immutables;
            this.payloads.emptyBag = BooleanBagsTest::emptyBag;
            this.payloads.newBagWith = BooleanBagsTest::newBagWith;
            this.payloads.newBagWithArray = BooleanBagsTest::newBagWithArray;
            this.payloads.newBagWithBag = BooleanBagsTest::newBagWithBag;
            this.payloads.newBagWithWithBag = BooleanBagsTest::newBagWithWithBag;
            this.payloads.classIsNonInstantiable = BooleanBagsTest::classIsNonInstantiable;
        }
    }
}
