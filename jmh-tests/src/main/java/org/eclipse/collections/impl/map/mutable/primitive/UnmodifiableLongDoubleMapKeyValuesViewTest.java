...
public class UnmodifiableLongDoubleMapKeyValuesViewTest extends AbstractLongDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableLongDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableLongDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableLongDoubleMapKeyValuesViewTest implementation() {
