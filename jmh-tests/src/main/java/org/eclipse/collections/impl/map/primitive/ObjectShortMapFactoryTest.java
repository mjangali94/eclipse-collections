...
/*
    ...
    public static class _Benchmark {
        ...
        private ObjectShortMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectShortMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ObjectShortMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectShortMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectShortMapFactoryTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectShortMapFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ObjectShortMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ObjectShortMapFactoryTest::of;
            this.payloads.with = ObjectShortMapFactoryTest::with;
            this.payloads.ofAll = ObjectShortMapFactoryTest::ofAll;
