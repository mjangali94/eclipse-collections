...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MinAndMaxBlocksTest> payload) throws java.lang.Throwable {
            this.instance = new MinAndMaxBlocksTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinAndMaxBlocksTest> minBlocks;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinAndMaxBlocksTest> minBlocksNull;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinAndMaxBlocksTest> maxBlocks;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MinAndMaxBlocksTest> maxBlocksNull;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.minBlocks = MinAndMaxBlocksTest::minBlocks;
            this.payloads.minBlocksNull = MinAndMaxBlocksTest::minBlocksNull;
            this.payloads.maxBlocks = MinAndMaxBlocksTest::maxBlocks;
