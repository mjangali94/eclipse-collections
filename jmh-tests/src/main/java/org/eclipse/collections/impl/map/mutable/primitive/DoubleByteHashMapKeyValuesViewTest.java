...
public class DoubleByteHashMapKeyValuesViewTest extends AbstractDoubleByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private DoubleByteHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleByteHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public DoubleByteHashMapKeyValuesViewTest implementation() {
