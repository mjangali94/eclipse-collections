...
public class UnmodifiableCharDoubleMapKeyValuesViewTest extends AbstractCharDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractCharDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableCharDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableCharDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableCharDoubleMapKeyValuesViewTest implementation() {
