...
public class FloatCharMapsTest {
    ...
    public static class _Benchmark {
        ...
        private FloatCharMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FloatCharMapsTest> payload) throws java.lang.Throwable {
            this.instance = new FloatCharMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatCharMapsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatCharMapsTest> mutables;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = FloatCharMapsTest::immutables;
            this.payloads.mutables = FloatCharMapsTest::mutables;
        }
    }
}
