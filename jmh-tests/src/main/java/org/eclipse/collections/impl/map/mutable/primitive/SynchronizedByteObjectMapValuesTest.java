...
public class SynchronizedByteObjectMapValuesTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private SynchronizedByteObjectMapValuesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedByteObjectMapValuesTest();
        }

        @java.lang.Override
        public SynchronizedByteObjectMapValuesTest implementation() {
