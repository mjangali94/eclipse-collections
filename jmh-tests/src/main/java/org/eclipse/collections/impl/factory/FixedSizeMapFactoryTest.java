...
/*
    ...
    public static class _Benchmark {
        ...
        private FixedSizeMapFactoryTest instance;
        ...
        public void benchmark_testWithMap() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.testWithMap);
        }

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new FixedSizeMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> create0;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> create1;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> create2;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> create3;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> createWithDuplicates;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> keyPreservation;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeMapFactoryTest> testWithMap;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.create0 = FixedSizeMapFactoryTest::create0;
            this.payloads.create1 = FixedSizeMapFactoryTest::create1;
            this.payloads.create2 = FixedSizeMapFactoryTest::create2;
            this.payloads.create3 = FixedSizeMapFactoryTest::create3;
            this.payloads.createWithDuplicates = FixedSizeMapFactoryTest::createWithDuplicates;
            this.payloads.keyPreservation = FixedSizeMapFactoryTest::keyPreservation;
