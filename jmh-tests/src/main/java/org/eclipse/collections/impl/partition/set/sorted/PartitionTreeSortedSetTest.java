...
public class PartitionTreeSortedSetTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionTreeSortedSetTest> payload) throws java.lang.Throwable {
            this.instance = new PartitionTreeSortedSetTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionTreeSortedSetTest> toImmutable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.toImmutable = PartitionTreeSortedSetTest::toImmutable;
        }
    }
}
