...
public class ShortDoubleHashMapKeysViewTest extends AbstractLazyShortIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyShortIterableTestCase._Benchmark {
        ...
        private ShortDoubleHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortDoubleHashMapKeysViewTest();
        }

        @java.lang.Override
        public ShortDoubleHashMapKeysViewTest implementation() {
