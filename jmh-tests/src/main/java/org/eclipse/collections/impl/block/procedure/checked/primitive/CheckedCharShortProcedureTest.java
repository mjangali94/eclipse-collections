...
public final class CheckedCharShortProcedureTest {
    ...
    public static class _Benchmark {
        ...
        private CheckedCharShortProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedCharShortProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new CheckedCharShortProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedCharShortProcedureTest> regular;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedCharShortProcedureTest> runtimeException;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedCharShortProcedureTest> checkedException;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.regular = CheckedCharShortProcedureTest::regular;
            this.payloads.runtimeException = CheckedCharShortProcedureTest::runtimeException;
            this.payloads.checkedException = CheckedCharShortProcedureTest::checkedException;
        }
    }
}
