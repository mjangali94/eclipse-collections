...
public class BiMapsTest {
    ...
    public void withAllEmptyImmutableSame() {
        ...
        Map<Integer, Integer> integers = BiMaps.immutable.<Integer, Integer>empty().newWithMap(Maps.mutable.empty()).castToMap();
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<BiMapsTest> payload) throws java.lang.Throwable {
            this.instance = new BiMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BiMapsTest> immutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BiMapsTest> mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BiMapsTest> withAllEmptyImmutableSame;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<BiMapsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutable = BiMapsTest::immutable;
            this.payloads.mutable = BiMapsTest::mutable;
            this.payloads.withAllEmptyImmutableSame = BiMapsTest::withAllEmptyImmutableSame;
