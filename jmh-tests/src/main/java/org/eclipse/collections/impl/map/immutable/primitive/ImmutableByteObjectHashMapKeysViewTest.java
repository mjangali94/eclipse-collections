...
public class ImmutableByteObjectHashMapKeysViewTest extends AbstractLazyByteIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyByteIterableTestCase._Benchmark {
        ...
        private ImmutableByteObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableByteObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public ImmutableByteObjectHashMapKeysViewTest implementation() {
