...
public class AdaptObjectIntProcedureToProcedureTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private AdaptObjectIntProcedureToProcedureTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new AdaptObjectIntProcedureToProcedureTest();
        }

        @java.lang.Override
        public AdaptObjectIntProcedureToProcedureTest implementation() {
