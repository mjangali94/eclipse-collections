...
public class SynchronizedFloatShortMapKeyValuesViewTest extends AbstractFloatShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedFloatShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedFloatShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedFloatShortMapKeyValuesViewTest implementation() {
