...
public class CompositeIterableTest extends AbstractLazyIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.AbstractLazyIterableTestCase._Benchmark {
        ...
        public void benchmark_emptyIterator() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::emptyIterator, this.description("emptyIterator"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_iteratorAll() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::iteratorAll, this.description("iteratorAll"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_iteratorAny() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::iteratorAny, this.description("iteratorAny"));
        }
        ...
        public void benchmark_ensureLazy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ensureLazy, this.description("ensureLazy"));
        }
        ...
        private CompositeIterableTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompositeIterableTest();
        }

        @java.lang.Override
        public CompositeIterableTest implementation() {
