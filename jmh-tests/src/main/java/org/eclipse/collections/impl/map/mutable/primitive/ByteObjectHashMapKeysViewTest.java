...
public class ByteObjectHashMapKeysViewTest extends AbstractLazyByteIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyByteIterableTestCase._Benchmark {
        ...
        private ByteObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ByteObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public ByteObjectHashMapKeysViewTest implementation() {
