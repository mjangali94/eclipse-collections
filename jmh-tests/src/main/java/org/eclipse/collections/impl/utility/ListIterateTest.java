...
public class ListIterateTest {
    ...
    public void reverseForEachWithIndex() {
        ...
        Assert.assertEquals(Lists.mutable.of(Tuples.twin(1, 4), Tuples.twin(2, 3), Tuples.twin(3, 2), Tuples.twin(4, 1), Tuples.twin(5, 0)), result);
    }
    ...
    @Test
    public void min() {
        Assert.assertEquals((Integer) 3, ListIterate.min(Lists.mutable.of(2, 1, 3), Comparators.reverseNaturalOrder()));
        Assert.assertEquals((Integer) 1, ListIterate.min(Lists.mutable.of(2, 1, 3)));
        Assert.assertEquals((Integer) 3, ListIterate.min(new LinkedList<>(Lists.mutable.of(2, 1, 3)), Comparators.reverseNaturalOrder()));
        Assert.assertEquals((Integer) 1, ListIterate.min(new LinkedList<>(Lists.mutable.of(2, 1, 3))));
    }
    ...
    @Test
    public void max() {
        Assert.assertEquals((Integer) 1, ListIterate.max(Lists.mutable.of(2, 1, 3), Comparators.reverseNaturalOrder()));
        Assert.assertEquals((Integer) 3, ListIterate.max(Lists.mutable.of(2, 1, 3)));
        Assert.assertEquals((Integer) 1, ListIterate.max(new LinkedList<>(Lists.mutable.of(2, 1, 3)), Comparators.reverseNaturalOrder()));
        Assert.assertEquals((Integer) 3, ListIterate.max(new LinkedList<>(Lists.mutable.of(2, 1, 3))));
    }
    ...
    private void assertGroupByEach(List<Integer> list) {
        ...
        Assert.assertEquals(FastListMultimap.newMultimap(Tuples.pair(1, 1), Tuples.pair(1, 1), Tuples.pair(2, 2), Tuples.pair(2, 2), Tuples.pair(3, 3), Tuples.pair(3, 3)), multimap);
    }
    ...
    private void validateDetectWithOptional(List<Integer> list) {
        ...
        Assert.assertFalse(ListIterate.detectWithOptional(list, Predicates2.attributeEqual(Functions.getPassThru()), 7).isPresent());
    }
    ...
    public void select() {
        ...
        Assert.assertEquals(expected, ListIterate.select(new LinkedList<>(list), IntegerPredicates.isEven(), Lists.mutable.empty()));
    }
    ...
    public void reject() {
        MutableList<Integer> list = this.getIntegerList();
        Assert.assertEquals(Lists.mutable.of(4, 2), ListIterate.reject(list, IntegerPredicates.isOdd(), Lists.mutable.empty()));
        Assert.assertEquals(Lists.mutable.of(4, 2), ListIterate.reject(new LinkedList<>(list), IntegerPredicates.isOdd(), Lists.mutable.empty()));
    }
    ...
    public void removeIfWithProcedure() {
        ...
        Assert.assertTrue(ListIterate.removeIf(list1, IntegerPredicates.isEven(), CollectionAddProcedure.on(resultList1)));
        ...
        Assert.assertFalse(ListIterate.removeIf(list1, IntegerPredicates.isNegative(), CollectionAddProcedure.on(resultList1)));
        Assert.assertEquals(expected, list1);
        Assert.assertEquals(expectedToCollect, resultList1);
        Assert.assertTrue(ListIterate.removeIf(list2, IntegerPredicates.isEven(), CollectionAddProcedure.on(resultList2)));
        Assert.assertEquals(expected, list2);
        Assert.assertEquals(expectedToCollect, resultList2);
        Assert.assertFalse(ListIterate.removeIf(list2, IntegerPredicates.isNegative(), CollectionAddProcedure.on(resultList2)));
        Assert.assertEquals(expected, list2);
        Assert.assertEquals(expectedToCollect, resultList2);
    }
    ...
    private void assertRemoveIfWithProcedureAndParameter(List<Integer> list) {
        ...
        Assert.assertTrue(ListIterate.removeIfWith(list, Predicates2.equal(), 3, CollectionAddProcedure.on(target)));
        MutableList<Integer> expected = Lists.mutable.of(1, 2, 4, 5);
        Assert.assertEquals(expected, list);
        Assert.assertEquals(Lists.mutable.of(3), target);
        target.clear();
        Assert.assertFalse(ListIterate.removeIfWith(list, Predicates2.equal(), 3, CollectionAddProcedure.on(target)));
        Assert.assertEquals(expected, list);
    ...
    public void zipWithIndex() {
        List<Integer> integers = Interval.oneTo(3);
        List<Twin<Integer>> expected = Lists.mutable.with(Tuples.twin(1, 0), Tuples.twin(2, 1), Tuples.twin(3, 2));
    ...
    public static class _Benchmark {
        ...
        private ListIterateTest instance;
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toArray_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.toArray_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatten() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatten);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_occurrencesOfAttributeNamedOnList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.occurrencesOfAttributeNamedOnList);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_forEachInRange() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.forEachInRange);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_forEachInBothThrowsOnDifferentLengthLists() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.forEachInBothThrowsOnDifferentLengthLists);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_chunkWithIllegalSize() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.chunkWithIllegalSize);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfWithProcedure() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfWithProcedure);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfWithProcedureAndParameter() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfWithProcedureAndParameter);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> payload) throws java.lang.Throwable {
            this.instance = new ListIterateTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectInto;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> toArray_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectLastIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectIndexWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoMaxString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> injectIntoMinString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> collectWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> flatten;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> getFirstAndLast;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> getFirstAndLastOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> occurrencesOfAttributeNamedOnList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachUsingFromTo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachWithIndexUsingFromTo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> reverseForEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> reverseForEach_emptyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> reverseForEachWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectOptional;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> sumOfInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> groupByEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> minBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> maxBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectWithOptional;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachInRange;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachInBoth;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> forEachInBothThrowsOnDifferentLengthLists;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> detectWithIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> selectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> selectInstanceOf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> distinct;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> distinctBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> rejectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> selectAndRejectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> partitionWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> anySatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> allSatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> noneSatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> countWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> collectIf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> reverseThis;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> take;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> take_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> drop;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> drop_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> chunk;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> chunkWithIllegalSize;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> removeIfWithProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> removeIfWithProcedureAndParameter;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> removeIf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> removeIfWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> zip;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> zipWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> takeWhile;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> dropWhile;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListIterateTest> partitionWhile;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.injectInto = ListIterateTest::injectInto;
            this.payloads.toArray = ListIterateTest::toArray;
            this.payloads.toArray_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(ListIterateTest::toArray_throws, java.lang.ArrayIndexOutOfBoundsException.class);
            this.payloads.detectIndex = ListIterateTest::detectIndex;
            this.payloads.detectLastIndex = ListIterateTest::detectLastIndex;
            this.payloads.detectIndexWith = ListIterateTest::detectIndexWith;
            this.payloads.forEachWith = ListIterateTest::forEachWith;
            this.payloads.injectIntoInt = ListIterateTest::injectIntoInt;
            this.payloads.injectIntoLong = ListIterateTest::injectIntoLong;
            this.payloads.injectIntoDouble = ListIterateTest::injectIntoDouble;
            this.payloads.injectIntoFloat = ListIterateTest::injectIntoFloat;
            this.payloads.injectIntoString = ListIterateTest::injectIntoString;
            this.payloads.injectIntoMaxString = ListIterateTest::injectIntoMaxString;
            this.payloads.injectIntoMinString = ListIterateTest::injectIntoMinString;
            this.payloads.collect = ListIterateTest::collect;
            this.payloads.collectWithIndex = ListIterateTest::collectWithIndex;
            this.payloads.flatten = ListIterateTest::flatten;
            this.payloads.getFirstAndLast = ListIterateTest::getFirstAndLast;
            this.payloads.getFirstAndLastOnEmpty = ListIterateTest::getFirstAndLastOnEmpty;
            this.payloads.occurrencesOfAttributeNamedOnList = ListIterateTest::occurrencesOfAttributeNamedOnList;
            this.payloads.forEachWithIndex = ListIterateTest::forEachWithIndex;
            this.payloads.forEachUsingFromTo = ListIterateTest::forEachUsingFromTo;
            this.payloads.forEachWithIndexUsingFromTo = ListIterateTest::forEachWithIndexUsingFromTo;
            this.payloads.reverseForEach = ListIterateTest::reverseForEach;
            this.payloads.reverseForEach_emptyList = ListIterateTest::reverseForEach_emptyList;
            this.payloads.reverseForEachWithIndex = ListIterateTest::reverseForEachWithIndex;
            this.payloads.detectOptional = ListIterateTest::detectOptional;
            this.payloads.sumOfInt = ListIterateTest::sumOfInt;
            this.payloads.groupByEach = ListIterateTest::groupByEach;
            this.payloads.min = ListIterateTest::min;
            this.payloads.minBy = ListIterateTest::minBy;
            this.payloads.max = ListIterateTest::max;
            this.payloads.maxBy = ListIterateTest::maxBy;
            this.payloads.allSatisfy = ListIterateTest::allSatisfy;
            this.payloads.detectWithOptional = ListIterateTest::detectWithOptional;
            this.payloads.forEachInRange = ListIterateTest::forEachInRange;
            this.payloads.forEachInBoth = ListIterateTest::forEachInBoth;
            this.payloads.forEachInBothThrowsOnDifferentLengthLists = new se.chalmers.ju2jmh.api.ExceptionTest<>(ListIterateTest::forEachInBothThrowsOnDifferentLengthLists, java.lang.RuntimeException.class);
            this.payloads.detectWith = ListIterateTest::detectWith;
            this.payloads.detectIfNone = ListIterateTest::detectIfNone;
            this.payloads.detectWithIfNone = ListIterateTest::detectWithIfNone;
            this.payloads.select = ListIterateTest::select;
            this.payloads.selectWith = ListIterateTest::selectWith;
            this.payloads.selectInstanceOf = ListIterateTest::selectInstanceOf;
            this.payloads.distinct = ListIterateTest::distinct;
            this.payloads.distinctBy = ListIterateTest::distinctBy;
            this.payloads.reject = ListIterateTest::reject;
            this.payloads.rejectWith = ListIterateTest::rejectWith;
            this.payloads.selectAndRejectWith = ListIterateTest::selectAndRejectWith;
            this.payloads.partitionWith = ListIterateTest::partitionWith;
            this.payloads.anySatisfyWith = ListIterateTest::anySatisfyWith;
            this.payloads.anySatisfy = ListIterateTest::anySatisfy;
            this.payloads.allSatisfyWith = ListIterateTest::allSatisfyWith;
            this.payloads.noneSatisfy = ListIterateTest::noneSatisfy;
            this.payloads.noneSatisfyWith = ListIterateTest::noneSatisfyWith;
            this.payloads.countWith = ListIterateTest::countWith;
            this.payloads.count = ListIterateTest::count;
            this.payloads.collectIf = ListIterateTest::collectIf;
            this.payloads.reverseThis = ListIterateTest::reverseThis;
            this.payloads.take = ListIterateTest::take;
            this.payloads.take_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(ListIterateTest::take_throws, java.lang.IllegalArgumentException.class);
            this.payloads.drop = ListIterateTest::drop;
            this.payloads.drop_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(ListIterateTest::drop_throws, java.lang.IllegalArgumentException.class);
            this.payloads.chunk = ListIterateTest::chunk;
            this.payloads.chunkWithIllegalSize = new se.chalmers.ju2jmh.api.ExceptionTest<>(ListIterateTest::chunkWithIllegalSize, java.lang.IllegalArgumentException.class);
            this.payloads.removeIfWithProcedure = ListIterateTest::removeIfWithProcedure;
            this.payloads.removeIfWithProcedureAndParameter = ListIterateTest::removeIfWithProcedureAndParameter;
            this.payloads.removeIf = ListIterateTest::removeIf;
            this.payloads.removeIfWith = ListIterateTest::removeIfWith;
            this.payloads.zip = ListIterateTest::zip;
            this.payloads.zipWithIndex = ListIterateTest::zipWithIndex;
            this.payloads.classIsNonInstantiable = ListIterateTest::classIsNonInstantiable;
            this.payloads.takeWhile = ListIterateTest::takeWhile;
            this.payloads.dropWhile = ListIterateTest::dropWhile;
