...
public class IntFloatHashMapKeyValuesViewTest extends AbstractIntFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private IntFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new IntFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public IntFloatHashMapKeyValuesViewTest implementation() {
