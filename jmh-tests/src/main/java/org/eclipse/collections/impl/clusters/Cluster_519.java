    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.list.immutable.ImmutableSeptupletonListTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_519() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.subListFromGreaterThanTO);
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.castToCollection);
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.listIterator_throwsNegative);
        }
