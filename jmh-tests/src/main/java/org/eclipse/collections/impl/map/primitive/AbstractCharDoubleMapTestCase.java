...
public abstract class AbstractCharDoubleMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(CharHashSet.newSetWith((char) 0, (char) 31, (char) 32), this.newWithKeysValues((char) 0, 0.0, (char) 31, 31.0, (char) 32, 32.0).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues((char) 0, 0.0, (char) 1, 1.0, (char) 32, 32.0).hashCode(), this.newWithKeysValues((char) 32, 32.0, (char) 0, 0.0, (char) 1, 1.0).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((char) 50, 0.0, (char) 60, 1.0, (char) 70, 33.0).hashCode(), this.newWithKeysValues((char) 50, 0.0, (char) 60, 1.0, (char) 70, 33.0).hashCode());
    ...
    public void injectIntoKeyValue() {
        CharDoubleMap map0 = this.newWithKeysValues((char) 0, 1.0, (char) 3, 4.0);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, char eachKey, double eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        CharDoubleMap copy = map0.injectIntoKeyValue(CharDoubleMaps.mutable.empty(), MutableCharDoubleMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues((char) 2, 2.0, (char) 3, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0)) || this.newWithKeysValues((char) 2, 2.0, (char) 3, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(DoubleBags.mutable.with(1.0)).toSet(), this.newWithKeysValues((char) 1, 1.0).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((char) 1, 1.0).chunk(-1));
    }
    ...
    public static class _Benchmark {
        ...
        private AbstractCharDoubleMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractCharDoubleMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> doubleIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractCharDoubleMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractCharDoubleMapTestCase::keySet;
            this.payloads.values = AbstractCharDoubleMapTestCase::values;
            this.payloads.get = AbstractCharDoubleMapTestCase::get;
            this.payloads.getIfAbsent = AbstractCharDoubleMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractCharDoubleMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractCharDoubleMapTestCase::containsKey;
            this.payloads.containsValue = AbstractCharDoubleMapTestCase::containsValue;
            this.payloads.contains = AbstractCharDoubleMapTestCase::contains;
            this.payloads.containsAll = AbstractCharDoubleMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractCharDoubleMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractCharDoubleMapTestCase::size;
            this.payloads.isEmpty = AbstractCharDoubleMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractCharDoubleMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractCharDoubleMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractCharDoubleMapTestCase::testHashCode;
            this.payloads.testToString = AbstractCharDoubleMapTestCase::testToString;
            this.payloads.forEach = AbstractCharDoubleMapTestCase::forEach;
            this.payloads.forEachValue = AbstractCharDoubleMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractCharDoubleMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractCharDoubleMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractCharDoubleMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractCharDoubleMapTestCase::makeString;
            this.payloads.appendString = AbstractCharDoubleMapTestCase::appendString;
            this.payloads.select = AbstractCharDoubleMapTestCase::select;
            this.payloads.reject = AbstractCharDoubleMapTestCase::reject;
            this.payloads.select_value = AbstractCharDoubleMapTestCase::select_value;
            this.payloads.reject_value = AbstractCharDoubleMapTestCase::reject_value;
            this.payloads.collect = AbstractCharDoubleMapTestCase::collect;
            this.payloads.count = AbstractCharDoubleMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractCharDoubleMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractCharDoubleMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractCharDoubleMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractCharDoubleMapTestCase::noneSatisfy;
            this.payloads.max = AbstractCharDoubleMapTestCase::max;
            this.payloads.min = AbstractCharDoubleMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharDoubleMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharDoubleMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractCharDoubleMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractCharDoubleMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractCharDoubleMapTestCase::sum;
            this.payloads.average = AbstractCharDoubleMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharDoubleMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractCharDoubleMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractCharDoubleMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractCharDoubleMapTestCase::toList;
            this.payloads.toSortedList = AbstractCharDoubleMapTestCase::toSortedList;
            this.payloads.toSet = AbstractCharDoubleMapTestCase::toSet;
            this.payloads.toBag = AbstractCharDoubleMapTestCase::toBag;
            this.payloads.doubleIterator = AbstractCharDoubleMapTestCase::doubleIterator;
            this.payloads.asLazy = AbstractCharDoubleMapTestCase::asLazy;
            this.payloads.keysView = AbstractCharDoubleMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractCharDoubleMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractCharDoubleMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractCharDoubleMapTestCase::toArray;
            this.payloads.toImmutable = AbstractCharDoubleMapTestCase::toImmutable;
            this.payloads.chunk = AbstractCharDoubleMapTestCase::chunk;
        }
    }
}
