...
public class MutableByte extends Number implements Comparable<MutableByte> {
    ...
    public static class _Benchmark {
        ...
        private MutableByte instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableByte> payload) throws java.lang.Throwable {
            this.instance = new MutableByte();
