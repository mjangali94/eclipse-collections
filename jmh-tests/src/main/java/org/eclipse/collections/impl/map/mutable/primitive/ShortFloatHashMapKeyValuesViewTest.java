...
public class ShortFloatHashMapKeyValuesViewTest extends AbstractShortFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ShortFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ShortFloatHashMapKeyValuesViewTest implementation() {
