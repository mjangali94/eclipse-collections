...
public class UnmodifiableDoubleFloatMapKeyValuesViewTest extends AbstractDoubleFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableDoubleFloatMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableDoubleFloatMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableDoubleFloatMapKeyValuesViewTest implementation() {
