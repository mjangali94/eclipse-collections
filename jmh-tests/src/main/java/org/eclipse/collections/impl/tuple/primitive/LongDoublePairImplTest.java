...
public class LongDoublePairImplTest {
    ...
    public static class _Benchmark {
        ...
        private LongDoublePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new LongDoublePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongDoublePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = LongDoublePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = LongDoublePairImplTest::getOne;
            this.payloads.getTwo = LongDoublePairImplTest::getTwo;
            this.payloads.testToString = LongDoublePairImplTest::testToString;
            this.payloads.compareTo = LongDoublePairImplTest::compareTo;
        }
    }
}
