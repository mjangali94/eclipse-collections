...
public class ArrayIterateTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_minWithComparator() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::minWithComparator, this.description("minWithComparator"));
        }
        ...
        public void benchmark_maxWithComparator() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::maxWithComparator, this.description("maxWithComparator"));
        }
