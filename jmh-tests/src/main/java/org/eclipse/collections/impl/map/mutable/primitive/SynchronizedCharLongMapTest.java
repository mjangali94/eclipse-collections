...
public class SynchronizedCharLongMapTest extends AbstractMutableCharLongMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableCharLongMapTestCase._Benchmark {
        ...
        private SynchronizedCharLongMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedCharLongMapTest();
        }

        @java.lang.Override
        public SynchronizedCharLongMapTest implementation() {
