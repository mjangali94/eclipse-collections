...
public abstract class NonParallelUnsortedSetIterableTestCase extends ParallelUnsortedSetIterableTestCase {
    ...
    public static abstract class _Benchmark extends org.eclipse.collections.impl.lazy.parallel.set.ParallelUnsortedSetIterableTestCase._Benchmark {
        ...
        @java.lang.Override
        public abstract NonParallelUnsortedSetIterableTestCase implementation();
    }
}
