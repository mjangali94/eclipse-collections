...
/*
    ...
    public static class _Benchmark {
        ...
        private ByteByteMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteByteMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ByteByteMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteByteMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteByteMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteByteMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ByteByteMapFactoryTest::of;
            this.payloads.withAll = ByteByteMapFactoryTest::withAll;
            this.payloads.from = ByteByteMapFactoryTest::from;
        }
    }
*/
}
