...
public class LongLongMapsTest {
    ...
    public static class _Benchmark {
        ...
        private LongLongMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongMapsTest> payload) throws java.lang.Throwable {
            this.instance = new LongLongMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongMapsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongLongMapsTest> mutables;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = LongLongMapsTest::immutables;
            this.payloads.mutables = LongLongMapsTest::mutables;
        }
    }
}
