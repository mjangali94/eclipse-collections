...
public abstract class AbstractIntDoubleMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(IntHashSet.newSetWith(0, 31, 32), this.newWithKeysValues(0, 0.0, 31, 31.0, 32, 32.0).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues(0, 0.0, 1, 1.0, 32, 32.0).hashCode(), this.newWithKeysValues(32, 32.0, 0, 0.0, 1, 1.0).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues(50, 0.0, 60, 1.0, 70, 33.0).hashCode(), this.newWithKeysValues(50, 0.0, 60, 1.0, 70, 33.0).hashCode());
    ...
    public void injectIntoKeyValue() {
        IntDoubleMap map0 = this.newWithKeysValues(0, 1.0, 3, 4.0);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, int eachKey, double eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        IntDoubleMap copy = map0.injectIntoKeyValue(IntDoubleMaps.mutable.empty(), MutableIntDoubleMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues(2, 2.0, 3, 3.0).toList().equals(DoubleArrayList.newListWith(2.0, 3.0)) || this.newWithKeysValues(2, 2.0, 3, 3.0).toList().equals(DoubleArrayList.newListWith(3.0, 2.0)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(DoubleBags.mutable.with(1.0)).toSet(), this.newWithKeysValues(1, 1.0).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues(1, 1.0).chunk(-1));
    }
    ...
    public static class _Benchmark {
        ...
        private AbstractIntDoubleMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractIntDoubleMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> doubleIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractIntDoubleMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractIntDoubleMapTestCase::keySet;
            this.payloads.values = AbstractIntDoubleMapTestCase::values;
            this.payloads.get = AbstractIntDoubleMapTestCase::get;
            this.payloads.getIfAbsent = AbstractIntDoubleMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractIntDoubleMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractIntDoubleMapTestCase::containsKey;
            this.payloads.containsValue = AbstractIntDoubleMapTestCase::containsValue;
            this.payloads.contains = AbstractIntDoubleMapTestCase::contains;
            this.payloads.containsAll = AbstractIntDoubleMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractIntDoubleMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractIntDoubleMapTestCase::size;
            this.payloads.isEmpty = AbstractIntDoubleMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractIntDoubleMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractIntDoubleMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractIntDoubleMapTestCase::testHashCode;
            this.payloads.testToString = AbstractIntDoubleMapTestCase::testToString;
            this.payloads.forEach = AbstractIntDoubleMapTestCase::forEach;
            this.payloads.forEachValue = AbstractIntDoubleMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractIntDoubleMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractIntDoubleMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractIntDoubleMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractIntDoubleMapTestCase::makeString;
            this.payloads.appendString = AbstractIntDoubleMapTestCase::appendString;
            this.payloads.select = AbstractIntDoubleMapTestCase::select;
            this.payloads.reject = AbstractIntDoubleMapTestCase::reject;
            this.payloads.select_value = AbstractIntDoubleMapTestCase::select_value;
            this.payloads.reject_value = AbstractIntDoubleMapTestCase::reject_value;
            this.payloads.collect = AbstractIntDoubleMapTestCase::collect;
            this.payloads.count = AbstractIntDoubleMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractIntDoubleMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractIntDoubleMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractIntDoubleMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractIntDoubleMapTestCase::noneSatisfy;
            this.payloads.max = AbstractIntDoubleMapTestCase::max;
            this.payloads.min = AbstractIntDoubleMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractIntDoubleMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractIntDoubleMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractIntDoubleMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractIntDoubleMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractIntDoubleMapTestCase::sum;
            this.payloads.average = AbstractIntDoubleMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractIntDoubleMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractIntDoubleMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractIntDoubleMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractIntDoubleMapTestCase::toList;
            this.payloads.toSortedList = AbstractIntDoubleMapTestCase::toSortedList;
            this.payloads.toSet = AbstractIntDoubleMapTestCase::toSet;
            this.payloads.toBag = AbstractIntDoubleMapTestCase::toBag;
            this.payloads.doubleIterator = AbstractIntDoubleMapTestCase::doubleIterator;
            this.payloads.asLazy = AbstractIntDoubleMapTestCase::asLazy;
            this.payloads.keysView = AbstractIntDoubleMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractIntDoubleMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractIntDoubleMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractIntDoubleMapTestCase::toArray;
            this.payloads.toImmutable = AbstractIntDoubleMapTestCase::toImmutable;
            this.payloads.chunk = AbstractIntDoubleMapTestCase::chunk;
        }
    }
}
