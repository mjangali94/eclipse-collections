...
public class ShortStacksTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_ofAllShortIterable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ofAllShortIterable, this.description("ofAllShortIterable"));
        }
        ...
        private ShortStacksTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortStacksTest();
        }

        @java.lang.Override
        public ShortStacksTest implementation() {
