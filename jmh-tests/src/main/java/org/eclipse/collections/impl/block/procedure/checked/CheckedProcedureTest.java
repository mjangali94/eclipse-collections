...
public class CheckedProcedureTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new CheckedProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> dateProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> collectionProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> mapProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> checkedObjectIntProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> numberProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedProcedureTest> timestampProcedure;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.dateProcedure = CheckedProcedureTest::dateProcedure;
            this.payloads.collectionProcedure = CheckedProcedureTest::collectionProcedure;
            this.payloads.mapProcedure = CheckedProcedureTest::mapProcedure;
            this.payloads.checkedObjectIntProcedure = CheckedProcedureTest::checkedObjectIntProcedure;
            this.payloads.numberProcedure = CheckedProcedureTest::numberProcedure;
