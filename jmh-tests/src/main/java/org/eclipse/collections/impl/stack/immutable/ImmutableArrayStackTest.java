...
public class ImmutableArrayStackTest extends ImmutableStackTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.stack.immutable.ImmutableStackTestCase._Benchmark {
        ...
        public void benchmark_peekAndPop() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::peekAndPop, this.description("peekAndPop"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_peekAndPopCount() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::peekAndPopCount, this.description("peekAndPopCount"));
        }
