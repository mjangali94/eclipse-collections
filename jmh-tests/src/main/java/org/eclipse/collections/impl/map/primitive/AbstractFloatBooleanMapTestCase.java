...
public abstract class AbstractFloatBooleanMapTestCase {
    ...
    public static class _Benchmark {
        ...
        private AbstractFloatBooleanMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractFloatBooleanMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> containsAllIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> booleanIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractFloatBooleanMapTestCase> toImmutable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.get = AbstractFloatBooleanMapTestCase::get;
            this.payloads.getIfAbsent = AbstractFloatBooleanMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractFloatBooleanMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractFloatBooleanMapTestCase::containsKey;
            this.payloads.containsValue = AbstractFloatBooleanMapTestCase::containsValue;
            this.payloads.contains = AbstractFloatBooleanMapTestCase::contains;
            this.payloads.containsAll = AbstractFloatBooleanMapTestCase::containsAll;
            this.payloads.containsAllIterable = AbstractFloatBooleanMapTestCase::containsAllIterable;
            this.payloads.size = AbstractFloatBooleanMapTestCase::size;
            this.payloads.isEmpty = AbstractFloatBooleanMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractFloatBooleanMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractFloatBooleanMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractFloatBooleanMapTestCase::testHashCode;
            this.payloads.testToString = AbstractFloatBooleanMapTestCase::testToString;
            this.payloads.forEach = AbstractFloatBooleanMapTestCase::forEach;
            this.payloads.forEachValue = AbstractFloatBooleanMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractFloatBooleanMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractFloatBooleanMapTestCase::forEachKeyValue;
            this.payloads.makeString = AbstractFloatBooleanMapTestCase::makeString;
            this.payloads.appendString = AbstractFloatBooleanMapTestCase::appendString;
            this.payloads.select = AbstractFloatBooleanMapTestCase::select;
            this.payloads.reject = AbstractFloatBooleanMapTestCase::reject;
            this.payloads.select_value = AbstractFloatBooleanMapTestCase::select_value;
            this.payloads.reject_value = AbstractFloatBooleanMapTestCase::reject_value;
            this.payloads.collect = AbstractFloatBooleanMapTestCase::collect;
            this.payloads.count = AbstractFloatBooleanMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractFloatBooleanMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractFloatBooleanMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractFloatBooleanMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractFloatBooleanMapTestCase::noneSatisfy;
            this.payloads.toList = AbstractFloatBooleanMapTestCase::toList;
            this.payloads.toSet = AbstractFloatBooleanMapTestCase::toSet;
            this.payloads.toBag = AbstractFloatBooleanMapTestCase::toBag;
            this.payloads.booleanIterator = AbstractFloatBooleanMapTestCase::booleanIterator;
            this.payloads.asLazy = AbstractFloatBooleanMapTestCase::asLazy;
            this.payloads.keysView = AbstractFloatBooleanMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractFloatBooleanMapTestCase::keyValuesView;
            this.payloads.toArray = AbstractFloatBooleanMapTestCase::toArray;
