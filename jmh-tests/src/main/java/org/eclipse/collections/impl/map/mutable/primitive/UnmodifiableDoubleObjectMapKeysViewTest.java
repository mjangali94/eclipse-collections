...
public class UnmodifiableDoubleObjectMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private UnmodifiableDoubleObjectMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableDoubleObjectMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableDoubleObjectMapKeysViewTest implementation() {
