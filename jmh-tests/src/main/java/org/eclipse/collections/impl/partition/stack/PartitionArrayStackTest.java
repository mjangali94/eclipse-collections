...
/*
    ...
    public static class _Benchmark {
        ...
        private PartitionArrayStackTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionArrayStackTest> payload) throws java.lang.Throwable {
            this.instance = new PartitionArrayStackTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionArrayStackTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionArrayStackTest> toImmutable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(PartitionArrayStackTest::add, java.lang.UnsupportedOperationException.class);
