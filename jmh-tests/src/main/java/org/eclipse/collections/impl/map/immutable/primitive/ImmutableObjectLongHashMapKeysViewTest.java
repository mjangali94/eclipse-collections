...
public class ImmutableObjectLongHashMapKeysViewTest extends AbstractObjectLongMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectLongMapKeysViewTestCase._Benchmark {
        ...
        private ImmutableObjectLongHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableObjectLongHashMapKeysViewTest();
        }

        @java.lang.Override
        public ImmutableObjectLongHashMapKeysViewTest implementation() {
