...
public class FastListRejectProcedureTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private FastListRejectProcedureTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FastListRejectProcedureTest();
        }

        @java.lang.Override
        public FastListRejectProcedureTest implementation() {
