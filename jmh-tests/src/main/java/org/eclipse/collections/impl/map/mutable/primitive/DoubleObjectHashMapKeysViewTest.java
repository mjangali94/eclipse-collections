...
public class DoubleObjectHashMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private DoubleObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public DoubleObjectHashMapKeysViewTest implementation() {
