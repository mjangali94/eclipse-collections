...
public abstract class AbstractShortCharMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32), this.newWithKeysValues((short) 0, (char) 0, (short) 31, (char) 31, (short) 32, (char) 32).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 0, (char) 0, (short) 1, (char) 1, (short) 32, (char) 32).hashCode(), this.newWithKeysValues((short) 32, (char) 32, (short) 0, (char) 0, (short) 1, (char) 1).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 50, (char) 0, (short) 60, (char) 1, (short) 70, (char) 33).hashCode(), this.newWithKeysValues((short) 50, (char) 0, (short) 60, (char) 1, (short) 70, (char) 33).hashCode());
    ...
    public void injectIntoKeyValue() {
        ShortCharMap map0 = this.newWithKeysValues((short) 0, (char) 1, (short) 3, (char) 4);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, short eachKey, char eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        ShortCharMap copy = map0.injectIntoKeyValue(ShortCharMaps.mutable.empty(), MutableShortCharMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 2, (char) 2, (short) 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 2, (char) 3)) || this.newWithKeysValues((short) 2, (char) 2, (short) 3, (char) 3).toList().equals(CharArrayList.newListWith((char) 3, (char) 2)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(CharBags.mutable.with((char) 1)).toSet(), this.newWithKeysValues((short) 1, (char) 1).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, (char) 1).chunk(-1));
    }
...
/*
    ...
    public static class _Benchmark {
        ...
        private AbstractShortCharMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractShortCharMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> charIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortCharMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractShortCharMapTestCase::keySet;
            this.payloads.values = AbstractShortCharMapTestCase::values;
            this.payloads.get = AbstractShortCharMapTestCase::get;
            this.payloads.getIfAbsent = AbstractShortCharMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractShortCharMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractShortCharMapTestCase::containsKey;
            this.payloads.containsValue = AbstractShortCharMapTestCase::containsValue;
            this.payloads.contains = AbstractShortCharMapTestCase::contains;
            this.payloads.containsAll = AbstractShortCharMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractShortCharMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractShortCharMapTestCase::size;
            this.payloads.isEmpty = AbstractShortCharMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractShortCharMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractShortCharMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractShortCharMapTestCase::testHashCode;
            this.payloads.testToString = AbstractShortCharMapTestCase::testToString;
            this.payloads.forEach = AbstractShortCharMapTestCase::forEach;
            this.payloads.forEachValue = AbstractShortCharMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractShortCharMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractShortCharMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractShortCharMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractShortCharMapTestCase::makeString;
            this.payloads.appendString = AbstractShortCharMapTestCase::appendString;
            this.payloads.select = AbstractShortCharMapTestCase::select;
            this.payloads.reject = AbstractShortCharMapTestCase::reject;
            this.payloads.select_value = AbstractShortCharMapTestCase::select_value;
            this.payloads.reject_value = AbstractShortCharMapTestCase::reject_value;
            this.payloads.collect = AbstractShortCharMapTestCase::collect;
            this.payloads.count = AbstractShortCharMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractShortCharMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractShortCharMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractShortCharMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractShortCharMapTestCase::noneSatisfy;
            this.payloads.max = AbstractShortCharMapTestCase::max;
            this.payloads.min = AbstractShortCharMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortCharMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortCharMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractShortCharMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractShortCharMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractShortCharMapTestCase::sum;
            this.payloads.average = AbstractShortCharMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortCharMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractShortCharMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortCharMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractShortCharMapTestCase::toList;
            this.payloads.toSortedList = AbstractShortCharMapTestCase::toSortedList;
            this.payloads.toSet = AbstractShortCharMapTestCase::toSet;
            this.payloads.toBag = AbstractShortCharMapTestCase::toBag;
            this.payloads.charIterator = AbstractShortCharMapTestCase::charIterator;
            this.payloads.asLazy = AbstractShortCharMapTestCase::asLazy;
            this.payloads.keysView = AbstractShortCharMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractShortCharMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractShortCharMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractShortCharMapTestCase::toArray;
            this.payloads.toImmutable = AbstractShortCharMapTestCase::toImmutable;
            this.payloads.chunk = AbstractShortCharMapTestCase::chunk;
        }
    }
*/
}
