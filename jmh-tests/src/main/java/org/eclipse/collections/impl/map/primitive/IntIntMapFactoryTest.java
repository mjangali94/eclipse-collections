...
/*
    ...
    public static class _Benchmark {
        ...
        private IntIntMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new IntIntMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = IntIntMapFactoryTest::of;
            this.payloads.withAll = IntIntMapFactoryTest::withAll;
            this.payloads.from = IntIntMapFactoryTest::from;
        }
    }
*/
}
