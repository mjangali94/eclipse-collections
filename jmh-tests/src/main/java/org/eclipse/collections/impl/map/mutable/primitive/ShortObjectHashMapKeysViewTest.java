...
public class ShortObjectHashMapKeysViewTest extends AbstractLazyShortIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyShortIterableTestCase._Benchmark {
        ...
        private ShortObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public ShortObjectHashMapKeysViewTest implementation() {
