...
public class SynchronizedFloatObjectMapValuesTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private SynchronizedFloatObjectMapValuesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedFloatObjectMapValuesTest();
        }

        @java.lang.Override
        public SynchronizedFloatObjectMapValuesTest implementation() {
