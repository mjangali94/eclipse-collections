...
public class SynchronizedFloatObjectMapValuesTest {
    ...
    public static class _Benchmark {
        ...
        private SynchronizedFloatObjectMapValuesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> payload) throws java.lang.Throwable {
            this.instance = new SynchronizedFloatObjectMapValuesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> clear;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> removeFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> removeNullFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> removeAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> retainAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedFloatObjectMapValuesTest> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedFloatObjectMapValuesTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedFloatObjectMapValuesTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.clear = SynchronizedFloatObjectMapValuesTest::clear;
            this.payloads.contains = SynchronizedFloatObjectMapValuesTest::contains;
            this.payloads.containsAll = SynchronizedFloatObjectMapValuesTest::containsAll;
            this.payloads.isEmpty = SynchronizedFloatObjectMapValuesTest::isEmpty;
            this.payloads.size = SynchronizedFloatObjectMapValuesTest::size;
            this.payloads.iterator = SynchronizedFloatObjectMapValuesTest::iterator;
            this.payloads.values = SynchronizedFloatObjectMapValuesTest::values;
            this.payloads.removeFromValues = SynchronizedFloatObjectMapValuesTest::removeFromValues;
            this.payloads.removeNullFromValues = SynchronizedFloatObjectMapValuesTest::removeNullFromValues;
            this.payloads.removeAllFromValues = SynchronizedFloatObjectMapValuesTest::removeAllFromValues;
            this.payloads.retainAllFromValues = SynchronizedFloatObjectMapValuesTest::retainAllFromValues;
            this.payloads.valuesToArray = SynchronizedFloatObjectMapValuesTest::valuesToArray;
        }
    }
}
