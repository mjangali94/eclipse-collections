...
public class ProceduresTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_throwingWithSuccessfulCompletion() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::throwingWithSuccessfulCompletion, this.description("throwingWithSuccessfulCompletion"));
        }
        ...
        public void benchmark_println() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::println, this.description("println"));
        }
        ...
        public void benchmark_appendWithException() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::appendWithException, this.description("appendWithException"), java.lang.RuntimeException.class);
        }
        ...
        public void benchmark_fromProcedureWithInt() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromProcedureWithInt, this.description("fromProcedureWithInt"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_noop() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::noop, this.description("noop"));
        }
        ...
        public void benchmark_caseDefault() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::caseDefault, this.description("caseDefault"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_caseDefaultWithACase() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::caseDefaultWithACase, this.description("caseDefaultWithACase"));
        }
        ...
        private ProceduresTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ProceduresTest();
        }

        @java.lang.Override
        public ProceduresTest implementation() {
