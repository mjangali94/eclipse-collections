...
public class IntFloatPairImplTest {
    ...
    public static class _Benchmark {
        ...
        private IntFloatPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new IntFloatPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = IntFloatPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = IntFloatPairImplTest::getOne;
            this.payloads.getTwo = IntFloatPairImplTest::getTwo;
            this.payloads.testToString = IntFloatPairImplTest::testToString;
            this.payloads.compareTo = IntFloatPairImplTest::compareTo;
        }
    }
}
