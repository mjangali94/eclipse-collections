...
public class SynchronizedShortLongMapTest extends AbstractMutableShortLongMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableShortLongMapTestCase._Benchmark {
        ...
        private SynchronizedShortLongMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortLongMapTest();
        }

        @java.lang.Override
        public SynchronizedShortLongMapTest implementation() {
