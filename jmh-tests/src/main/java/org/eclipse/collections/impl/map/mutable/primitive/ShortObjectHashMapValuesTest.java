...
public class ShortObjectHashMapValuesTest {
    ...
    public static class _Benchmark {
        ...
        private ShortObjectHashMapValuesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> payload) throws java.lang.Throwable {
            this.instance = new ShortObjectHashMapValuesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> clear;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> removeFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> removeNullFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> removeAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> retainAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortObjectHashMapValuesTest> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(ShortObjectHashMapValuesTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(ShortObjectHashMapValuesTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.clear = ShortObjectHashMapValuesTest::clear;
            this.payloads.contains = ShortObjectHashMapValuesTest::contains;
            this.payloads.containsAll = ShortObjectHashMapValuesTest::containsAll;
            this.payloads.isEmpty = ShortObjectHashMapValuesTest::isEmpty;
            this.payloads.size = ShortObjectHashMapValuesTest::size;
            this.payloads.iterator = ShortObjectHashMapValuesTest::iterator;
            this.payloads.values = ShortObjectHashMapValuesTest::values;
            this.payloads.removeFromValues = ShortObjectHashMapValuesTest::removeFromValues;
            this.payloads.removeNullFromValues = ShortObjectHashMapValuesTest::removeNullFromValues;
            this.payloads.removeAllFromValues = ShortObjectHashMapValuesTest::removeAllFromValues;
            this.payloads.retainAllFromValues = ShortObjectHashMapValuesTest::retainAllFromValues;
            this.payloads.valuesToArray = ShortObjectHashMapValuesTest::valuesToArray;
        }
    }
}
