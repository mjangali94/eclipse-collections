...
public class SynchronizedByteDoubleMapKeyValuesViewTest extends AbstractByteDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedByteDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedByteDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedByteDoubleMapKeyValuesViewTest implementation() {
