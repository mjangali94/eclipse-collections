...
public class ImmutableCharIntHashMapKeyValuesViewTest extends AbstractCharIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractCharIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableCharIntHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableCharIntHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableCharIntHashMapKeyValuesViewTest implementation() {
