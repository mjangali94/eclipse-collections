...
public class IntCaseFunctionTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntCaseFunctionTest> payload) throws java.lang.Throwable {
            this.instance = new IntCaseFunctionTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntCaseFunctionTest> noopCase;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntCaseFunctionTest> basicCase;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntCaseFunctionTest> defaultValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntCaseFunctionTest> fizzBuzz;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.noopCase = IntCaseFunctionTest::noopCase;
            this.payloads.basicCase = IntCaseFunctionTest::basicCase;
            this.payloads.defaultValue = IntCaseFunctionTest::defaultValue;
            this.payloads.fizzBuzz = IntCaseFunctionTest::fizzBuzz;
        }
    }
}
