...
public class ImmutableObjectDoubleHashMapKeysViewTest extends AbstractObjectDoubleMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectDoubleMapKeysViewTestCase._Benchmark {
        ...
        private ImmutableObjectDoubleHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableObjectDoubleHashMapKeysViewTest();
        }

        @java.lang.Override
        public ImmutableObjectDoubleHashMapKeysViewTest implementation() {
