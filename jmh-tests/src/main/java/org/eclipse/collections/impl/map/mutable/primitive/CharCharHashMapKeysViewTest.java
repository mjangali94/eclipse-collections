...
public class CharCharHashMapKeysViewTest extends AbstractLazyCharIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyCharIterableTestCase._Benchmark {
        ...
        private CharCharHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CharCharHashMapKeysViewTest();
        }

        @java.lang.Override
        public CharCharHashMapKeysViewTest implementation() {
