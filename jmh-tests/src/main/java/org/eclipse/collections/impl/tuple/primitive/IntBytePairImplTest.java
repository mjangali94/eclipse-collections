...
/*
    ...
    public static class _Benchmark {
        ...
        private IntBytePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new IntBytePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntBytePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = IntBytePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = IntBytePairImplTest::getOne;
            this.payloads.getTwo = IntBytePairImplTest::getTwo;
            this.payloads.testToString = IntBytePairImplTest::testToString;
            this.payloads.compareTo = IntBytePairImplTest::compareTo;
        }
    }
*/
}
