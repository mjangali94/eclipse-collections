...
public class ObjectDoubleHashMapValuesTest extends ObjectDoubleHashMapValuesTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.ObjectDoubleHashMapValuesTestCase._Benchmark {
        ...
        private ObjectDoubleHashMapValuesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectDoubleHashMapValuesTest();
        }

        @java.lang.Override
        public ObjectDoubleHashMapValuesTest implementation() {
