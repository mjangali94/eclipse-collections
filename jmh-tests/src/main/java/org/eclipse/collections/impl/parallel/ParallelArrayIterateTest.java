...
public class ParallelArrayIterateTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> payload) throws java.lang.Throwable {
            this.instance = new ParallelArrayIterateTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> parallelForEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> parallelForEachException;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> parallelForEachPerformanceOneThread;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> parallelForEachPerformanceTwoThreads;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ParallelArrayIterateTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.parallelForEach = ParallelArrayIterateTest::parallelForEach;
            this.payloads.parallelForEachException = ParallelArrayIterateTest::parallelForEachException;
            this.payloads.parallelForEachPerformanceOneThread = ParallelArrayIterateTest::parallelForEachPerformanceOneThread;
            this.payloads.parallelForEachPerformanceTwoThreads = ParallelArrayIterateTest::parallelForEachPerformanceTwoThreads;
            this.payloads.classIsNonInstantiable = ParallelArrayIterateTest::classIsNonInstantiable;
        }
    }
}
