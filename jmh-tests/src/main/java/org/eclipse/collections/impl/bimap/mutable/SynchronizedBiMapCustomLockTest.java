...
public class SynchronizedBiMapCustomLockTest extends AbstractMutableBiMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.bimap.mutable.AbstractMutableBiMapTestCase._Benchmark {

        private SynchronizedBiMapCustomLockTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedBiMapCustomLockTest();
        }

        @java.lang.Override
        public SynchronizedBiMapCustomLockTest implementation() {
