...
public class HashingStrategyBagsTest {
    ...
    public void mutable() {
        ...
        MutableList<Person> people = Lists.mutable.of(new Person("Alex", "Smith"), new Person("John", "Smith"), new Person("John", "Brown"));
        Assert.assertEquals(HashBagWithHashingStrategy.newBagWith(HashingStrategies.fromFunction(Person::getLastName)).withAll(people), factory.fromFunction(Person::getLastName).withAll(people));
        Assert.assertEquals(HashBagWithHashingStrategy.newBagWith(HashingStrategies.fromFunction(Person::getFirstName)).withAll(people), factory.fromFunction(Person::getFirstName).withAll(people));
    }
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyBagsTest> payload) throws java.lang.Throwable {
            this.instance = new HashingStrategyBagsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyBagsTest> mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyBagsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.mutable = HashingStrategyBagsTest::mutable;
