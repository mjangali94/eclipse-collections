...
/*
    ...
    public static class _Benchmark {
        ...
        private FixedSizeListFactoryTest instance;

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_createEmpty() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.createEmpty);
        }

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withExtra() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.withExtra);
        }
        ...
        public void benchmark_createList_singleton() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.createList_singleton);
        }

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_varArgsListCreation() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.varArgsListCreation);
        }
        ...
        public void benchmark_serializationOfEmptyList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.serializationOfEmptyList);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new FixedSizeListFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> createEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> withExtra;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> create1;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> create2;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> create3;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> create4;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> createList_singleton;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> varArgsListCreation;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> equalsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> serializationOfEmptyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> forEachWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> forEachWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FixedSizeListFactoryTest> getFirstGetLast;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.createEmpty = FixedSizeListFactoryTest::createEmpty;
            this.payloads.withExtra = FixedSizeListFactoryTest::withExtra;
            this.payloads.create1 = FixedSizeListFactoryTest::create1;
            this.payloads.create2 = FixedSizeListFactoryTest::create2;
            this.payloads.create3 = FixedSizeListFactoryTest::create3;
            this.payloads.create4 = FixedSizeListFactoryTest::create4;
            this.payloads.createList_singleton = FixedSizeListFactoryTest::createList_singleton;
            this.payloads.varArgsListCreation = FixedSizeListFactoryTest::varArgsListCreation;
            this.payloads.equalsAndHashCode = FixedSizeListFactoryTest::equalsAndHashCode;
            this.payloads.serializationOfEmptyList = FixedSizeListFactoryTest::serializationOfEmptyList;
            this.payloads.forEach = FixedSizeListFactoryTest::forEach;
            this.payloads.forEachWithIndex = FixedSizeListFactoryTest::forEachWithIndex;
            this.payloads.forEachWith = FixedSizeListFactoryTest::forEachWith;
