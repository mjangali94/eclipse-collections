...
public class UnmodifiableLongBooleanMapKeyValuesViewTest extends AbstractLongBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableLongBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableLongBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableLongBooleanMapKeyValuesViewTest implementation() {
