...
public class ImmutableFloatFloatMapKeySetTest extends AbstractImmutableFloatHashSetTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.set.mutable.primitive.AbstractImmutableFloatHashSetTestCase._Benchmark {
        ...
        private ImmutableFloatFloatMapKeySetTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableFloatFloatMapKeySetTest();
        }

        @java.lang.Override
        public ImmutableFloatFloatMapKeySetTest implementation() {
