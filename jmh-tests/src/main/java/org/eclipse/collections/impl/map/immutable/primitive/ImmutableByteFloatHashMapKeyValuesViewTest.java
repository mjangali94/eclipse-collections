...
public class ImmutableByteFloatHashMapKeyValuesViewTest extends AbstractByteFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableByteFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableByteFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableByteFloatHashMapKeyValuesViewTest implementation() {
