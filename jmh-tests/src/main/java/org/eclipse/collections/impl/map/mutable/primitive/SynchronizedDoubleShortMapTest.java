...
public class SynchronizedDoubleShortMapTest extends AbstractMutableDoubleShortMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableDoubleShortMapTestCase._Benchmark {
        ...
        private SynchronizedDoubleShortMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleShortMapTest();
        }

        @java.lang.Override
        public SynchronizedDoubleShortMapTest implementation() {
