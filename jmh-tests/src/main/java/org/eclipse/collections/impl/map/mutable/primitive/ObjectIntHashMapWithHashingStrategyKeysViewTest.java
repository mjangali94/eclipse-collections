...
public class ObjectIntHashMapWithHashingStrategyKeysViewTest extends AbstractObjectIntMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectIntMapKeysViewTestCase._Benchmark {
        ...
        private ObjectIntHashMapWithHashingStrategyKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectIntHashMapWithHashingStrategyKeysViewTest();
        }

        @java.lang.Override
        public ObjectIntHashMapWithHashingStrategyKeysViewTest implementation() {
