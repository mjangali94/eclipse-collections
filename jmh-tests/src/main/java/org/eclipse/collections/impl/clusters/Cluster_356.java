...
public class Cluster_356 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.list.mutable.ArrayListAdapterAsUnmodifiableTest._Benchmark _Benchmark_benchmark_1;
       ...
       private org.eclipse.collections.impl.collection.mutable.CollectionAdapterTest._Benchmark _Benchmark_benchmark_11;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_1 = new org.eclipse.collections.impl.list.mutable.ArrayListAdapterAsUnmodifiableTest._Benchmark();
        ...
        public void benchmark_Cluster_356() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.collectInt);
            ...
            this._Benchmark_benchmark_8.runBenchmark(this._Benchmark_benchmark_8.payloads.noneSatisfyWith);
            this._Benchmark_benchmark_8.runBenchmark(this._Benchmark_benchmark_8.payloads.anySatisfyWith);
            this._Benchmark_benchmark_8.runBenchmark(this._Benchmark_benchmark_8.payloads.allSatisfyWith);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.min_empty_throws);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.max_empty_throws);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.injectIntoDouble);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.injectIntoLong);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.injectIntoFloat);
            this._Benchmark_benchmark_8.runBenchmark(this._Benchmark_benchmark_8.payloads.sumInteger);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.injectIntoInt);
            this._Benchmark_benchmark_8.runBenchmark(this._Benchmark_benchmark_8.payloads.sumLong);
