...
public class SynchronizedShortByteMapTest extends AbstractMutableShortByteMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableShortByteMapTestCase._Benchmark {
        ...
        private SynchronizedShortByteMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortByteMapTest();
        }

        @java.lang.Override
        public SynchronizedShortByteMapTest implementation() {
