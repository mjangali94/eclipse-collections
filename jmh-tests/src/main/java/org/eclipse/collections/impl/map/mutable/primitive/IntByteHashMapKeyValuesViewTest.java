...
public class IntByteHashMapKeyValuesViewTest extends AbstractIntByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private IntByteHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new IntByteHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public IntByteHashMapKeyValuesViewTest implementation() {
