...
public abstract class AbstractSortedSetTestCase extends AbstractCollectionTestCase {
    ...
    public static abstract class _Benchmark extends org.eclipse.collections.impl.collection.mutable.AbstractCollectionTestCase._Benchmark {
        ...
        public void benchmark_selectWithIndexAllRejected() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::selectWithIndexAllRejected, this.description("selectWithIndexAllRejected"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectWithIndexNoneRejected() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::rejectWithIndexNoneRejected, this.description("rejectWithIndexNoneRejected"));
        }
