...
public class ImmutableShortSetFactoryImplTest {
    ...
    public static class _Benchmark {
        ...
        private ImmutableShortSetFactoryImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableShortSetFactoryImplTest> payload) throws java.lang.Throwable {
            this.instance = new ImmutableShortSetFactoryImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableShortSetFactoryImplTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableShortSetFactoryImplTest> with;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableShortSetFactoryImplTest> ofAll;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ImmutableShortSetFactoryImplTest::of;
            this.payloads.with = ImmutableShortSetFactoryImplTest::with;
