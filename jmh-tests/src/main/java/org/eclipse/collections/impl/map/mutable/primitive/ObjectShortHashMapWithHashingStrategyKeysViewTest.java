...
public class ObjectShortHashMapWithHashingStrategyKeysViewTest extends AbstractObjectShortMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectShortMapKeysViewTestCase._Benchmark {
        ...
        private ObjectShortHashMapWithHashingStrategyKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectShortHashMapWithHashingStrategyKeysViewTest();
        }

        @java.lang.Override
        public ObjectShortHashMapWithHashingStrategyKeysViewTest implementation() {
