...
/*
    ...
    public static class _Benchmark {
        ...
        private CharShortMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapsTest> payload) throws java.lang.Throwable {
            this.instance = new CharShortMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapsTest> mutables;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = CharShortMapsTest::immutables;
            this.payloads.mutables = CharShortMapsTest::mutables;
        }
    }
*/
}
