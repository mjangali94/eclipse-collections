...
public class CollectionAddProcedureTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_toStringTest() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::toStringTest, this.description("toStringTest"));
        }
        ...
        private CollectionAddProcedureTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CollectionAddProcedureTest();
        }

        @java.lang.Override
        public CollectionAddProcedureTest implementation() {
