...
/*
    ...
    public static class _Benchmark {
        ...
        private FloatListsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> payload) throws java.lang.Throwable {
            this.instance = new FloatListsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> emptyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> newListWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> newListWithArray_immutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> newListWithArray_mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> wrapCopy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> newListWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> newListWithWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatListsTest> ofAllIterable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = FloatListsTest::immutables;
            this.payloads.mutables = FloatListsTest::mutables;
            this.payloads.emptyList = FloatListsTest::emptyList;
            this.payloads.newListWith = FloatListsTest::newListWith;
            this.payloads.newListWithArray_immutable = FloatListsTest::newListWithArray_immutable;
            this.payloads.newListWithArray_mutable = FloatListsTest::newListWithArray_mutable;
            this.payloads.wrapCopy = FloatListsTest::wrapCopy;
            this.payloads.newListWithList = FloatListsTest::newListWithList;
            this.payloads.newListWithWithList = FloatListsTest::newListWithWithList;
            this.payloads.classIsNonInstantiable = FloatListsTest::classIsNonInstantiable;
