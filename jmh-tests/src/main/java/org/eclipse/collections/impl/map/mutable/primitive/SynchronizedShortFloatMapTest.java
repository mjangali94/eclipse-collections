...
public class SynchronizedShortFloatMapTest extends AbstractMutableShortFloatMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableShortFloatMapTestCase._Benchmark {
        ...
        private SynchronizedShortFloatMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortFloatMapTest();
        }

        @java.lang.Override
        public SynchronizedShortFloatMapTest implementation() {
