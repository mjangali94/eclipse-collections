...
public class ImmutableSortedBagFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ImmutableSortedBagFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> empty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> ofElements;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> withElements;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> ofSortedBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableSortedBagFactoryTest> withSortedBag;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.empty = ImmutableSortedBagFactoryTest::empty;
            this.payloads.ofElements = ImmutableSortedBagFactoryTest::ofElements;
            this.payloads.withElements = ImmutableSortedBagFactoryTest::withElements;
            this.payloads.ofAll = ImmutableSortedBagFactoryTest::ofAll;
            this.payloads.ofSortedBag = ImmutableSortedBagFactoryTest::ofSortedBag;
