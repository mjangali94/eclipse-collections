...
public class ImmutableIntSetFactoryImplTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private ImmutableIntSetFactoryImplTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableIntSetFactoryImplTest();
        }

        @java.lang.Override
        public ImmutableIntSetFactoryImplTest implementation() {
