...
public class FloatLongHashMapKeyValuesViewTest extends AbstractFloatLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private FloatLongHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FloatLongHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public FloatLongHashMapKeyValuesViewTest implementation() {
