...
public class SpreadFunctionsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_doubleSpreadOne() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::doubleSpreadOne, this.description("doubleSpreadOne"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_doubleSpreadTwo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::doubleSpreadTwo, this.description("doubleSpreadTwo"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_longSpreadOne() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::longSpreadOne, this.description("longSpreadOne"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_longSpreadTwo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::longSpreadTwo, this.description("longSpreadTwo"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_intSpreadOne() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::intSpreadOne, this.description("intSpreadOne"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_intSpreadTwo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::intSpreadTwo, this.description("intSpreadTwo"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_floatSpreadOne() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::floatSpreadOne, this.description("floatSpreadOne"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_floatSpreadTwo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::floatSpreadTwo, this.description("floatSpreadTwo"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shortSpreadOne() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shortSpreadOne, this.description("shortSpreadOne"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shortSpreadTwo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shortSpreadTwo, this.description("shortSpreadTwo"));
        }

        private SpreadFunctionsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SpreadFunctionsTest();
        }

        @java.lang.Override
        public SpreadFunctionsTest implementation() {
