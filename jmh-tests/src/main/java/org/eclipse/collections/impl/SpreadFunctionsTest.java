...
public class SpreadFunctionsTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> payload) throws java.lang.Throwable {
            this.instance = new SpreadFunctionsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> doubleSpreadOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> doubleSpreadTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> longSpreadOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> longSpreadTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> intSpreadOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> intSpreadTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> floatSpreadOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> floatSpreadTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> shortSpreadOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SpreadFunctionsTest> shortSpreadTwo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.doubleSpreadOne = SpreadFunctionsTest::doubleSpreadOne;
            this.payloads.doubleSpreadTwo = SpreadFunctionsTest::doubleSpreadTwo;
            this.payloads.longSpreadOne = SpreadFunctionsTest::longSpreadOne;
            this.payloads.longSpreadTwo = SpreadFunctionsTest::longSpreadTwo;
            this.payloads.intSpreadOne = SpreadFunctionsTest::intSpreadOne;
            this.payloads.intSpreadTwo = SpreadFunctionsTest::intSpreadTwo;
            this.payloads.floatSpreadOne = SpreadFunctionsTest::floatSpreadOne;
            this.payloads.floatSpreadTwo = SpreadFunctionsTest::floatSpreadTwo;
            this.payloads.shortSpreadOne = SpreadFunctionsTest::shortSpreadOne;
