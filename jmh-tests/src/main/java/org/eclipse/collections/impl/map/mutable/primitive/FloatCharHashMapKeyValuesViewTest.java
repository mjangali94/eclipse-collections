...
public class FloatCharHashMapKeyValuesViewTest extends AbstractFloatCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private FloatCharHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FloatCharHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public FloatCharHashMapKeyValuesViewTest implementation() {
