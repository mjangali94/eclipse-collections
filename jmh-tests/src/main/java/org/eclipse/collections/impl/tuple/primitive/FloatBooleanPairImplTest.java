...
/*
    ...
    public static class _Benchmark {
        ...
        private FloatBooleanPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new FloatBooleanPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatBooleanPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = FloatBooleanPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = FloatBooleanPairImplTest::getOne;
            this.payloads.getTwo = FloatBooleanPairImplTest::getTwo;
            this.payloads.testToString = FloatBooleanPairImplTest::testToString;
            this.payloads.compareTo = FloatBooleanPairImplTest::compareTo;
        }
    }
*/
}
