...
public class FloatFloatHashMapKeyValuesViewTest extends AbstractFloatFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private FloatFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FloatFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public FloatFloatHashMapKeyValuesViewTest implementation() {
