...
public class IterateTest {
    ...
    public void reduceInPlaceCollector() {
        this.iterables.each(each -> Assert.assertEquals(Iterate.toSortedList(each), Iterate.reduceInPlace(each, Collectors2.toSortedList())));
        this.iterables.each(each -> Assert.assertEquals(Iterate.sumByInt(each, value -> value % 2, value -> value), Iterate.reduceInPlace(each, Collectors2.sumByInt(value -> value % 2, value -> value))));
        this.iterables.each(each -> Assert.assertEquals(Iterate.groupBy(each, value -> value % 2, Multimaps.mutable.bag.empty()), Iterate.reduceInPlace(each, Collectors2.toBagMultimap(value -> value % 2))));
    }

    @Test
    public void reduceInPlace() {
        this.iterables.each(each -> Assert.assertEquals(Iterate.toSortedList(each), Iterate.reduceInPlace(each, FastList::new, FastList::add).sortThis()));
    }
    ...
    public void flatCollectFromAttributes() {
        MutableList<ListContainer<String>> list = mList(new ListContainer<>(Lists.mutable.of("One", "Two")), new ListContainer<>(Lists.mutable.of("Two-and-a-half", "Three", "Four")), new ListContainer<>(Lists.mutable.of()), new ListContainer<>(Lists.mutable.of("Five")));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(list, ListContainer.getListFunction()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(Collections.synchronizedList(list), ListContainer.getListFunction()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(Collections.synchronizedCollection(list), ListContainer.getListFunction()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(LazyIterate.adapt(list), ListContainer.getListFunction()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(new ArrayList<>(list), ListContainer.getListFunction()));
    ...
    public void flatCollectFromAttributesWithTarget() {
        MutableList<ListContainer<String>> list = Lists.fixedSize.of(new ListContainer<>(Lists.mutable.of("One", "Two")), new ListContainer<>(Lists.mutable.of("Two-and-a-half", "Three", "Four")), new ListContainer<>(Lists.mutable.of()), new ListContainer<>(Lists.mutable.of("Five")));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(list, ListContainer.getListFunction(), FastList.newList()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(Collections.synchronizedList(list), ListContainer.getListFunction(), FastList.newList()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(Collections.synchronizedCollection(list), ListContainer.getListFunction(), FastList.newList()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(LazyIterate.adapt(list), ListContainer.getListFunction(), FastList.newList()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(new ArrayList<>(list), ListContainer.getListFunction(), FastList.newList()));
        Assert.assertEquals(iList("One", "Two", "Two-and-a-half", "Three", "Four", "Five"), Iterate.flatCollect(new IterableAdapter<>(new ArrayList<>(list)), ListContainer.getListFunction(), FastList.newList()));
    }
    ...
    public void flatCollectFromAttributesUsingStringFunction() {
        MutableList<ListContainer<String>> list = Lists.mutable.of(new ListContainer<>(Lists.mutable.of("One", "Two")), new ListContainer<>(Lists.mutable.of("Two-and-a-half", "Three", "Four")), new ListContainer<>(Lists.mutable.of()), new ListContainer<>(Lists.mutable.of("Five")));
    ...
    public void flatCollectOneLevel() {
        MutableList<MutableList<String>> list = Lists.mutable.of(Lists.mutable.of("One", "Two"), Lists.mutable.of("Two-and-a-half", "Three", "Four"), Lists.mutable.of(), Lists.mutable.of("Five"));
    ...
    public void groupByAndCollect() {
        ...
        Pair<String, String>[] expectedPairs = new Pair[] { Tuples.pair("Key1", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key2", "2"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "3") };
    ...
    public void toMultimap() {
        MutableList<Integer> list = Lists.mutable.of(1, 2, 2, 3, 3, 3);
        Pair<String, String>[] expectedPairs = new Pair[] { Tuples.pair("Key1", "1"), Tuples.pair("Key1", "1"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3") };
        Function<Integer, String> keyFunction = each -> "Key" + each;
        ...
        BagMultimap<String, String> expectedMultimap8 = HashBagMultimap.newMultimap(Tuples.pair("Key1", "1"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"));
        ...
        MutableBagMultimap<String, String> expectedMultimap9 = HashBagMultimap.newMultimap(Tuples.pair("Key1", "1"), Tuples.pair("Key1", "1"), Tuples.pair("Key1", "1"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "1"), Tuples.pair("Key2", "2"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "1"), Tuples.pair("Key3", "3"));
    ...
    public void selectPairs() {
        ImmutableList<Twin<String>> twins = iList(Tuples.twin("1", "2"), Tuples.twin("2", "1"), Tuples.twin("3", "3"));
    ...
    public void removeIfWithRandomAccess() {
        ...
        Verify.assertSize(3, objects);
        Verify.assertContainsAll(objects, 1, 2, 3);
        List<Integer> objects1 = Collections.synchronizedList(new ArrayList<>(Lists.fixedSize.of(null, 1, 2, 3)));
        Assert.assertTrue(Iterate.removeIfWith(objects1, (each, ignored) -> each == null, null));
        Verify.assertSize(3, objects1);
        Verify.assertContainsAll(objects1, 1, 2, 3);
    }
    ...
    private void zip(Iterable<String> iterable) {
        ...
        Assert.assertEquals(UnifiedSet.newSet(iterable), Iterate.collect(pairs, (Function<Pair<String, ?>, String>) Pair::getOne, UnifiedSet.newSet()));
        Assert.assertEquals(nulls, Iterate.collect(pairs, (Function<Pair<?, Object>, Object>) Pair::getTwo, Lists.mutable.of()));
    }
    ...
    private void zipWithIndex(Iterable<String> iterable) {
        ...
        Assert.assertEquals(UnifiedSet.newSet(iterable), Iterate.collect(pairs, (Function<Pair<String, ?>, String>) Pair::getOne, UnifiedSet.newSet()));
        Assert.assertEquals(Interval.zeroTo(Iterate.sizeOf(iterable) - 1).toSet(), Iterate.collect(pairs, (Function<Pair<?, Integer>, Integer>) Pair::getTwo, UnifiedSet.newSet()));
    }
    ...
    public void sumByInt() {
        ...
        ObjectLongMap<Integer> map = Iterate.sumByInt(FastList.newListWith(2_000_000_000, 2_000_000_001, 2_000_000_000, 2_000_000_001, 2_000_000_000), i -> i % 2, e -> e);
    ...
    public void sumByFloat() {
        ...
        ObjectDoubleMap<Integer> map = Iterate.sumByFloat(FastList.newListWith(2_000_000_000, 2_000_001, 2_000_000_000, 2_000_001, 2_000_000_000), i -> i % 2, e -> e);
    ...
    public static class _Benchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllFrom() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllFrom);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllFromEmptyTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllFromEmptyTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllFromEmptyListTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllFromEmptyListTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllFromNoElementRemovedTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllFromNoElementRemovedTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllFromEmptyTargetListTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllFromEmptyTargetListTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllIterableFrom() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllIterableFrom);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllIterableFromEmptyTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllIterableFromEmptyTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllIterableFromEmptyListTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllIterableFromEmptyListTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllIterableFromNoElementRemovedTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllIterableFromNoElementRemovedTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeAllIterableFromEmptyTargetListTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeAllIterableFromEmptyTargetListTest);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sizeOf() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.sizeOf);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toArray_NullParameter() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.toArray_NullParameter);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toArray_with_array() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.toArray_with_array);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromToDoit() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.fromToDoit);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_reduceInPlaceCollector() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.reduceInPlaceCollector);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_reduceInPlace() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.reduceInPlace);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_injectInto2() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.injectInto2);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectFromAttributes() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectFromAttributes);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectFromAttributesWithTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectFromAttributesWithTarget);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectFromAttributesWithTarget_NullParameter() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectFromAttributesWithTarget_NullParameter);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectFromAttributesUsingStringFunction() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectFromAttributesUsingStringFunction);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectOneLevel() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectOneLevel);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flatCollectOneLevel_target() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.flatCollectOneLevel_target);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_groupByAndCollect() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.groupByAndCollect);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirst_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirst_null_throws);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getList_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getList_null_throws);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastInterval() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastInterval);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastLinkedList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastLinkedList);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastTreeSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastTreeSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastCollection);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastForSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastForSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getFirstAndLastOnEmptyForSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getFirstAndLastOnEmptyForSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectDifferentTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectDifferentTargetCollection);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectWithDifferentTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectWithDifferentTargetCollection);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_count_empty() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.count_empty);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_count_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.count_null_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_addToMap() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.addToMap);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toMapSelectingKeyAndValue() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.toMapSelectingKeyAndValue);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toMultimap() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.toMultimap);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectPairs() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectPairs);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectIndexWithTreeSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectIndexWithTreeSet);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectIndexWithWithTreeSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectIndexWithWithTreeSet);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectWithWithTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectWithWithTarget);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectTargetCollection);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectOnRandomAccessTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectOnRandomAccessTargetCollection);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectWithTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectWithTargetCollection);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectWithOnRandomAccessTargetCollection() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectWithOnRandomAccessTargetCollection);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectWithRandomAccess() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectWithRandomAccess);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectWithOptionalSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectWithOptionalSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectWithOptionalRandomAccess() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.detectWithOptionalRandomAccess);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_anySatisfyWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.anySatisfyWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_allSatisfyWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.allSatisfyWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_noneSatisfyWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.noneSatisfyWithSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectAndRejectWithSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectAndRejectWithSet);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_collectIfTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.collectIfTarget);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_collect_sortedSetSource() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.collect_sortedSetSource);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_collectWithWithTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.collectWithWithTarget);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfLinkedList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfLinkedList);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfAll() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfAll);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfNone() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfNone);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfFromSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfFromSet);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfWithFastList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfWithFastList);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfWithRandomAccess() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfWithRandomAccess);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_removeIfWithLinkedList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.removeIfWithLinkedList);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_injectIntoIfProcedure() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.injectIntoIfProcedure);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.selectTarget);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_rejectTarget() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.rejectTarget);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_count_null_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.count_null_null_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_countWith_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.countWith_null_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_injectIntoWithRandomAccess() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.injectIntoWithRandomAccess);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_injectIntoWithHashSet() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.injectIntoWithHashSet);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_forEachWithSets() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.forEachWithSets);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sortThisWithPredicate() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.sortThisWithPredicate);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_take_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.take_null_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_drop_null_throws() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.drop_null_throws);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getOnlySingleton() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getOnlySingleton);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getOnlyEmpty() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getOnlyEmpty);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getOnlyMultiple() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.getOnlyMultiple);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_aggregateByImmutableResult() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.aggregateByImmutableResult);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_minByThrowsOnEmpty() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.minByThrowsOnEmpty);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_minByThrowsOnNull() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.minByThrowsOnNull);
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maxByThrowsOnEmpty() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.maxByThrowsOnEmpty);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maxByThrowsOnNull() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.maxByThrowsOnNull);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> payload) throws java.lang.Throwable {
            this.instance = new IterateTest();
            this.instance.setUp();
        ...
        private static class _Payloads {
            ...
            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> addAllTo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllFrom;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllFromEmptyTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllFromEmptyListTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllFromNoElementRemovedTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllFromEmptyTargetListTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllIterableFrom;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllIterableFromEmptyTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllIterableFromEmptyListTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllIterableFromNoElementRemovedTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeAllIterableFromEmptyTargetListTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sizeOf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toArray_NullParameter;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toArray_with_array;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> fromToDoit;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> reduceInPlaceCollector;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> reduceInPlace;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectInto;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectInto2;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoMaxString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoMinString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectFromAttributes;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectFromAttributesWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectFromAttributesWithTarget_NullParameter;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectFromAttributesUsingStringFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectOneLevel;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> flatCollectOneLevel_target;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByEachWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByAndCollect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLast;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirst_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getList_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastInterval;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastLinkedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastTreeSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastForSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getFirstAndLastOnEmptyForSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectDifferentTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWithDifferentTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> count_empty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> count_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toMap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toMapTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> addToMap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toMapSelectingKeyAndValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toMultimap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> forEachWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectPairs;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectOptional;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectIndexWithTreeSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectIndexWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectIndexWithWithTreeSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectWithIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectWithWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectAndRejectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> partition;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> partitionWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectOnRandomAccessTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWithTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWithOnRandomAccessTargetCollection;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> anySatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> allSatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> noneSatisfyWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectWithRandomAccess;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectWithOptionalSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> detectWithOptionalRandomAccess;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> anySatisfyWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> allSatisfyWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> noneSatisfyWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectAndRejectWithSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectIf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectIfTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectBoolean;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectBooleanWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectByte;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectByteWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectChar;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectCharWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectDoubleWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectFloatWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectIntWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectLongWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectShort;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectShortWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collect_sortedSetSource;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> collectWithWithTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfLinkedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfFromSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfWithFastList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfWithRandomAccess;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> removeIfWithLinkedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoIfProcedure;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> toSortedListWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> rejectTarget;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> selectInstancesOf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> count_null_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> countWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> countWith_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoWithRandomAccess;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> injectIntoWithHashSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> forEachWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> forEachWithSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sortThis;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sortThisWithPredicate;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sortThisBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sortThisWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> take;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> take_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> take_negative_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> drop;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> drop_null_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> drop_negative_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getOnlySingleton;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getOnlyEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getOnlyMultiple;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> zip;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> zipWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> chunk;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> getOnly;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> aggregateByMutating;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> aggregateByImmutableResult;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfBigDecimal;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumOfBigInteger;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByBigDecimal;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByBigInteger;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByFloat;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByLong;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> sumByDouble;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> minBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> minByThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> minByThrowsOnNull;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> maxBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> maxByThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> maxByThrowsOnNull;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByUniqueKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByUniqueKey_throws_for_null;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByUniqueKey_target;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterateTest> groupByUniqueKey_target_throws_for_null;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.addAllTo = IterateTest::addAllTo;
            this.payloads.removeAllFrom = IterateTest::removeAllFrom;
            this.payloads.removeAllFromEmptyTest = IterateTest::removeAllFromEmptyTest;
            this.payloads.removeAllFromEmptyListTest = IterateTest::removeAllFromEmptyListTest;
            this.payloads.removeAllFromNoElementRemovedTest = IterateTest::removeAllFromNoElementRemovedTest;
            this.payloads.removeAllFromEmptyTargetListTest = IterateTest::removeAllFromEmptyTargetListTest;
            this.payloads.removeAllIterableFrom = IterateTest::removeAllIterableFrom;
            this.payloads.removeAllIterableFromEmptyTest = IterateTest::removeAllIterableFromEmptyTest;
            this.payloads.removeAllIterableFromEmptyListTest = IterateTest::removeAllIterableFromEmptyListTest;
            this.payloads.removeAllIterableFromNoElementRemovedTest = IterateTest::removeAllIterableFromNoElementRemovedTest;
            this.payloads.removeAllIterableFromEmptyTargetListTest = IterateTest::removeAllIterableFromEmptyTargetListTest;
            this.payloads.sizeOf = IterateTest::sizeOf;
            this.payloads.toArray = IterateTest::toArray;
            this.payloads.toArray_NullParameter = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::toArray_NullParameter, java.lang.NullPointerException.class);
            this.payloads.toArray_with_array = IterateTest::toArray_with_array;
            this.payloads.fromToDoit = IterateTest::fromToDoit;
            this.payloads.reduceInPlaceCollector = IterateTest::reduceInPlaceCollector;
            this.payloads.reduceInPlace = IterateTest::reduceInPlace;
            this.payloads.injectInto = IterateTest::injectInto;
            this.payloads.injectIntoInt = IterateTest::injectIntoInt;
            this.payloads.injectIntoLong = IterateTest::injectIntoLong;
            this.payloads.injectIntoDouble = IterateTest::injectIntoDouble;
            this.payloads.injectIntoFloat = IterateTest::injectIntoFloat;
            this.payloads.injectInto2 = IterateTest::injectInto2;
            this.payloads.injectIntoString = IterateTest::injectIntoString;
            this.payloads.injectIntoMaxString = IterateTest::injectIntoMaxString;
            this.payloads.injectIntoMinString = IterateTest::injectIntoMinString;
            this.payloads.flatCollectFromAttributes = IterateTest::flatCollectFromAttributes;
            this.payloads.flatCollectFromAttributesWithTarget = IterateTest::flatCollectFromAttributesWithTarget;
            this.payloads.flatCollectFromAttributesWithTarget_NullParameter = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::flatCollectFromAttributesWithTarget_NullParameter, java.lang.IllegalArgumentException.class);
            this.payloads.flatCollectFromAttributesUsingStringFunction = IterateTest::flatCollectFromAttributesUsingStringFunction;
            this.payloads.flatCollectOneLevel = IterateTest::flatCollectOneLevel;
            this.payloads.flatCollectOneLevel_target = IterateTest::flatCollectOneLevel_target;
            this.payloads.groupBy = IterateTest::groupBy;
            this.payloads.groupByEach = IterateTest::groupByEach;
            this.payloads.groupByWithTarget = IterateTest::groupByWithTarget;
            this.payloads.groupByEachWithTarget = IterateTest::groupByEachWithTarget;
            this.payloads.groupByAndCollect = IterateTest::groupByAndCollect;
            this.payloads.toList = IterateTest::toList;
            this.payloads.contains = IterateTest::contains;
            this.payloads.getFirstAndLast = IterateTest::getFirstAndLast;
            this.payloads.getFirst_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::getFirst_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.getList_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::getList_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.getFirstAndLastInterval = IterateTest::getFirstAndLastInterval;
            this.payloads.getFirstAndLastLinkedList = IterateTest::getFirstAndLastLinkedList;
            this.payloads.getFirstAndLastTreeSet = IterateTest::getFirstAndLastTreeSet;
            this.payloads.getFirstAndLastCollection = IterateTest::getFirstAndLastCollection;
            this.payloads.getFirstAndLastOnEmpty = IterateTest::getFirstAndLastOnEmpty;
            this.payloads.getFirstAndLastForSet = IterateTest::getFirstAndLastForSet;
            this.payloads.getFirstAndLastOnEmptyForSet = IterateTest::getFirstAndLastOnEmptyForSet;
            this.payloads.selectDifferentTargetCollection = IterateTest::selectDifferentTargetCollection;
            this.payloads.rejectWithDifferentTargetCollection = IterateTest::rejectWithDifferentTargetCollection;
            this.payloads.count_empty = IterateTest::count_empty;
            this.payloads.count_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::count_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.toMap = IterateTest::toMap;
            this.payloads.toMapTarget = IterateTest::toMapTarget;
            this.payloads.addToMap = IterateTest::addToMap;
            this.payloads.toMapSelectingKeyAndValue = IterateTest::toMapSelectingKeyAndValue;
            this.payloads.toMultimap = IterateTest::toMultimap;
            this.payloads.forEachWithIndex = IterateTest::forEachWithIndex;
            this.payloads.selectPairs = IterateTest::selectPairs;
            this.payloads.detect = IterateTest::detect;
            this.payloads.detectOptional = IterateTest::detectOptional;
            this.payloads.detectIndex = IterateTest::detectIndex;
            this.payloads.detectIndexWithTreeSet = IterateTest::detectIndexWithTreeSet;
            this.payloads.detectIndexWith = IterateTest::detectIndexWith;
            this.payloads.detectIndexWithWithTreeSet = IterateTest::detectIndexWithWithTreeSet;
            this.payloads.detectWithIfNone = IterateTest::detectWithIfNone;
            this.payloads.selectWith = IterateTest::selectWith;
            this.payloads.selectWithWithTarget = IterateTest::selectWithWithTarget;
            this.payloads.rejectWith = IterateTest::rejectWith;
            this.payloads.rejectWithTarget = IterateTest::rejectWithTarget;
            this.payloads.selectAndRejectWith = IterateTest::selectAndRejectWith;
            this.payloads.partition = IterateTest::partition;
            this.payloads.partitionWith = IterateTest::partitionWith;
            this.payloads.rejectTargetCollection = IterateTest::rejectTargetCollection;
            this.payloads.rejectOnRandomAccessTargetCollection = IterateTest::rejectOnRandomAccessTargetCollection;
            this.payloads.rejectWithTargetCollection = IterateTest::rejectWithTargetCollection;
            this.payloads.rejectWithOnRandomAccessTargetCollection = IterateTest::rejectWithOnRandomAccessTargetCollection;
            this.payloads.anySatisfy = IterateTest::anySatisfy;
            this.payloads.anySatisfyWith = IterateTest::anySatisfyWith;
            this.payloads.allSatisfy = IterateTest::allSatisfy;
            this.payloads.allSatisfyWith = IterateTest::allSatisfyWith;
            this.payloads.noneSatisfy = IterateTest::noneSatisfy;
            this.payloads.noneSatisfyWith = IterateTest::noneSatisfyWith;
            this.payloads.selectWithSet = IterateTest::selectWithSet;
            this.payloads.rejectWithSet = IterateTest::rejectWithSet;
            this.payloads.detectWithSet = IterateTest::detectWithSet;
            this.payloads.detectWithRandomAccess = IterateTest::detectWithRandomAccess;
            this.payloads.detectWithOptionalSet = IterateTest::detectWithOptionalSet;
            this.payloads.detectWithOptionalRandomAccess = IterateTest::detectWithOptionalRandomAccess;
            this.payloads.anySatisfyWithSet = IterateTest::anySatisfyWithSet;
            this.payloads.allSatisfyWithSet = IterateTest::allSatisfyWithSet;
            this.payloads.noneSatisfyWithSet = IterateTest::noneSatisfyWithSet;
            this.payloads.selectAndRejectWithSet = IterateTest::selectAndRejectWithSet;
            this.payloads.forEach = IterateTest::forEach;
            this.payloads.collectIf = IterateTest::collectIf;
            this.payloads.collectIfTarget = IterateTest::collectIfTarget;
            this.payloads.collect = IterateTest::collect;
            this.payloads.collectBoolean = IterateTest::collectBoolean;
            this.payloads.collectBooleanWithTarget = IterateTest::collectBooleanWithTarget;
            this.payloads.collectByte = IterateTest::collectByte;
            this.payloads.collectByteWithTarget = IterateTest::collectByteWithTarget;
            this.payloads.collectChar = IterateTest::collectChar;
            this.payloads.collectCharWithTarget = IterateTest::collectCharWithTarget;
            this.payloads.collectDouble = IterateTest::collectDouble;
            this.payloads.collectDoubleWithTarget = IterateTest::collectDoubleWithTarget;
            this.payloads.collectFloat = IterateTest::collectFloat;
            this.payloads.collectFloatWithTarget = IterateTest::collectFloatWithTarget;
            this.payloads.collectInt = IterateTest::collectInt;
            this.payloads.collectIntWithTarget = IterateTest::collectIntWithTarget;
            this.payloads.collectLong = IterateTest::collectLong;
            this.payloads.collectLongWithTarget = IterateTest::collectLongWithTarget;
            this.payloads.collectShort = IterateTest::collectShort;
            this.payloads.collectShortWithTarget = IterateTest::collectShortWithTarget;
            this.payloads.collect_sortedSetSource = IterateTest::collect_sortedSetSource;
            this.payloads.collectTarget = IterateTest::collectTarget;
            this.payloads.collectWith = IterateTest::collectWith;
            this.payloads.collectWithWithTarget = IterateTest::collectWithWithTarget;
            this.payloads.removeIf = IterateTest::removeIf;
            this.payloads.removeIfWith = IterateTest::removeIfWith;
            this.payloads.removeIfLinkedList = IterateTest::removeIfLinkedList;
            this.payloads.removeIfAll = IterateTest::removeIfAll;
            this.payloads.removeIfNone = IterateTest::removeIfNone;
            this.payloads.removeIfFromSet = IterateTest::removeIfFromSet;
            this.payloads.removeIfWithFastList = IterateTest::removeIfWithFastList;
            this.payloads.removeIfWithRandomAccess = IterateTest::removeIfWithRandomAccess;
            this.payloads.removeIfWithLinkedList = IterateTest::removeIfWithLinkedList;
            this.payloads.injectIntoIfProcedure = IterateTest::injectIntoIfProcedure;
            this.payloads.isEmpty = IterateTest::isEmpty;
            this.payloads.notEmpty = IterateTest::notEmpty;
            this.payloads.toSortedList = IterateTest::toSortedList;
            this.payloads.toSortedListWithComparator = IterateTest::toSortedListWithComparator;
            this.payloads.select = IterateTest::select;
            this.payloads.selectTarget = IterateTest::selectTarget;
            this.payloads.reject = IterateTest::reject;
            this.payloads.rejectTarget = IterateTest::rejectTarget;
            this.payloads.selectInstancesOf = IterateTest::selectInstancesOf;
            this.payloads.count = IterateTest::count;
            this.payloads.count_null_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::count_null_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.countWith = IterateTest::countWith;
            this.payloads.countWith_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::countWith_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.injectIntoWith = IterateTest::injectIntoWith;
            this.payloads.injectIntoWithRandomAccess = IterateTest::injectIntoWithRandomAccess;
            this.payloads.injectIntoWithHashSet = IterateTest::injectIntoWithHashSet;
            this.payloads.forEachWith = IterateTest::forEachWith;
            this.payloads.forEachWithSets = IterateTest::forEachWithSets;
            this.payloads.sortThis = IterateTest::sortThis;
            this.payloads.sortThisWithPredicate = IterateTest::sortThisWithPredicate;
            this.payloads.sortThisBy = IterateTest::sortThisBy;
            this.payloads.sortThisWithComparator = IterateTest::sortThisWithComparator;
            this.payloads.take = IterateTest::take;
            this.payloads.take_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::take_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.take_negative_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::take_negative_throws, java.lang.IllegalArgumentException.class);
            this.payloads.drop = IterateTest::drop;
            this.payloads.drop_null_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::drop_null_throws, java.lang.IllegalArgumentException.class);
            this.payloads.drop_negative_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::drop_negative_throws, java.lang.IllegalArgumentException.class);
            this.payloads.getOnlySingleton = IterateTest::getOnlySingleton;
            this.payloads.getOnlyEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::getOnlyEmpty, java.lang.IllegalArgumentException.class);
            this.payloads.getOnlyMultiple = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::getOnlyMultiple, java.lang.IllegalArgumentException.class);
            this.payloads.zip = IterateTest::zip;
            this.payloads.zipWithIndex = IterateTest::zipWithIndex;
            this.payloads.chunk = IterateTest::chunk;
            this.payloads.getOnly = IterateTest::getOnly;
            this.payloads.makeString = IterateTest::makeString;
            this.payloads.appendString = IterateTest::appendString;
            this.payloads.aggregateByMutating = IterateTest::aggregateByMutating;
            this.payloads.aggregateByImmutableResult = IterateTest::aggregateByImmutableResult;
            this.payloads.sumOfInt = IterateTest::sumOfInt;
            this.payloads.sumOfLong = IterateTest::sumOfLong;
            this.payloads.sumOfFloat = IterateTest::sumOfFloat;
            this.payloads.sumOfDouble = IterateTest::sumOfDouble;
            this.payloads.sumOfBigDecimal = IterateTest::sumOfBigDecimal;
            this.payloads.sumOfBigInteger = IterateTest::sumOfBigInteger;
            this.payloads.sumByBigDecimal = IterateTest::sumByBigDecimal;
            this.payloads.sumByBigInteger = IterateTest::sumByBigInteger;
            this.payloads.sumByInt = IterateTest::sumByInt;
            this.payloads.sumByFloat = IterateTest::sumByFloat;
            this.payloads.sumByLong = IterateTest::sumByLong;
            this.payloads.sumByDouble = IterateTest::sumByDouble;
            this.payloads.minBy = IterateTest::minBy;
            this.payloads.minByThrowsOnEmpty = IterateTest::minByThrowsOnEmpty;
            this.payloads.minByThrowsOnNull = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::minByThrowsOnNull, java.lang.IllegalArgumentException.class);
            this.payloads.maxBy = IterateTest::maxBy;
            this.payloads.maxByThrowsOnEmpty = IterateTest::maxByThrowsOnEmpty;
            this.payloads.maxByThrowsOnNull = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::maxByThrowsOnNull, java.lang.IllegalArgumentException.class);
            this.payloads.classIsNonInstantiable = IterateTest::classIsNonInstantiable;
            this.payloads.groupByUniqueKey = IterateTest::groupByUniqueKey;
            this.payloads.groupByUniqueKey_throws_for_null = new se.chalmers.ju2jmh.api.ExceptionTest<>(IterateTest::groupByUniqueKey_throws_for_null, java.lang.IllegalArgumentException.class);
            this.payloads.groupByUniqueKey_target = IterateTest::groupByUniqueKey_target;
