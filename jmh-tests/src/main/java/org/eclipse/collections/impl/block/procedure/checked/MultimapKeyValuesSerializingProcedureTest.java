...
public class MultimapKeyValuesSerializingProcedureTest {
    ...
    public void testSerialization() {
        ...
        Procedure2<String, RichIterable<String>> procedure = new MultimapKeyValuesSerializingProcedure<>(new MockObjectOutput(expectedWrites));
...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapKeyValuesSerializingProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new MultimapKeyValuesSerializingProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapKeyValuesSerializingProcedureTest> testSerialization;
        }
