...
/*
    ...
    public static class _Benchmark {
        ...
        private ByteCaseProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCaseProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new ByteCaseProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCaseProcedureTest> noopCaseAndThenDefault;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCaseProcedureTest> oneCaseWithDefault;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCaseProcedureTest> twoCasesNoDefault;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCaseProcedureTest> twoCasesWithDefault;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.noopCaseAndThenDefault = ByteCaseProcedureTest::noopCaseAndThenDefault;
            this.payloads.oneCaseWithDefault = ByteCaseProcedureTest::oneCaseWithDefault;
            this.payloads.twoCasesNoDefault = ByteCaseProcedureTest::twoCasesNoDefault;
