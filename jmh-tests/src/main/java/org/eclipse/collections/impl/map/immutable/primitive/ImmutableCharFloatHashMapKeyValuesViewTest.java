...
public class ImmutableCharFloatHashMapKeyValuesViewTest extends AbstractCharFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractCharFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableCharFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableCharFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableCharFloatHashMapKeyValuesViewTest implementation() {
