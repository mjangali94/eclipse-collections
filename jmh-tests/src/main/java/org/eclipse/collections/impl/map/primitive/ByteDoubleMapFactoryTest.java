...
public class ByteDoubleMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private ByteDoubleMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoubleMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ByteDoubleMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoubleMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoubleMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteDoubleMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ByteDoubleMapFactoryTest::of;
            this.payloads.withAll = ByteDoubleMapFactoryTest::withAll;
            this.payloads.from = ByteDoubleMapFactoryTest::from;
        }
    }
}
