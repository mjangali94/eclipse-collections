...
public class SynchronizedIntObjectMapValuesTest {
    ...
    public static class _Benchmark {
        ...
        private SynchronizedIntObjectMapValuesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> payload) throws java.lang.Throwable {
            this.instance = new SynchronizedIntObjectMapValuesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> clear;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> removeFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> removeNullFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> removeAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> retainAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedIntObjectMapValuesTest> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedIntObjectMapValuesTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedIntObjectMapValuesTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.clear = SynchronizedIntObjectMapValuesTest::clear;
            this.payloads.contains = SynchronizedIntObjectMapValuesTest::contains;
            this.payloads.containsAll = SynchronizedIntObjectMapValuesTest::containsAll;
            this.payloads.isEmpty = SynchronizedIntObjectMapValuesTest::isEmpty;
            this.payloads.size = SynchronizedIntObjectMapValuesTest::size;
            this.payloads.iterator = SynchronizedIntObjectMapValuesTest::iterator;
            this.payloads.values = SynchronizedIntObjectMapValuesTest::values;
            this.payloads.removeFromValues = SynchronizedIntObjectMapValuesTest::removeFromValues;
            this.payloads.removeNullFromValues = SynchronizedIntObjectMapValuesTest::removeNullFromValues;
            this.payloads.removeAllFromValues = SynchronizedIntObjectMapValuesTest::removeAllFromValues;
            this.payloads.retainAllFromValues = SynchronizedIntObjectMapValuesTest::retainAllFromValues;
            this.payloads.valuesToArray = SynchronizedIntObjectMapValuesTest::valuesToArray;
        }
    }
}
