...
public class SynchronizedObjectDoubleMapKeyValuesViewTest extends AbstractObjectDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedObjectDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedObjectDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedObjectDoubleMapKeyValuesViewTest implementation() {
