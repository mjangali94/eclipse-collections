...
public final class SingletonShortIteratorTest {
    ...
    public static class _Benchmark {
        ...
        private SingletonShortIteratorTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonShortIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new SingletonShortIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonShortIteratorTest> hasNext;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonShortIteratorTest> next;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.hasNext = SingletonShortIteratorTest::hasNext;
            this.payloads.next = SingletonShortIteratorTest::next;
        }
    }
}
