...
public class PartitionTreeBagTest {
    ...
    public static class _Benchmark {
        ...
        private PartitionTreeBagTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionTreeBagTest> payload) throws java.lang.Throwable {
            this.instance = new PartitionTreeBagTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<PartitionTreeBagTest> toImmutable;
        }
