...
public class CharObjectHashMapKeysViewTest extends AbstractLazyCharIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyCharIterableTestCase._Benchmark {
        ...
        private CharObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CharObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public CharObjectHashMapKeysViewTest implementation() {
