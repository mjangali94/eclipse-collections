...
public class SynchronizedDoubleCharMapKeyValuesViewTest extends AbstractDoubleCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedDoubleCharMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleCharMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedDoubleCharMapKeyValuesViewTest implementation() {
