...
public class FastListCollectProcedureTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private FastListCollectProcedureTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FastListCollectProcedureTest();
        }

        @java.lang.Override
        public FastListCollectProcedureTest implementation() {
