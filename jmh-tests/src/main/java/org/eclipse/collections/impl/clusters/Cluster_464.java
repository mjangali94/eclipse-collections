    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.list.immutable.ImmutableDoubletonListTest._Benchmark _Benchmark_benchmark_11;
        ...
        public void benchmark_Cluster_464() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_6.runBenchmark(this._Benchmark_benchmark_6.payloads.min);
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.minBy);
            this._Benchmark_benchmark_6.runBenchmark(this._Benchmark_benchmark_6.payloads.min_without_comparator);
            this._Benchmark_benchmark_10.runBenchmark(this._Benchmark_benchmark_10.payloads.iteratorRemove);
            this._Benchmark_benchmark_11.runBenchmark(this._Benchmark_benchmark_11.payloads.containsAllIterable);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.forLoop);
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.detectIndex);
        }
