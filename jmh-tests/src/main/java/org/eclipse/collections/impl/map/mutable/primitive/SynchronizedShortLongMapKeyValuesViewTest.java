...
public class SynchronizedShortLongMapKeyValuesViewTest extends AbstractShortLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortLongMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortLongMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortLongMapKeyValuesViewTest implementation() {
