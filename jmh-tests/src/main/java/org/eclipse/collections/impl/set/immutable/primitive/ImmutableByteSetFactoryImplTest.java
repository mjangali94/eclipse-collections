...
public class ImmutableByteSetFactoryImplTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private ImmutableByteSetFactoryImplTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableByteSetFactoryImplTest();
        }

        @java.lang.Override
        public ImmutableByteSetFactoryImplTest implementation() {
