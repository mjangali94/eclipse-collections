...
public class ObjectShortHashMapKeysViewTest extends AbstractObjectShortMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectShortMapKeysViewTestCase._Benchmark {
        ...
        private ObjectShortHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectShortHashMapKeysViewTest();
        }

        @java.lang.Override
        public ObjectShortHashMapKeysViewTest implementation() {
