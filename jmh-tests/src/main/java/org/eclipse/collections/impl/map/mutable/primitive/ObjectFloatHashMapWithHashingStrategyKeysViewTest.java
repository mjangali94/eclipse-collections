...
public class ObjectFloatHashMapWithHashingStrategyKeysViewTest extends AbstractObjectFloatMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectFloatMapKeysViewTestCase._Benchmark {
        ...
        private ObjectFloatHashMapWithHashingStrategyKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectFloatHashMapWithHashingStrategyKeysViewTest();
        }

        @java.lang.Override
        public ObjectFloatHashMapWithHashingStrategyKeysViewTest implementation() {
