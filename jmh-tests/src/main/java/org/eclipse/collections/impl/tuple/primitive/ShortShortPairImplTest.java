...
public class ShortShortPairImplTest {
    ...
    public static class _Benchmark {
        ...
        private ShortShortPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new ShortShortPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ShortShortPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = ShortShortPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = ShortShortPairImplTest::getOne;
            this.payloads.getTwo = ShortShortPairImplTest::getTwo;
            this.payloads.testToString = ShortShortPairImplTest::testToString;
            this.payloads.compareTo = ShortShortPairImplTest::compareTo;
        }
    }
}
