...
/*
    ...
    public static class _Benchmark {
        ...
        private MutableShort instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableShort> payload) throws java.lang.Throwable {
            this.instance = new MutableShort();
