...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> payload) throws java.lang.Throwable {
            this.instance = new IterablesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableLists;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableLists;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableBags;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableBags;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSortedSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSortedSetsWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSortedSetsWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSortedSets;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSortedMaps;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSortedMapsWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableSortedMapsWithFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSortedMaps;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSortedMapsWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableSortedMapsWithFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> mutableMaps;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> immutableMaps;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IterablesTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutableLists = IterablesTest::immutableLists;
            this.payloads.mutableLists = IterablesTest::mutableLists;
            this.payloads.immutableSets = IterablesTest::immutableSets;
            this.payloads.mutableSets = IterablesTest::mutableSets;
            this.payloads.mutableBags = IterablesTest::mutableBags;
            this.payloads.immutableBags = IterablesTest::immutableBags;
            this.payloads.immutableSortedSets = IterablesTest::immutableSortedSets;
            this.payloads.immutableSortedSetsWithComparator = IterablesTest::immutableSortedSetsWithComparator;
            this.payloads.mutableSortedSetsWithComparator = IterablesTest::mutableSortedSetsWithComparator;
            this.payloads.mutableSortedSets = IterablesTest::mutableSortedSets;
            this.payloads.mutableSortedMaps = IterablesTest::mutableSortedMaps;
            this.payloads.mutableSortedMapsWithComparator = IterablesTest::mutableSortedMapsWithComparator;
            this.payloads.mutableSortedMapsWithFunction = IterablesTest::mutableSortedMapsWithFunction;
            this.payloads.immutableSortedMaps = IterablesTest::immutableSortedMaps;
            this.payloads.immutableSortedMapsWithComparator = IterablesTest::immutableSortedMapsWithComparator;
            this.payloads.immutableSortedMapsWithFunction = IterablesTest::immutableSortedMapsWithFunction;
            this.payloads.mutableMaps = IterablesTest::mutableMaps;
            this.payloads.immutableMaps = IterablesTest::immutableMaps;
            this.payloads.classIsNonInstantiable = IterablesTest::classIsNonInstantiable;
        }
    }
*/
}
