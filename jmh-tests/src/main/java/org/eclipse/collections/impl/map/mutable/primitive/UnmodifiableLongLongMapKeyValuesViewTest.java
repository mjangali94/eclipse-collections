...
public class UnmodifiableLongLongMapKeyValuesViewTest extends AbstractLongLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableLongLongMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableLongLongMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableLongLongMapKeyValuesViewTest implementation() {
