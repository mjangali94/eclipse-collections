...
/*
    ...
    public static class _Benchmark {
        ...
        private DoubleByteMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleByteMapsTest> payload) throws java.lang.Throwable {
            this.instance = new DoubleByteMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleByteMapsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleByteMapsTest> mutables;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = DoubleByteMapsTest::immutables;
            this.payloads.mutables = DoubleByteMapsTest::mutables;
        }
    }
*/
}
