...
public class ByteCharHashMapKeysViewTest extends AbstractLazyByteIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyByteIterableTestCase._Benchmark {
        ...
        private ByteCharHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ByteCharHashMapKeysViewTest();
        }

        @java.lang.Override
        public ByteCharHashMapKeysViewTest implementation() {
