...
public class LongListsTest {
    ...
    public static class _Benchmark {
        ...
        private LongListsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> payload) throws java.lang.Throwable {
            this.instance = new LongListsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> emptyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> newListWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> newListWithArray_immutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> newListWithArray_mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> wrapCopy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> newListWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> newListWithWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> classIsNonInstantiable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> ofAllIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> primitiveStream;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongListsTest> primitiveParallelStream;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = LongListsTest::immutables;
            this.payloads.mutables = LongListsTest::mutables;
            this.payloads.emptyList = LongListsTest::emptyList;
            this.payloads.newListWith = LongListsTest::newListWith;
            this.payloads.newListWithArray_immutable = LongListsTest::newListWithArray_immutable;
            this.payloads.newListWithArray_mutable = LongListsTest::newListWithArray_mutable;
            this.payloads.wrapCopy = LongListsTest::wrapCopy;
            this.payloads.newListWithList = LongListsTest::newListWithList;
            this.payloads.newListWithWithList = LongListsTest::newListWithWithList;
            this.payloads.classIsNonInstantiable = LongListsTest::classIsNonInstantiable;
            this.payloads.ofAllIterable = LongListsTest::ofAllIterable;
            this.payloads.primitiveStream = LongListsTest::primitiveStream;
