...
public class UnmodifiableIntBooleanMapKeyValuesViewTest extends AbstractIntBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableIntBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableIntBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableIntBooleanMapKeyValuesViewTest implementation() {
