...
public class SynchronizedDoubleObjectMapKeyValuesViewTest extends AbstractDoubleObjectMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleObjectMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedDoubleObjectMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedDoubleObjectMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedDoubleObjectMapKeyValuesViewTest implementation() {
