...
public class FloatDoubleHashMapKeysViewTest extends AbstractLazyFloatIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyFloatIterableTestCase._Benchmark {
        ...
        private FloatDoubleHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FloatDoubleHashMapKeysViewTest();
        }

        @java.lang.Override
        public FloatDoubleHashMapKeysViewTest implementation() {
