...
/*
    ...
    public static class _Benchmark {
        ...
        private DoubleShortMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleShortMapsTest> payload) throws java.lang.Throwable {
            this.instance = new DoubleShortMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleShortMapsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleShortMapsTest> mutables;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = DoubleShortMapsTest::immutables;
            this.payloads.mutables = DoubleShortMapsTest::mutables;
        }
    }
*/
}
