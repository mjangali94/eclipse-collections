...
public class IntIntervalTest {
    ...
    public void chunk() {
        ...
        MutableList<IntInterval> expected1 = Lists.mutable.with(IntInterval.fromToBy(0, 1, 1), IntInterval.fromToBy(2, 3, 1), IntInterval.fromToBy(4, 5, 1));
        Assert.assertEquals(expected1, interval1.chunk(2));
        IntInterval interval2 = IntInterval.fromToBy(0, -5, -1);
        MutableList<IntInterval> expected2 = Lists.mutable.with(IntInterval.fromToBy(0, -1, -1), IntInterval.fromToBy(-2, -3, -1), IntInterval.fromToBy(-4, -5, -1));
        Assert.assertEquals(expected2, interval2.chunk(2));
        IntInterval interval3 = IntInterval.fromToBy(0, 6, 1);
        MutableList<IntInterval> expected3 = Lists.mutable.with(IntInterval.fromToBy(0, 1, 1), IntInterval.fromToBy(2, 3, 1), IntInterval.fromToBy(4, 5, 1), IntInterval.fromToBy(6, 6, 1));
        Assert.assertEquals(expected3, interval3.chunk(2));
        IntInterval interval4 = IntInterval.fromToBy(0, -6, -1);
        MutableList<IntInterval> expected4 = Lists.mutable.with(IntInterval.fromToBy(0, -1, -1), IntInterval.fromToBy(-2, -3, -1), IntInterval.fromToBy(-4, -5, -1), IntInterval.fromToBy(-6, -6, -1));
        ...
        MutableList<IntIterable> expected9 = Lists.mutable.with(IntLists.mutable.with(0, 4), IntLists.mutable.with(8));
        Assert.assertEquals(expected9, interval9.chunk(2));
        IntInterval interval10 = IntInterval.fromToBy(0, -9, -4);
        MutableList<IntIterable> expected10 = Lists.mutable.with(IntLists.mutable.with(0, -4), IntLists.mutable.with(-8));
    ...
    public void sum() {
        ...
        Assert.assertEquals(3L * ((long) Integer.MAX_VALUE * 2L - 2L) / 2L, IntInterval.fromTo(Integer.MAX_VALUE - 2, Integer.MAX_VALUE).sum());
    }
    ...
    public void average() {
        ...
        Assert.assertEquals((double) Integer.MAX_VALUE - 1.5, IntInterval.fromTo(Integer.MAX_VALUE - 3, Integer.MAX_VALUE).average(), 0.0);
    }
    ...
    public void median() {
        ...
        Assert.assertEquals((double) Integer.MAX_VALUE - 1.5, IntInterval.fromTo(Integer.MAX_VALUE - 3, Integer.MAX_VALUE).median(), 0.0);
    }
    ...
    public void appendStringThrows() {
        Assert.assertThrows(RuntimeException.class, () -> this.intInterval.appendString(new ThrowingAppendable()));
        Assert.assertThrows(RuntimeException.class, () -> this.intInterval.appendString(new ThrowingAppendable(), ", "));
        Assert.assertThrows(RuntimeException.class, () -> this.intInterval.appendString(new ThrowingAppendable(), "[", ", ", "]"));
    }
    ...
    public void contains() {
        ...
        Assert.assertTrue(IntInterval.fromToBy(1_000_000_000, 2_000_000_000, 1_500_000_000).contains(1_000_000_000));
        Assert.assertTrue(IntInterval.fromToBy(-1_000_000_000, -2_000_000_000, -1_500_000_000).contains(-1_000_000_000));
    ...
    public void zip() {
        ...
        ImmutableList<IntObjectPair<String>> expected = Lists.immutable.with(PrimitiveTuples.pair(1, "1"), PrimitiveTuples.pair(2, "2"), PrimitiveTuples.pair(3, "3"));
    ...
    public void zipInt() {
        ...
        ImmutableList<IntIntPair> expected = Lists.immutable.with(PrimitiveTuples.pair(1, 3), PrimitiveTuples.pair(2, 2), PrimitiveTuples.pair(3, 1));
        Assert.assertEquals(expected, zipped);
        Assert.assertEquals(expected, zippedLazy);
...
/*
    ...
    public static class _Benchmark {
        ...
        private IntIntervalTest instance;
        ...
        public void benchmark_fromToBy_throws_on_illegal_step() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.fromToBy_throws_on_illegal_step);
        }
        ...
        public void benchmark_fromToBy_with_same_start_and_end_with_negative_step2() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.fromToBy_with_same_start_and_end_with_negative_step2);
        }
        ...
        public void benchmark_oneToBy_throws_count_size_zero() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.oneToBy_throws_count_size_zero);
        }
        ...
        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sumIntInterval() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.sumIntInterval);
        }

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maxIntInterval() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.maxIntInterval);
        }
        ...
        public void benchmark_intervalSize() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.intervalSize);
        }
        ...
        public void benchmark_intervalIterator() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.intervalIterator);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> payload) throws java.lang.Throwable {
            this.instance = new IntIntervalTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> fromAndToAndBy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> fromToBy_throws_step_size_zero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> fromToBy_throws_on_illegal_step;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> fromToBy_with_same_start_and_end_with_negative_step;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> fromToBy_with_same_start_and_end_with_negative_step2;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> oneToBy_throws_step_size_zero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> oneToBy_throws_count_size_zero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> zeroToBy_throws_step_size_zero;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> equalsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> sumIntInterval;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> maxIntInterval;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> iterator_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> each;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> injectInto;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> injectIntoWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> injectIntoOnFromToBySameStartEndNegativeStepInterval;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> chunk;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> subList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> dotProduct;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> dotProduct_throwsOnListsOfDifferentSizes;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> empty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> detectIfNone;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> lazyCollectPrimitives;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> binarySearch;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> appendStringThrows;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toReversed;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> evens;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> odds;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> intervalSize;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> largeReverseUnderflowTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> forwardOverflowTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> reverseOverflowTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> intervalIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> forEachWithIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> forEach_with_same_start_and_end_with_negative_step;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> getFirst;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> getLast;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> indexOf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> lastIndexOf;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> containsAllIterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> distinct;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> asReversed;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> zip;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> zipInt;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> primitiveStream;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> primitiveParallelStream;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> newWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> newWithout;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> newWithAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntIntervalTest> newWithoutAll;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.fromAndToAndBy = IntIntervalTest::fromAndToAndBy;
            this.payloads.fromToBy_throws_step_size_zero = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::fromToBy_throws_step_size_zero, java.lang.IllegalArgumentException.class);
            this.payloads.fromToBy_throws_on_illegal_step = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::fromToBy_throws_on_illegal_step, java.lang.IllegalArgumentException.class);
            this.payloads.fromToBy_with_same_start_and_end_with_negative_step = IntIntervalTest::fromToBy_with_same_start_and_end_with_negative_step;
            this.payloads.fromToBy_with_same_start_and_end_with_negative_step2 = IntIntervalTest::fromToBy_with_same_start_and_end_with_negative_step2;
            this.payloads.oneToBy_throws_step_size_zero = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::oneToBy_throws_step_size_zero, java.lang.IllegalArgumentException.class);
            this.payloads.oneToBy_throws_count_size_zero = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::oneToBy_throws_count_size_zero, java.lang.IllegalArgumentException.class);
            this.payloads.zeroToBy_throws_step_size_zero = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::zeroToBy_throws_step_size_zero, java.lang.IllegalArgumentException.class);
            this.payloads.equalsAndHashCode = IntIntervalTest::equalsAndHashCode;
            this.payloads.sumIntInterval = IntIntervalTest::sumIntInterval;
            this.payloads.maxIntInterval = IntIntervalTest::maxIntInterval;
            this.payloads.iterator = IntIntervalTest::iterator;
            this.payloads.iterator_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::iterator_throws, java.util.NoSuchElementException.class);
            this.payloads.forEach = IntIntervalTest::forEach;
            this.payloads.each = IntIntervalTest::each;
            this.payloads.injectInto = IntIntervalTest::injectInto;
            this.payloads.injectIntoWithIndex = IntIntervalTest::injectIntoWithIndex;
            this.payloads.injectIntoOnFromToBySameStartEndNegativeStepInterval = IntIntervalTest::injectIntoOnFromToBySameStartEndNegativeStepInterval;
            this.payloads.chunk = IntIntervalTest::chunk;
            this.payloads.size = IntIntervalTest::size;
            this.payloads.subList = IntIntervalTest::subList;
            this.payloads.dotProduct = IntIntervalTest::dotProduct;
            this.payloads.dotProduct_throwsOnListsOfDifferentSizes = new se.chalmers.ju2jmh.api.ExceptionTest<>(IntIntervalTest::dotProduct_throwsOnListsOfDifferentSizes, java.lang.IllegalArgumentException.class);
            this.payloads.empty = IntIntervalTest::empty;
            this.payloads.count = IntIntervalTest::count;
            this.payloads.anySatisfy = IntIntervalTest::anySatisfy;
            this.payloads.allSatisfy = IntIntervalTest::allSatisfy;
            this.payloads.noneSatisfy = IntIntervalTest::noneSatisfy;
            this.payloads.select = IntIntervalTest::select;
            this.payloads.reject = IntIntervalTest::reject;
            this.payloads.detectIfNone = IntIntervalTest::detectIfNone;
            this.payloads.collect = IntIntervalTest::collect;
            this.payloads.lazyCollectPrimitives = IntIntervalTest::lazyCollectPrimitives;
            this.payloads.binarySearch = IntIntervalTest::binarySearch;
            this.payloads.max = IntIntervalTest::max;
            this.payloads.min = IntIntervalTest::min;
            this.payloads.minIfEmpty = IntIntervalTest::minIfEmpty;
            this.payloads.maxIfEmpty = IntIntervalTest::maxIfEmpty;
            this.payloads.sum = IntIntervalTest::sum;
            this.payloads.average = IntIntervalTest::average;
            this.payloads.median = IntIntervalTest::median;
            this.payloads.toArray = IntIntervalTest::toArray;
            this.payloads.toList = IntIntervalTest::toList;
            this.payloads.toSortedList = IntIntervalTest::toSortedList;
            this.payloads.toSet = IntIntervalTest::toSet;
            this.payloads.toBag = IntIntervalTest::toBag;
            this.payloads.asLazy = IntIntervalTest::asLazy;
            this.payloads.toSortedArray = IntIntervalTest::toSortedArray;
            this.payloads.testEquals = IntIntervalTest::testEquals;
            this.payloads.testHashCode = IntIntervalTest::testHashCode;
            this.payloads.testToString = IntIntervalTest::testToString;
            this.payloads.makeString = IntIntervalTest::makeString;
            this.payloads.appendString = IntIntervalTest::appendString;
            this.payloads.appendStringThrows = IntIntervalTest::appendStringThrows;
            this.payloads.toReversed = IntIntervalTest::toReversed;
            this.payloads.evens = IntIntervalTest::evens;
            this.payloads.odds = IntIntervalTest::odds;
            this.payloads.intervalSize = IntIntervalTest::intervalSize;
            this.payloads.contains = IntIntervalTest::contains;
            this.payloads.largeReverseUnderflowTest = IntIntervalTest::largeReverseUnderflowTest;
            this.payloads.forwardOverflowTest = IntIntervalTest::forwardOverflowTest;
            this.payloads.reverseOverflowTest = IntIntervalTest::reverseOverflowTest;
            this.payloads.intervalIterator = IntIntervalTest::intervalIterator;
            this.payloads.forEachWithIndex = IntIntervalTest::forEachWithIndex;
            this.payloads.forEach_with_same_start_and_end_with_negative_step = IntIntervalTest::forEach_with_same_start_and_end_with_negative_step;
            this.payloads.getFirst = IntIntervalTest::getFirst;
            this.payloads.getLast = IntIntervalTest::getLast;
            this.payloads.indexOf = IntIntervalTest::indexOf;
            this.payloads.lastIndexOf = IntIntervalTest::lastIndexOf;
            this.payloads.get = IntIntervalTest::get;
            this.payloads.containsAll = IntIntervalTest::containsAll;
            this.payloads.containsAllIterable = IntIntervalTest::containsAllIterable;
            this.payloads.distinct = IntIntervalTest::distinct;
            this.payloads.asReversed = IntIntervalTest::asReversed;
            this.payloads.zip = IntIntervalTest::zip;
            this.payloads.zipInt = IntIntervalTest::zipInt;
            this.payloads.primitiveStream = IntIntervalTest::primitiveStream;
            this.payloads.primitiveParallelStream = IntIntervalTest::primitiveParallelStream;
            this.payloads.toImmutable = IntIntervalTest::toImmutable;
            this.payloads.newWith = IntIntervalTest::newWith;
            this.payloads.newWithout = IntIntervalTest::newWithout;
            this.payloads.newWithAll = IntIntervalTest::newWithAll;
