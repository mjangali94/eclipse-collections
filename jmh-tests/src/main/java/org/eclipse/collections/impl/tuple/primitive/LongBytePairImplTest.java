...
public class LongBytePairImplTest {
    ...
    public static class _Benchmark {
        ...
        private LongBytePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new LongBytePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongBytePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = LongBytePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = LongBytePairImplTest::getOne;
            this.payloads.getTwo = LongBytePairImplTest::getTwo;
            this.payloads.testToString = LongBytePairImplTest::testToString;
            this.payloads.compareTo = LongBytePairImplTest::compareTo;
        }
    }
}
