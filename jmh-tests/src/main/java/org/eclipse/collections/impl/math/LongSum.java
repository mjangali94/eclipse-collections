...
public final class LongSum implements Sum {
    ...
    public static class _Benchmark {
        ...
        private LongSum instance;

        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongSum> payload) throws java.lang.Throwable {
            this.instance = new LongSum();
