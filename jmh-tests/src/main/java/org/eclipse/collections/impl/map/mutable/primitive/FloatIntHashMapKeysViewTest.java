...
public class FloatIntHashMapKeysViewTest extends AbstractLazyFloatIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyFloatIterableTestCase._Benchmark {
        ...
        private FloatIntHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FloatIntHashMapKeysViewTest();
        }

        @java.lang.Override
        public FloatIntHashMapKeysViewTest implementation() {
