...
public class ShortCharHashMapKeysViewTest extends AbstractLazyShortIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyShortIterableTestCase._Benchmark {
        ...
        private ShortCharHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ShortCharHashMapKeysViewTest();
        }

        @java.lang.Override
        public ShortCharHashMapKeysViewTest implementation() {
