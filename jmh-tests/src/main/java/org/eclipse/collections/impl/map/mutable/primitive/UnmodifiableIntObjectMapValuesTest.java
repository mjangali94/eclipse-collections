...
public class UnmodifiableIntObjectMapValuesTest {
    ...
    public static class _Benchmark {
        ...
        private UnmodifiableIntObjectMapValuesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> payload) throws java.lang.Throwable {
            this.instance = new UnmodifiableIntObjectMapValuesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableIntObjectMapValuesTest> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(UnmodifiableIntObjectMapValuesTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(UnmodifiableIntObjectMapValuesTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.contains = UnmodifiableIntObjectMapValuesTest::contains;
            this.payloads.containsAll = UnmodifiableIntObjectMapValuesTest::containsAll;
            this.payloads.isEmpty = UnmodifiableIntObjectMapValuesTest::isEmpty;
            this.payloads.size = UnmodifiableIntObjectMapValuesTest::size;
            this.payloads.iterator = UnmodifiableIntObjectMapValuesTest::iterator;
            this.payloads.values = UnmodifiableIntObjectMapValuesTest::values;
            this.payloads.valuesToArray = UnmodifiableIntObjectMapValuesTest::valuesToArray;
        }
    }
}
