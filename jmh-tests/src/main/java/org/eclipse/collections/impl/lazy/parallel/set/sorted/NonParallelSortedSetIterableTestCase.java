...
public abstract class NonParallelSortedSetIterableTestCase extends ParallelSortedSetIterableTestCase {
    ...
    public static abstract class _Benchmark extends org.eclipse.collections.impl.lazy.parallel.set.sorted.ParallelSortedSetIterableTestCase._Benchmark {
        ...
        @java.lang.Override
        public abstract NonParallelSortedSetIterableTestCase implementation();
    }
}
