...
public class MaxComparatorProcedureTest {
    ...
    public static class _Benchmark {
        ...
        private MaxComparatorProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MaxComparatorProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new MaxComparatorProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MaxComparatorProcedureTest> value;
        }
