    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.bag.sorted.mutable.TreeBagTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_818() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.getIfAbsentPutWithKey);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.getIfAbsentPutWithKey);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.removeOccurrences_throws);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.addOccurrences_throws);
        }
