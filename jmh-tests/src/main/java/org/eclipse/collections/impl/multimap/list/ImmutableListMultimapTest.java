...
public class ImmutableListMultimapTest extends AbstractImmutableMultimapTestCase {
    ...
    public void forEachKeyMultiValue() {
        ...
        MutableSet<Pair<String, MutableList<Integer>>> expected = Sets.mutable.with(Tuples.pair("Two", Lists.mutable.with(2, 1)), Tuples.pair("Three", Lists.mutable.with(3, 3)));
    ...
    public void forEachKeyImmutableList() {
        ...
        MutableSet<Pair<String, ImmutableList<Integer>>> exptected = Sets.mutable.with(Tuples.pair("Two", Lists.immutable.with(2, 1)), Tuples.pair("Three", Lists.immutable.with(3, 3)));
    ...
    @Test
    public void flip() {
        ImmutableListMultimap<String, Integer> multimap = this.<String, Integer>classUnderTest().newWith("Less than 2", 1).newWith("Less than 3", 1).newWith("Less than 3", 2).newWith("Less than 3", 2);
    ...
    public static class _Benchmark {
        ...
        private ImmutableListMultimapTest instance;
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_forEachKeyImmutableList() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.forEachKeyImmutableList);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> payload) throws java.lang.Throwable {
            this.instance = new ImmutableListMultimapTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> allowDuplicates;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> noDuplicates;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> toMap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> newWithout;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> newWithAll_newWithoutAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> testSerialization;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> forEachKeyMultiValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> forEachKeyImmutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> flip;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> selectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> rejectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> selectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> rejectKeysMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> collectKeysValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> collectKeyMultiValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableListMultimapTest> collectValues;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.size = ImmutableListMultimapTest::size;
            this.payloads.allowDuplicates = ImmutableListMultimapTest::allowDuplicates;
            this.payloads.noDuplicates = ImmutableListMultimapTest::noDuplicates;
            this.payloads.isEmpty = ImmutableListMultimapTest::isEmpty;
            this.payloads.keySet = ImmutableListMultimapTest::keySet;
            this.payloads.get = ImmutableListMultimapTest::get;
            this.payloads.toMap = ImmutableListMultimapTest::toMap;
            this.payloads.newWithout = ImmutableListMultimapTest::newWithout;
            this.payloads.newWithAll_newWithoutAll = ImmutableListMultimapTest::newWithAll_newWithoutAll;
            this.payloads.toImmutable = ImmutableListMultimapTest::toImmutable;
            this.payloads.testSerialization = ImmutableListMultimapTest::testSerialization;
            this.payloads.forEachKeyMultiValue = ImmutableListMultimapTest::forEachKeyMultiValue;
            this.payloads.forEachKeyImmutableList = ImmutableListMultimapTest::forEachKeyImmutableList;
            this.payloads.flip = ImmutableListMultimapTest::flip;
            this.payloads.selectKeysValues = ImmutableListMultimapTest::selectKeysValues;
            this.payloads.rejectKeysValues = ImmutableListMultimapTest::rejectKeysValues;
            this.payloads.selectKeysMultiValues = ImmutableListMultimapTest::selectKeysMultiValues;
            this.payloads.rejectKeysMultiValues = ImmutableListMultimapTest::rejectKeysMultiValues;
            this.payloads.collectKeysValues = ImmutableListMultimapTest::collectKeysValues;
            this.payloads.collectKeyMultiValues = ImmutableListMultimapTest::collectKeyMultiValues;
            this.payloads.collectValues = ImmutableListMultimapTest::collectValues;
        }
    }
}
