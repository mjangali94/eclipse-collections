...
public class ImmutableUnifiedMapWithHashingStrategy2Test extends MapIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.MapIterableTestCase._Benchmark {

        private ImmutableUnifiedMapWithHashingStrategy2Test implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableUnifiedMapWithHashingStrategy2Test();
        }

        @java.lang.Override
        public ImmutableUnifiedMapWithHashingStrategy2Test implementation() {
