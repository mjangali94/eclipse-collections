...
public class ImmutableDoubleObjectHashMapKeysViewTest extends AbstractLazyDoubleIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyDoubleIterableTestCase._Benchmark {
        ...
        private ImmutableDoubleObjectHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableDoubleObjectHashMapKeysViewTest();
        }

        @java.lang.Override
        public ImmutableDoubleObjectHashMapKeysViewTest implementation() {
