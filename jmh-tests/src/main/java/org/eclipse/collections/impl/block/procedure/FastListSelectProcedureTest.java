...
/*
    ...
    public static class _Benchmark {
        ...
        private FastListSelectProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FastListSelectProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new FastListSelectProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FastListSelectProcedureTest> value;
        }
