...
public class TuplesTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_pairToList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::pairToList, this.description("pairToList"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_pairToFixedSizeList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::pairToFixedSizeList, this.description("pairToFixedSizeList"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_pairToImmutableList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::pairToImmutableList, this.description("pairToImmutableList"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_tripleToList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::tripleToList, this.description("tripleToList"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_tripleToFixedSizeList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::tripleToFixedSizeList, this.description("tripleToFixedSizeList"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_tripleToImmutableList() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::tripleToImmutableList, this.description("tripleToImmutableList"));
        }
