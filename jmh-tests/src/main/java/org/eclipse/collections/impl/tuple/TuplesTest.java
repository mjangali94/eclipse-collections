...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> payload) throws java.lang.Throwable {
            this.instance = new TuplesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pairFrom;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pair;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> twin;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> identicalTwin;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> triple;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> triplet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> identicalTriplet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> equalsHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> equalsHashCodeTriple;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> putToMap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pairFunctions;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> swap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> reverse;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pairToList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pairToFixedSizeList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> pairToImmutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> tripleToList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> tripleToFixedSizeList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TuplesTest> tripleToImmutableList;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.pairFrom = TuplesTest::pairFrom;
            this.payloads.pair = TuplesTest::pair;
            this.payloads.twin = TuplesTest::twin;
            this.payloads.identicalTwin = TuplesTest::identicalTwin;
            this.payloads.triple = TuplesTest::triple;
            this.payloads.triplet = TuplesTest::triplet;
            this.payloads.identicalTriplet = TuplesTest::identicalTriplet;
            this.payloads.equalsHashCode = TuplesTest::equalsHashCode;
            this.payloads.equalsHashCodeTriple = TuplesTest::equalsHashCodeTriple;
            this.payloads.putToMap = TuplesTest::putToMap;
            this.payloads.testToString = TuplesTest::testToString;
            this.payloads.pairFunctions = TuplesTest::pairFunctions;
            this.payloads.swap = TuplesTest::swap;
            this.payloads.reverse = TuplesTest::reverse;
            this.payloads.pairToList = TuplesTest::pairToList;
            this.payloads.pairToFixedSizeList = TuplesTest::pairToFixedSizeList;
            this.payloads.pairToImmutableList = TuplesTest::pairToImmutableList;
            this.payloads.tripleToList = TuplesTest::tripleToList;
            this.payloads.tripleToFixedSizeList = TuplesTest::tripleToFixedSizeList;
