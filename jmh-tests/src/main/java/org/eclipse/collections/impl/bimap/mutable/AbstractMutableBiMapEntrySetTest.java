...
public abstract class AbstractMutableBiMapEntrySetTest {
    ...
    public static class _Benchmark {
        ...
        private AbstractMutableBiMapEntrySetTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> payload) throws java.lang.Throwable {
            this.instance = new AbstractMutableBiMapEntrySetTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_clear;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_setValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_setValue_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_remove;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_equals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entrySet_Iterator_incrementPastEnd;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_hashCodeForNullKeyAndValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_equals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_equalsWithNonEntry;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapEntrySetTest> entry_toString;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.entry_clear = AbstractMutableBiMapEntrySetTest::entry_clear;
            this.payloads.entry_isEmpty = AbstractMutableBiMapEntrySetTest::entry_isEmpty;
            this.payloads.entry_toArray = AbstractMutableBiMapEntrySetTest::entry_toArray;
            this.payloads.entry_setValue = AbstractMutableBiMapEntrySetTest::entry_setValue;
            this.payloads.entry_setValue_throws = AbstractMutableBiMapEntrySetTest::entry_setValue_throws;
            this.payloads.entrySet_remove = AbstractMutableBiMapEntrySetTest::entrySet_remove;
            this.payloads.entrySet_contains = AbstractMutableBiMapEntrySetTest::entrySet_contains;
            this.payloads.entrySet_containsAll = AbstractMutableBiMapEntrySetTest::entrySet_containsAll;
            this.payloads.entrySet_add = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapEntrySetTest::entrySet_add, java.lang.UnsupportedOperationException.class);
            this.payloads.entrySet_addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapEntrySetTest::entrySet_addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.entrySet_equals = AbstractMutableBiMapEntrySetTest::entrySet_equals;
            this.payloads.entrySet_Iterator_incrementPastEnd = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapEntrySetTest::entrySet_Iterator_incrementPastEnd, java.util.NoSuchElementException.class);
            this.payloads.entry_hashCodeForNullKeyAndValue = AbstractMutableBiMapEntrySetTest::entry_hashCodeForNullKeyAndValue;
            this.payloads.entry_equals = AbstractMutableBiMapEntrySetTest::entry_equals;
            this.payloads.entry_equalsWithNonEntry = AbstractMutableBiMapEntrySetTest::entry_equalsWithNonEntry;
