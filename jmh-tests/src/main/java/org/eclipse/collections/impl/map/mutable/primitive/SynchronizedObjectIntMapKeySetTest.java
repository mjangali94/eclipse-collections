...
/*
    ...
    public static class _Benchmark {
        ...
        private SynchronizedObjectIntMapKeySetTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> payload) throws java.lang.Throwable {
            this.instance = new SynchronizedObjectIntMapKeySetTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> removeFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> removeNullFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> removeAllFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> retainAllFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> clearKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> keySetEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SynchronizedObjectIntMapKeySetTest> keySetToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedObjectIntMapKeySetTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(SynchronizedObjectIntMapKeySetTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.contains = SynchronizedObjectIntMapKeySetTest::contains;
            this.payloads.containsAll = SynchronizedObjectIntMapKeySetTest::containsAll;
            this.payloads.isEmpty = SynchronizedObjectIntMapKeySetTest::isEmpty;
            this.payloads.size = SynchronizedObjectIntMapKeySetTest::size;
            this.payloads.iterator = SynchronizedObjectIntMapKeySetTest::iterator;
            this.payloads.removeFromKeySet = SynchronizedObjectIntMapKeySetTest::removeFromKeySet;
            this.payloads.removeNullFromKeySet = SynchronizedObjectIntMapKeySetTest::removeNullFromKeySet;
            this.payloads.removeAllFromKeySet = SynchronizedObjectIntMapKeySetTest::removeAllFromKeySet;
            this.payloads.retainAllFromKeySet = SynchronizedObjectIntMapKeySetTest::retainAllFromKeySet;
            this.payloads.clearKeySet = SynchronizedObjectIntMapKeySetTest::clearKeySet;
            this.payloads.keySetEqualsAndHashCode = SynchronizedObjectIntMapKeySetTest::keySetEqualsAndHashCode;
            this.payloads.keySetToArray = SynchronizedObjectIntMapKeySetTest::keySetToArray;
        }
    }
*/
}
