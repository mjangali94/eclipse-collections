...
public class SubtractFunctionTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SubtractFunctionTest> payload) throws java.lang.Throwable {
            this.instance = new SubtractFunctionTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SubtractFunctionTest> subtractIntegerFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SubtractFunctionTest> subtractDoubleFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SubtractFunctionTest> subtractLongFunction;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.subtractIntegerFunction = SubtractFunctionTest::subtractIntegerFunction;
            this.payloads.subtractDoubleFunction = SubtractFunctionTest::subtractDoubleFunction;
