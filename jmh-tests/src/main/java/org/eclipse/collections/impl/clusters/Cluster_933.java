    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.list.immutable.ImmutableNonupletonListTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_933() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.addAllAtIndex);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.removeAll);
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.addAll);
        }
