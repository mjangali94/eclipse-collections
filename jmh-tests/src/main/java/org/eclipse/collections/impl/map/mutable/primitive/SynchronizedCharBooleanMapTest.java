...
public class SynchronizedCharBooleanMapTest extends AbstractMutableCharBooleanMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.AbstractMutableCharBooleanMapTestCase._Benchmark {
        ...
        private SynchronizedCharBooleanMapTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedCharBooleanMapTest();
        }

        @java.lang.Override
        public SynchronizedCharBooleanMapTest implementation() {
