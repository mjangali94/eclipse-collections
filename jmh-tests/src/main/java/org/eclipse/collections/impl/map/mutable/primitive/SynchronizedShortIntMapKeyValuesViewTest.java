...
public class SynchronizedShortIntMapKeyValuesViewTest extends AbstractShortIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortIntMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortIntMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortIntMapKeyValuesViewTest implementation() {
