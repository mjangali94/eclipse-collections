...
public class LongObjectMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private LongObjectMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongObjectMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new LongObjectMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongObjectMapFactoryTest> empty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongObjectMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongObjectMapFactoryTest> ofAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongObjectMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.empty = LongObjectMapFactoryTest::empty;
            this.payloads.of = LongObjectMapFactoryTest::of;
            this.payloads.ofAll = LongObjectMapFactoryTest::ofAll;
            this.payloads.from = LongObjectMapFactoryTest::from;
        }
    }
}
