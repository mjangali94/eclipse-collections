...
public class FunctionComparatorTest {
    ...
    public void comparator() {
        Comparator<Band> comparator = new FunctionComparator<>(Band.TO_NAME, String::compareTo);
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FunctionComparatorTest> payload) throws java.lang.Throwable {
            this.instance = new FunctionComparatorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FunctionComparatorTest> comparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FunctionComparatorTest> functionComparatorBuiltTheHardWay;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FunctionComparatorTest> functionComparatorBuiltTheEasyWay;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.comparator = FunctionComparatorTest::comparator;
            this.payloads.functionComparatorBuiltTheHardWay = FunctionComparatorTest::functionComparatorBuiltTheHardWay;
