...
public class HashingStrategyMapsTest {
    ...
    public void mutable() {
        ...
        MutableList<Pair<Person, String>> pairs = Lists.mutable.of(Tuples.pair(new Person("John", "Smith"), "A"), Tuples.pair(new Person("Alex", "Smith"), "B"), Tuples.pair(new Person("Jeff", "Johnson"), "D"));
        Assert.assertEquals(new UnifiedMapWithHashingStrategy<Person, String>(HashingStrategies.fromFunction(Person::getLastName)).withAllKeyValues(pairs), factory.<Person, String, String>fromFunction(Person::getLastName).withAllKeyValues(pairs));
        Assert.assertEquals(new UnifiedMapWithHashingStrategy<Person, String>(HashingStrategies.fromFunction(Person::getFirstName)).withAllKeyValues(pairs), factory.<Person, String, String>fromFunction(Person::getFirstName).withAllKeyValues(pairs));
    }
    ...
    public static class _Benchmark {
        ...
        private HashingStrategyMapsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyMapsTest> payload) throws java.lang.Throwable {
            this.instance = new HashingStrategyMapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyMapsTest> immutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyMapsTest> mutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategyMapsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutable = HashingStrategyMapsTest::immutable;
            this.payloads.mutable = HashingStrategyMapsTest::mutable;
            this.payloads.classIsNonInstantiable = HashingStrategyMapsTest::classIsNonInstantiable;
        }
    }
}
