...
/*
    ...
    public static class _Benchmark {
        ...
        private FloatLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<FloatLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new FloatLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatLongMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatLongMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<FloatLongMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = FloatLongMapFactoryTest::of;
            this.payloads.withAll = FloatLongMapFactoryTest::withAll;
            this.payloads.from = FloatLongMapFactoryTest::from;
        }
    }
*/
}
