...
public class ImmutableFloatFloatHashMapKeyValuesViewTest extends AbstractFloatFloatMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatFloatMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableFloatFloatHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableFloatFloatHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableFloatFloatHashMapKeyValuesViewTest implementation() {
