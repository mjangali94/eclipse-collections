...
public class UnmodifiableObjectFloatMapKeysViewTest extends AbstractObjectFloatMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectFloatMapKeysViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectFloatMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectFloatMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectFloatMapKeysViewTest implementation() {
