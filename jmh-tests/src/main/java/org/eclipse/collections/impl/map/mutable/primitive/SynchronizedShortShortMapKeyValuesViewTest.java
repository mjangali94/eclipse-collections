...
public class SynchronizedShortShortMapKeyValuesViewTest extends AbstractShortShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortShortMapKeyValuesViewTest implementation() {
