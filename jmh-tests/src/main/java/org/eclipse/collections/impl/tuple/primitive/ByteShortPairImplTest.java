...
/*
    ...
    public static class _Benchmark {
        ...
        private ByteShortPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new ByteShortPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteShortPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = ByteShortPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = ByteShortPairImplTest::getOne;
            this.payloads.getTwo = ByteShortPairImplTest::getTwo;
            this.payloads.testToString = ByteShortPairImplTest::testToString;
            this.payloads.compareTo = ByteShortPairImplTest::compareTo;
        }
    }
*/
}
