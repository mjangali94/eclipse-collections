...
/*
    ...
    public static class _Benchmark {
        ...
        private TakeWhileIteratorTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<TakeWhileIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new TakeWhileIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TakeWhileIteratorTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TakeWhileIteratorTest> hasNext;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TakeWhileIteratorTest> remove;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<TakeWhileIteratorTest> noSuchElementException;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.iterator = TakeWhileIteratorTest::iterator;
            this.payloads.hasNext = TakeWhileIteratorTest::hasNext;
            this.payloads.remove = TakeWhileIteratorTest::remove;
