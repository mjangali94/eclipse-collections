    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.bag.mutable.MultiReaderHashBagTest._Benchmark _Benchmark_benchmark_9;
        ...
        public void benchmark_Cluster_372() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.countByWith);
            this._Benchmark_benchmark_6.runBenchmark(this._Benchmark_benchmark_6.payloads.keyBag);
            this._Benchmark_benchmark_7.runBenchmark(this._Benchmark_benchmark_7.payloads.countBy);
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.countBy);
            this._Benchmark_benchmark_9.runBenchmark(this._Benchmark_benchmark_9.payloads.max_null_safe);
            this._Benchmark_benchmark_9.runBenchmark(this._Benchmark_benchmark_9.payloads.min_null_safe);
            this._Benchmark_benchmark_9.runBenchmark(this._Benchmark_benchmark_9.payloads.collectBooleanWithBagTarget);
        }
