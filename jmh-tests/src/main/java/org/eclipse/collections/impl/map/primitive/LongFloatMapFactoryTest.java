...
public class LongFloatMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private LongFloatMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongFloatMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new LongFloatMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongFloatMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongFloatMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongFloatMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = LongFloatMapFactoryTest::of;
            this.payloads.withAll = LongFloatMapFactoryTest::withAll;
            this.payloads.from = LongFloatMapFactoryTest::from;
        }
    }
}
