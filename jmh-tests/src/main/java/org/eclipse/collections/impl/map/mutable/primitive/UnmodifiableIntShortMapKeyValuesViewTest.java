...
public class UnmodifiableIntShortMapKeyValuesViewTest extends AbstractIntShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableIntShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableIntShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableIntShortMapKeyValuesViewTest implementation() {
