...
public class ObjectLongHashMapKeySetTest extends ObjectLongHashMapKeySetTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.ObjectLongHashMapKeySetTestCase._Benchmark {
        ...
        private ObjectLongHashMapKeySetTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectLongHashMapKeySetTest();
        }

        @java.lang.Override
        public ObjectLongHashMapKeySetTest implementation() {
