...
public class LongIntHashMapKeyValuesViewTest extends AbstractLongIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private LongIntHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LongIntHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public LongIntHashMapKeyValuesViewTest implementation() {
