...
public class CharBytePairImplTest {
    ...
    public static class _Benchmark {
        ...
        private CharBytePairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> payload) throws java.lang.Throwable {
            this.instance = new CharBytePairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharBytePairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = CharBytePairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = CharBytePairImplTest::getOne;
            this.payloads.getTwo = CharBytePairImplTest::getTwo;
            this.payloads.testToString = CharBytePairImplTest::testToString;
            this.payloads.compareTo = CharBytePairImplTest::compareTo;
        }
    }
}
