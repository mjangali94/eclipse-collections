...
public class ObjectDoubleHashMapKeysViewTest extends AbstractObjectDoubleMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectDoubleMapKeysViewTestCase._Benchmark {
        ...
        private ObjectDoubleHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectDoubleHashMapKeysViewTest();
        }

        @java.lang.Override
        public ObjectDoubleHashMapKeysViewTest implementation() {
