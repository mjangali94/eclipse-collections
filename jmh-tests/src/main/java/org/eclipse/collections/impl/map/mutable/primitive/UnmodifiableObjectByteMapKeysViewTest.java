...
public class UnmodifiableObjectByteMapKeysViewTest extends AbstractObjectByteMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectByteMapKeysViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectByteMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectByteMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectByteMapKeysViewTest implementation() {
