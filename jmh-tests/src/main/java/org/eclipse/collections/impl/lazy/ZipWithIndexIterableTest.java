...
public class ZipWithIndexIterableTest {
    ...
    public static class _Benchmark {
        ...
        private ZipWithIndexIterableTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ZipWithIndexIterableTest> payload) throws java.lang.Throwable {
            this.instance = new ZipWithIndexIterableTest();
            this.instance.setUp();
        ...
        private static class _Payloads {
            ...
            public se.chalmers.ju2jmh.api.ThrowingConsumer<ZipWithIndexIterableTest> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ZipWithIndexIterableTest> forEachWIthIndex;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ZipWithIndexIterableTest> forEachWith;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.forEach = ZipWithIndexIterableTest::forEach;
            this.payloads.forEachWIthIndex = ZipWithIndexIterableTest::forEachWIthIndex;
