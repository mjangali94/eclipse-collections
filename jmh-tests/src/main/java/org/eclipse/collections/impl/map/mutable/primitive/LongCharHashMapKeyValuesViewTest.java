...
public class LongCharHashMapKeyValuesViewTest extends AbstractLongCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private LongCharHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LongCharHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public LongCharHashMapKeyValuesViewTest implementation() {
