...
public class SynchronizedLongIntMapKeyValuesViewTest extends AbstractLongIntMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongIntMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedLongIntMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedLongIntMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedLongIntMapKeyValuesViewTest implementation() {
