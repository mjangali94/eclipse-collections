...
public class UnmodifiableIntLongMapKeyValuesViewTest extends AbstractIntLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableIntLongMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableIntLongMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableIntLongMapKeyValuesViewTest implementation() {
