...
public class ImmutableLongSetFactoryImplTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        private ImmutableLongSetFactoryImplTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableLongSetFactoryImplTest();
        }

        @java.lang.Override
        public ImmutableLongSetFactoryImplTest implementation() {
