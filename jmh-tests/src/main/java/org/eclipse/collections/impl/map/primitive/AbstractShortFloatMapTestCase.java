...
public abstract class AbstractShortFloatMapTestCase {
    ...
    public void keySet() {
        ...
        Assert.assertEquals(ShortHashSet.newSetWith((short) 0, (short) 31, (short) 32), this.newWithKeysValues((short) 0, 0.0f, (short) 31, 31.0f, (short) 32, 32.0f).keySet());
    }
    ...
    public void testHashCode() {
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 0, 0.0f, (short) 1, 1.0f, (short) 32, 32.0f).hashCode(), this.newWithKeysValues((short) 32, 32.0f, (short) 0, 0.0f, (short) 1, 1.0f).hashCode());
        Assert.assertEquals(UnifiedMap.newWithKeysValues((short) 50, 0.0f, (short) 60, 1.0f, (short) 70, 33.0f).hashCode(), this.newWithKeysValues((short) 50, 0.0f, (short) 60, 1.0f, (short) 70, 33.0f).hashCode());
    ...
    public void injectIntoKeyValue() {
        ShortFloatMap map0 = this.newWithKeysValues((short) 0, 1.0f, (short) 3, 4.0f);
        Long sum0 = map0.injectIntoKeyValue(new Long(0), (Long sum, short eachKey, float eachValue) -> {
            return new Long((long) (sum + eachKey + eachValue));
        });
        Assert.assertEquals(new Long(8), sum0);
        ShortFloatMap copy = map0.injectIntoKeyValue(ShortFloatMaps.mutable.empty(), MutableShortFloatMap::withKeyValue);
    ...
    public void toList() {
        ...
        Assert.assertTrue(this.newWithKeysValues((short) 2, 2.0f, (short) 3, 3.0f).toList().equals(FloatArrayList.newListWith(2.0f, 3.0f)) || this.newWithKeysValues((short) 2, 2.0f, (short) 3, 3.0f).toList().equals(FloatArrayList.newListWith(3.0f, 2.0f)));
    }
    ...
    public void chunk() {
        ...
        Assert.assertEquals(Lists.mutable.with(FloatBags.mutable.with(1.0f)).toSet(), this.newWithKeysValues((short) 1, 1.0f).chunk(1).toSet());
        Verify.assertIterablesEqual(Lists.mutable.empty(), this.getEmptyMap().chunk(1));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(0));
        Assert.assertThrows(IllegalArgumentException.class, () -> iterable.chunk(-1));
        Assert.assertThrows(IllegalArgumentException.class, () -> this.newWithKeysValues((short) 1, 1.0f).chunk(-1));
    }
...
/*
    ...
    public static class _Benchmark {
        ...
        private AbstractShortFloatMapTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractShortFloatMapTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> keySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> get;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> getIfAbsent;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> getOrThrow;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> containsKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> containsValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> containsAll_Iterable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> notEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> testEquals;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> testHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> forEach;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> forEachValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> forEachKey;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> forEachKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> injectIntoKeyValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> makeString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> appendString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> select;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> reject;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> select_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> reject_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> collect;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> count;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> detectIfNone_value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> anySatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> allSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> noneSatisfy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> max;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> min;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> max_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> min_empty_throws;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> minIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> maxIfEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> sum;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> average;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> averageThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> median;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> medianThrowsOnEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toSortedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> floatIterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> asLazy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> keysView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> keyValuesView;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toSortedArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> toImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractShortFloatMapTestCase> chunk;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.keySet = AbstractShortFloatMapTestCase::keySet;
            this.payloads.values = AbstractShortFloatMapTestCase::values;
            this.payloads.get = AbstractShortFloatMapTestCase::get;
            this.payloads.getIfAbsent = AbstractShortFloatMapTestCase::getIfAbsent;
            this.payloads.getOrThrow = AbstractShortFloatMapTestCase::getOrThrow;
            this.payloads.containsKey = AbstractShortFloatMapTestCase::containsKey;
            this.payloads.containsValue = AbstractShortFloatMapTestCase::containsValue;
            this.payloads.contains = AbstractShortFloatMapTestCase::contains;
            this.payloads.containsAll = AbstractShortFloatMapTestCase::containsAll;
            this.payloads.containsAll_Iterable = AbstractShortFloatMapTestCase::containsAll_Iterable;
            this.payloads.size = AbstractShortFloatMapTestCase::size;
            this.payloads.isEmpty = AbstractShortFloatMapTestCase::isEmpty;
            this.payloads.notEmpty = AbstractShortFloatMapTestCase::notEmpty;
            this.payloads.testEquals = AbstractShortFloatMapTestCase::testEquals;
            this.payloads.testHashCode = AbstractShortFloatMapTestCase::testHashCode;
            this.payloads.testToString = AbstractShortFloatMapTestCase::testToString;
            this.payloads.forEach = AbstractShortFloatMapTestCase::forEach;
            this.payloads.forEachValue = AbstractShortFloatMapTestCase::forEachValue;
            this.payloads.forEachKey = AbstractShortFloatMapTestCase::forEachKey;
            this.payloads.forEachKeyValue = AbstractShortFloatMapTestCase::forEachKeyValue;
            this.payloads.injectIntoKeyValue = AbstractShortFloatMapTestCase::injectIntoKeyValue;
            this.payloads.makeString = AbstractShortFloatMapTestCase::makeString;
            this.payloads.appendString = AbstractShortFloatMapTestCase::appendString;
            this.payloads.select = AbstractShortFloatMapTestCase::select;
            this.payloads.reject = AbstractShortFloatMapTestCase::reject;
            this.payloads.select_value = AbstractShortFloatMapTestCase::select_value;
            this.payloads.reject_value = AbstractShortFloatMapTestCase::reject_value;
            this.payloads.collect = AbstractShortFloatMapTestCase::collect;
            this.payloads.count = AbstractShortFloatMapTestCase::count;
            this.payloads.detectIfNone_value = AbstractShortFloatMapTestCase::detectIfNone_value;
            this.payloads.anySatisfy = AbstractShortFloatMapTestCase::anySatisfy;
            this.payloads.allSatisfy = AbstractShortFloatMapTestCase::allSatisfy;
            this.payloads.noneSatisfy = AbstractShortFloatMapTestCase::noneSatisfy;
            this.payloads.max = AbstractShortFloatMapTestCase::max;
            this.payloads.min = AbstractShortFloatMapTestCase::min;
            this.payloads.max_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortFloatMapTestCase::max_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.min_empty_throws = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortFloatMapTestCase::min_empty_throws, java.util.NoSuchElementException.class);
            this.payloads.minIfEmpty = AbstractShortFloatMapTestCase::minIfEmpty;
            this.payloads.maxIfEmpty = AbstractShortFloatMapTestCase::maxIfEmpty;
            this.payloads.sum = AbstractShortFloatMapTestCase::sum;
            this.payloads.average = AbstractShortFloatMapTestCase::average;
            this.payloads.averageThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortFloatMapTestCase::averageThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.median = AbstractShortFloatMapTestCase::median;
            this.payloads.medianThrowsOnEmpty = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractShortFloatMapTestCase::medianThrowsOnEmpty, java.lang.ArithmeticException.class);
            this.payloads.toList = AbstractShortFloatMapTestCase::toList;
            this.payloads.toSortedList = AbstractShortFloatMapTestCase::toSortedList;
            this.payloads.toSet = AbstractShortFloatMapTestCase::toSet;
            this.payloads.toBag = AbstractShortFloatMapTestCase::toBag;
            this.payloads.floatIterator = AbstractShortFloatMapTestCase::floatIterator;
            this.payloads.asLazy = AbstractShortFloatMapTestCase::asLazy;
            this.payloads.keysView = AbstractShortFloatMapTestCase::keysView;
            this.payloads.keyValuesView = AbstractShortFloatMapTestCase::keyValuesView;
            this.payloads.toSortedArray = AbstractShortFloatMapTestCase::toSortedArray;
            this.payloads.toArray = AbstractShortFloatMapTestCase::toArray;
            this.payloads.toImmutable = AbstractShortFloatMapTestCase::toImmutable;
            this.payloads.chunk = AbstractShortFloatMapTestCase::chunk;
        }
    }
*/
}
