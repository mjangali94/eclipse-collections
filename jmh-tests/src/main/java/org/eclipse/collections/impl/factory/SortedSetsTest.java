...
public class SortedSetsTest {
    ...
    public static class _Benchmark {
        ...
        private SortedSetsTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SortedSetsTest> payload) throws java.lang.Throwable {
            this.instance = new SortedSetsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SortedSetsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SortedSetsTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SortedSetsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = SortedSetsTest::immutables;
            this.payloads.mutables = SortedSetsTest::mutables;
