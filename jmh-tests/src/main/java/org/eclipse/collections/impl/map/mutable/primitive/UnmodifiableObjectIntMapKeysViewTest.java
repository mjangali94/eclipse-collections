...
public class UnmodifiableObjectIntMapKeysViewTest extends AbstractObjectIntMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectIntMapKeysViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectIntMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectIntMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectIntMapKeysViewTest implementation() {
