...
public class ObjectBooleanHashMapWithHashingStrategyValuesTest extends ObjectBooleanHashMapValuesTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.ObjectBooleanHashMapValuesTestCase._Benchmark {

        private ObjectBooleanHashMapWithHashingStrategyValuesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectBooleanHashMapWithHashingStrategyValuesTest();
        }

        @java.lang.Override
        public ObjectBooleanHashMapWithHashingStrategyValuesTest implementation() {
