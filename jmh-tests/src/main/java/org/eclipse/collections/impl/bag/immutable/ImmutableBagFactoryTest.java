...
public class ImmutableBagFactoryTest {
    ...
    public void ofOccurrences() {
        ImmutableBag<String> immutableBag = Bags.immutable.ofOccurrences(new StringIntPair("a", 5), new StringIntPair("b", 10));
    ...
    public void withOccurrences() {
        ImmutableBag<String> immutableBag = Bags.immutable.withOccurrences(new StringIntPair("a", 5), new StringIntPair("b", 10));
        Assert.assertTrue(immutableBag.contains("a"));
        Assert.assertTrue(immutableBag.contains("b"));
        Assert.assertFalse(immutableBag.contains("c"));
    }
...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableBagFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ImmutableBagFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableBagFactoryTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableBagFactoryTest> ofOccurrences;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableBagFactoryTest> withOccurrences;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ImmutableBagFactoryTest> singletonBagCreation;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = ImmutableBagFactoryTest::immutables;
            this.payloads.ofOccurrences = ImmutableBagFactoryTest::ofOccurrences;
            this.payloads.withOccurrences = ImmutableBagFactoryTest::withOccurrences;
