...
public class ImmutableBagFactoryTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_ofOccurrences() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ofOccurrences, this.description("ofOccurrences"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withOccurrences() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withOccurrences, this.description("withOccurrences"));
        }
