...
public final class DoubleFunctionImplTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleFunctionImplTest> payload) throws java.lang.Throwable {
            this.instance = new DoubleFunctionImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleFunctionImplTest> testValueOf;
        }
