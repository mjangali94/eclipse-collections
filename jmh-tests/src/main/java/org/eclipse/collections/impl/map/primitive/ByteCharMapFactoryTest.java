...
public class ByteCharMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private ByteCharMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCharMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new ByteCharMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCharMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCharMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ByteCharMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = ByteCharMapFactoryTest::of;
            this.payloads.withAll = ByteCharMapFactoryTest::withAll;
            this.payloads.from = ByteCharMapFactoryTest::from;
        }
    }
}
