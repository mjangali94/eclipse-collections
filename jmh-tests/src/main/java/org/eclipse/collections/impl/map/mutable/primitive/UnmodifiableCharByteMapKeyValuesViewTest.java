...
public class UnmodifiableCharByteMapKeyValuesViewTest extends AbstractCharByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractCharByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableCharByteMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableCharByteMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableCharByteMapKeyValuesViewTest implementation() {
