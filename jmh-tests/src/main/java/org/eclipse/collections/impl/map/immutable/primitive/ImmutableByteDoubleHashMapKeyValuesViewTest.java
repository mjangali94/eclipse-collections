...
public class ImmutableByteDoubleHashMapKeyValuesViewTest extends AbstractByteDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableByteDoubleHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableByteDoubleHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableByteDoubleHashMapKeyValuesViewTest implementation() {
