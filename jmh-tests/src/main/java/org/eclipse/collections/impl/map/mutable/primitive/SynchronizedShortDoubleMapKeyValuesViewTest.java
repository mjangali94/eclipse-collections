...
public class SynchronizedShortDoubleMapKeyValuesViewTest extends AbstractShortDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractShortDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedShortDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedShortDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedShortDoubleMapKeyValuesViewTest implementation() {
