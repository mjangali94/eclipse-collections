...
public class DoubleShortHashMapKeyValuesViewTest extends AbstractDoubleShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private DoubleShortHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DoubleShortHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public DoubleShortHashMapKeyValuesViewTest implementation() {
