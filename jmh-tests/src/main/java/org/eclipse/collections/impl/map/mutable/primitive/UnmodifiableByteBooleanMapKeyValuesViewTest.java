...
public class UnmodifiableByteBooleanMapKeyValuesViewTest extends AbstractByteBooleanMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractByteBooleanMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableByteBooleanMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableByteBooleanMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableByteBooleanMapKeyValuesViewTest implementation() {
