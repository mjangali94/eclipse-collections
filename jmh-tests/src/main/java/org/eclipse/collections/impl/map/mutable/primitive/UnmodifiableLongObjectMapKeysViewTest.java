...
public class UnmodifiableLongObjectMapKeysViewTest extends AbstractLazyLongIterableTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.lazy.primitive.AbstractLazyLongIterableTestCase._Benchmark {
        ...
        private UnmodifiableLongObjectMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableLongObjectMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableLongObjectMapKeysViewTest implementation() {
