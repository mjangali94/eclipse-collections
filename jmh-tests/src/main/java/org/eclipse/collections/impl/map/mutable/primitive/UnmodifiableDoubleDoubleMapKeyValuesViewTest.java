...
public class UnmodifiableDoubleDoubleMapKeyValuesViewTest extends AbstractDoubleDoubleMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractDoubleDoubleMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableDoubleDoubleMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableDoubleDoubleMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableDoubleDoubleMapKeyValuesViewTest implementation() {
