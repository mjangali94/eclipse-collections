...
public class SortedMapAdapterTest extends MutableSortedMapTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.sorted.mutable.MutableSortedMapTestCase._Benchmark {

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testNewNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::testNewNull, this.description("testNewNull"), java.lang.NullPointerException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testAdapt() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testAdapt, this.description("testAdapt"));
        }

        private SortedMapAdapterTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SortedMapAdapterTest();
        }

        @java.lang.Override
        public SortedMapAdapterTest implementation() {
