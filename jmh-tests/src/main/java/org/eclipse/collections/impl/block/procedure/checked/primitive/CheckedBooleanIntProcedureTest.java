...
public class CheckedBooleanIntProcedureTest {
    ...
    public void value() {
        ...
        Assert.assertEquals(Lists.mutable.of(PrimitiveTuples.pair(true, 1), PrimitiveTuples.pair(false, 10)), list);
    }
...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedBooleanIntProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new CheckedBooleanIntProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedBooleanIntProcedureTest> value;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedBooleanIntProcedureTest> valueWithCheckedException;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CheckedBooleanIntProcedureTest> valueWithUncheckedException;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.value = CheckedBooleanIntProcedureTest::value;
            this.payloads.valueWithCheckedException = CheckedBooleanIntProcedureTest::valueWithCheckedException;
