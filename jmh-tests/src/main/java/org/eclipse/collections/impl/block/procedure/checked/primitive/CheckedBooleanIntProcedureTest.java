...
public class CheckedBooleanIntProcedureTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_valueWithCheckedException() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::valueWithCheckedException, this.description("valueWithCheckedException"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_valueWithUncheckedException() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::valueWithUncheckedException, this.description("valueWithUncheckedException"));
        }

        private CheckedBooleanIntProcedureTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CheckedBooleanIntProcedureTest();
        }

        @java.lang.Override
        public CheckedBooleanIntProcedureTest implementation() {
