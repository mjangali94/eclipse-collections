...
public class IntLongMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private IntLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new IntLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntLongMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntLongMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntLongMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = IntLongMapFactoryTest::of;
            this.payloads.withAll = IntLongMapFactoryTest::withAll;
            this.payloads.from = IntLongMapFactoryTest::from;
        }
    }
}
