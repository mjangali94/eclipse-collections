...
/*
    ...
    public static class _Benchmark {
        ...
        private DropIteratorTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<DropIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new DropIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DropIteratorTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DropIteratorTest> remove;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DropIteratorTest> noSuchElementException;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.iterator = DropIteratorTest::iterator;
            this.payloads.remove = DropIteratorTest::remove;
