...
public class ImmutableCharSingletonBagTest extends AbstractImmutableCharBagTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.bag.immutable.primitive.AbstractImmutableCharBagTestCase._Benchmark {
        ...
        private ImmutableCharSingletonBagTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableCharSingletonBagTest();
        }

        @java.lang.Override
        public ImmutableCharSingletonBagTest implementation() {
