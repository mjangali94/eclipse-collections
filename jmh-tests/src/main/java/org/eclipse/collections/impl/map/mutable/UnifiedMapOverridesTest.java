...
public class UnifiedMapOverridesTest extends UnifiedMapTest {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.UnifiedMapTest._Benchmark {

        private UnifiedMapOverridesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnifiedMapOverridesTest();
        }

        @java.lang.Override
        public UnifiedMapOverridesTest implementation() {
