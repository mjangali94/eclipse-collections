...
public abstract class AbstractMutableBiMapValuesTestCase {
    ...
    public static class _Benchmark {
        ...
        private AbstractMutableBiMapValuesTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractMutableBiMapValuesTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> clear;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> removeFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> removeNullFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> removeAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> retainAllFromValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapValuesTestCase> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapValuesTestCase::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapValuesTestCase::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.clear = AbstractMutableBiMapValuesTestCase::clear;
            this.payloads.contains = AbstractMutableBiMapValuesTestCase::contains;
            this.payloads.containsAll = AbstractMutableBiMapValuesTestCase::containsAll;
            this.payloads.isEmpty = AbstractMutableBiMapValuesTestCase::isEmpty;
            this.payloads.size = AbstractMutableBiMapValuesTestCase::size;
            this.payloads.iterator = AbstractMutableBiMapValuesTestCase::iterator;
            this.payloads.values = AbstractMutableBiMapValuesTestCase::values;
            this.payloads.removeFromValues = AbstractMutableBiMapValuesTestCase::removeFromValues;
            this.payloads.removeNullFromValues = AbstractMutableBiMapValuesTestCase::removeNullFromValues;
            this.payloads.removeAllFromValues = AbstractMutableBiMapValuesTestCase::removeAllFromValues;
            this.payloads.retainAllFromValues = AbstractMutableBiMapValuesTestCase::retainAllFromValues;
