...
public abstract class AbstractMutableBiMapKeySetTestCase {
    ...
    public static class _Benchmark {
        ...
        private AbstractMutableBiMapKeySetTestCase instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> payload) throws java.lang.Throwable {
            this.instance = new AbstractMutableBiMapKeySetTestCase();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> removeFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> removeNullFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> removeAllFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> retainAllFromKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> clearKeySet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> keySetEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> keySetToArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AbstractMutableBiMapKeySetTestCase> serialization;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapKeySetTestCase::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(AbstractMutableBiMapKeySetTestCase::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.contains = AbstractMutableBiMapKeySetTestCase::contains;
            this.payloads.containsAll = AbstractMutableBiMapKeySetTestCase::containsAll;
            this.payloads.isEmpty = AbstractMutableBiMapKeySetTestCase::isEmpty;
            this.payloads.size = AbstractMutableBiMapKeySetTestCase::size;
            this.payloads.iterator = AbstractMutableBiMapKeySetTestCase::iterator;
            this.payloads.removeFromKeySet = AbstractMutableBiMapKeySetTestCase::removeFromKeySet;
            this.payloads.removeNullFromKeySet = AbstractMutableBiMapKeySetTestCase::removeNullFromKeySet;
            this.payloads.removeAllFromKeySet = AbstractMutableBiMapKeySetTestCase::removeAllFromKeySet;
            this.payloads.retainAllFromKeySet = AbstractMutableBiMapKeySetTestCase::retainAllFromKeySet;
            this.payloads.clearKeySet = AbstractMutableBiMapKeySetTestCase::clearKeySet;
            this.payloads.keySetEqualsAndHashCode = AbstractMutableBiMapKeySetTestCase::keySetEqualsAndHashCode;
            this.payloads.keySetToArray = AbstractMutableBiMapKeySetTestCase::keySetToArray;
