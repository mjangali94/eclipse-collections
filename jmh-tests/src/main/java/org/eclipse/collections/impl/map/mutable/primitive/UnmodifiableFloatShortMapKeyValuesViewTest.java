...
public class UnmodifiableFloatShortMapKeyValuesViewTest extends AbstractFloatShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableFloatShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableFloatShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableFloatShortMapKeyValuesViewTest implementation() {
