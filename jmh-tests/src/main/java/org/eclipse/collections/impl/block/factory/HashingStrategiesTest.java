...
public class HashingStrategiesTest {
    ...
    public void nullSafeStrategy() {
        HashingStrategy<Integer> integerHashingStrategy = HashingStrategies.nullSafeHashingStrategy(HashingStrategies.defaultStrategy());
...
/*
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> payload) throws java.lang.Throwable {
            this.instance = new HashingStrategiesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> defaultStrategy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> nullSafeStrategy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> nullSafeFromFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> identityHashingStrategy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> chainedHashingStrategy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromFunctionsTwoArgs;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromFunctionsThreeArgs;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromBooleanFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromByteFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromCharFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromDoubleFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromFloatFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromIntFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromLongFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> fromShortFunction;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<HashingStrategiesTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.defaultStrategy = HashingStrategiesTest::defaultStrategy;
            this.payloads.nullSafeStrategy = HashingStrategiesTest::nullSafeStrategy;
            this.payloads.nullSafeFromFunction = HashingStrategiesTest::nullSafeFromFunction;
            this.payloads.fromFunction = HashingStrategiesTest::fromFunction;
            this.payloads.identityHashingStrategy = HashingStrategiesTest::identityHashingStrategy;
            this.payloads.chainedHashingStrategy = HashingStrategiesTest::chainedHashingStrategy;
            this.payloads.fromFunctionsTwoArgs = HashingStrategiesTest::fromFunctionsTwoArgs;
            this.payloads.fromFunctionsThreeArgs = HashingStrategiesTest::fromFunctionsThreeArgs;
            this.payloads.fromBooleanFunction = HashingStrategiesTest::fromBooleanFunction;
            this.payloads.fromByteFunction = HashingStrategiesTest::fromByteFunction;
            this.payloads.fromCharFunction = HashingStrategiesTest::fromCharFunction;
            this.payloads.fromDoubleFunction = HashingStrategiesTest::fromDoubleFunction;
            this.payloads.fromFloatFunction = HashingStrategiesTest::fromFloatFunction;
            this.payloads.fromIntFunction = HashingStrategiesTest::fromIntFunction;
            this.payloads.fromLongFunction = HashingStrategiesTest::fromLongFunction;
            this.payloads.fromShortFunction = HashingStrategiesTest::fromShortFunction;
            this.payloads.classIsNonInstantiable = HashingStrategiesTest::classIsNonInstantiable;
        }
    }
*/
}
