...
public class UnmodifiableObjectCharMapKeyValuesViewTest extends AbstractObjectCharMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectCharMapKeyValuesViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectCharMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectCharMapKeyValuesViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectCharMapKeyValuesViewTest implementation() {
