...
/*
    ...
    public static class _Benchmark {
        ...
        private SumOfFloatProcedureTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SumOfFloatProcedureTest> payload) throws java.lang.Throwable {
            this.instance = new SumOfFloatProcedureTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SumOfFloatProcedureTest> getResult;
        }
