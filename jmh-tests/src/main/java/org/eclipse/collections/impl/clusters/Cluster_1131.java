    ...
    public static class _Benchmark {
       ...
       private org.eclipse.collections.impl.bimap.mutable.HashBiMapInverseTest._Benchmark _Benchmark_benchmark_7;
        ...
        public void benchmark_Cluster_1131() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.removeFromKeySet);
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.min);
            this._Benchmark_benchmark_7.runBenchmark(this._Benchmark_benchmark_7.payloads.removeFromValues);
            this._Benchmark_benchmark_5.runBenchmark(this._Benchmark_benchmark_5.payloads.removeFromValues);
        }
