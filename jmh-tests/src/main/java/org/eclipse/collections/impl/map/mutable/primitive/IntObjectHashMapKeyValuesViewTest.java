...
public class IntObjectHashMapKeyValuesViewTest extends AbstractIntObjectMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntObjectMapKeyValuesViewTestCase._Benchmark {
        ...
        private IntObjectHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new IntObjectHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public IntObjectHashMapKeyValuesViewTest implementation() {
