...
public class ObjectShortHashMapValuesTest extends ObjectShortHashMapValuesTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.mutable.primitive.ObjectShortHashMapValuesTestCase._Benchmark {
        ...
        private ObjectShortHashMapValuesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObjectShortHashMapValuesTest();
        }

        @java.lang.Override
        public ObjectShortHashMapValuesTest implementation() {
