...
public class CharShortMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private CharShortMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new CharShortMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<CharShortMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = CharShortMapFactoryTest::of;
            this.payloads.withAll = CharShortMapFactoryTest::withAll;
            this.payloads.from = CharShortMapFactoryTest::from;
        }
    }
}
