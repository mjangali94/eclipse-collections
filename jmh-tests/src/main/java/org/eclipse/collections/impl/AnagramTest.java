...
public class AnagramTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> payload) throws java.lang.Throwable {
            this.instance = new AnagramTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapInlined;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapEclipseCollections1;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapEclipseCollections3;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapEclipseCollections4;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapLazyIterable1;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsWithMultimapForEachMultiValue;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<AnagramTest> anagramsUsingMapGetIfAbsentPutInsteadOfGroupBy;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.anagramsWithMultimapInlined = AnagramTest::anagramsWithMultimapInlined;
            this.payloads.anagramsWithMultimapEclipseCollections1 = AnagramTest::anagramsWithMultimapEclipseCollections1;
            this.payloads.anagramsWithMultimapEclipseCollections3 = AnagramTest::anagramsWithMultimapEclipseCollections3;
            this.payloads.anagramsWithMultimapEclipseCollections4 = AnagramTest::anagramsWithMultimapEclipseCollections4;
            this.payloads.anagramsWithMultimapLazyIterable1 = AnagramTest::anagramsWithMultimapLazyIterable1;
            this.payloads.anagramsWithMultimapForEachMultiValue = AnagramTest::anagramsWithMultimapForEachMultiValue;
