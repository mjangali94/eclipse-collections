...
public class MutableEmptyPrimitiveTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MutableEmptyPrimitiveTest> payload) throws java.lang.Throwable {
            this.instance = new MutableEmptyPrimitiveTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MutableEmptyPrimitiveTest> isEmptyMutable;
        }
