...
public class ImmutableObjectFloatHashMapKeysViewTest extends AbstractObjectFloatMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectFloatMapKeysViewTestCase._Benchmark {
        ...
        private ImmutableObjectFloatHashMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableObjectFloatHashMapKeysViewTest();
        }

        @java.lang.Override
        public ImmutableObjectFloatHashMapKeysViewTest implementation() {
