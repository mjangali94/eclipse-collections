...
public class ListsTest {
    ...
    public void withAllSortedImmutable() {
        Assert.assertEquals(Lists.immutable.of(1, 5, 50, 100), Lists.immutable.withAllSorted(Lists.mutable.of(50, 5, 100, 1)));
    }
    ...
    public static class _Benchmark {
        ...
        public void benchmark_immutableWithListTest() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.immutableWithListTest);
        }
        ...
        public void benchmark_multiReaderOfInitialCapacity() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.multiReaderOfInitialCapacity);
        }

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_multiReaderWithInitialCapacity() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.multiReaderWithInitialCapacity);
        }
        ...
        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withAllSortedImmutable() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.withAllSortedImmutable);
        }

        //  @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withAllSortedImmutableWithComparator() throws java.lang.Throwable {
            this.runBenchmark(this.payloads.withAllSortedImmutableWithComparator);
        }
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> payload) throws java.lang.Throwable {
            this.instance = new ListsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> immutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> mutables;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> wrapCopy;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> immutableWithListTest;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> fixedSize;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> multiReader;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> castToList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> ofAllImmutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> ofAllMutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> ofAllFixedSizedList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> copyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> emptyList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> ofInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> withInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> multiReaderOfInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> multiReaderWithInitialCapacity;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> withNValues;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> newListWith;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> newListWithArray;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> newListWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> newListWithWithList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> withAllEmptyImmutableSame;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> withAllSortedImmutable;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> withAllSortedImmutableWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<ListsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutables = ListsTest::immutables;
            this.payloads.mutables = ListsTest::mutables;
            this.payloads.wrapCopy = ListsTest::wrapCopy;
            this.payloads.immutableWithListTest = ListsTest::immutableWithListTest;
            this.payloads.fixedSize = ListsTest::fixedSize;
            this.payloads.multiReader = ListsTest::multiReader;
            this.payloads.castToList = ListsTest::castToList;
            this.payloads.ofAllImmutableList = ListsTest::ofAllImmutableList;
            this.payloads.ofAllMutableList = ListsTest::ofAllMutableList;
            this.payloads.ofAllFixedSizedList = ListsTest::ofAllFixedSizedList;
            this.payloads.copyList = ListsTest::copyList;
            this.payloads.emptyList = ListsTest::emptyList;
            this.payloads.ofInitialCapacity = ListsTest::ofInitialCapacity;
            this.payloads.withInitialCapacity = ListsTest::withInitialCapacity;
            this.payloads.multiReaderOfInitialCapacity = ListsTest::multiReaderOfInitialCapacity;
            this.payloads.multiReaderWithInitialCapacity = ListsTest::multiReaderWithInitialCapacity;
            this.payloads.withNValues = ListsTest::withNValues;
            this.payloads.newListWith = ListsTest::newListWith;
            this.payloads.newListWithArray = ListsTest::newListWithArray;
            this.payloads.newListWithList = ListsTest::newListWithList;
            this.payloads.newListWithWithList = ListsTest::newListWithWithList;
            this.payloads.withAllEmptyImmutableSame = ListsTest::withAllEmptyImmutableSame;
            this.payloads.withAllSortedImmutable = ListsTest::withAllSortedImmutable;
            this.payloads.withAllSortedImmutableWithComparator = ListsTest::withAllSortedImmutableWithComparator;
