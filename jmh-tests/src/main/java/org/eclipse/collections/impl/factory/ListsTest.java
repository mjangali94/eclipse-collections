...
public class ListsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_withAllEmptyImmutableSame() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withAllEmptyImmutableSame, this.description("withAllEmptyImmutableSame"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withAllSortedImmutable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withAllSortedImmutable, this.description("withAllSortedImmutable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withAllSortedImmutableWithComparator() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withAllSortedImmutableWithComparator, this.description("withAllSortedImmutableWithComparator"));
        }
