...
/*
    ...
    public static class _Benchmark {
        ...
        private LongCharPairImplTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> payload) throws java.lang.Throwable {
            this.instance = new LongCharPairImplTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> testEqualsAndHashCode;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> getOne;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> getTwo;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> testToString;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<LongCharPairImplTest> compareTo;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.testEqualsAndHashCode = LongCharPairImplTest::testEqualsAndHashCode;
            this.payloads.getOne = LongCharPairImplTest::getOne;
            this.payloads.getTwo = LongCharPairImplTest::getTwo;
            this.payloads.testToString = LongCharPairImplTest::testToString;
            this.payloads.compareTo = LongCharPairImplTest::compareTo;
        }
    }
*/
}
