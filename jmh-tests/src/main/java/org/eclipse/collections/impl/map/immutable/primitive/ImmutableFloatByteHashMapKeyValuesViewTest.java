...
public class ImmutableFloatByteHashMapKeyValuesViewTest extends AbstractFloatByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractFloatByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableFloatByteHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableFloatByteHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableFloatByteHashMapKeyValuesViewTest implementation() {
