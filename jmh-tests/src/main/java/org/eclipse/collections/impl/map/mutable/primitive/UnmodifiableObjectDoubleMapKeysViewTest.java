...
public class UnmodifiableObjectDoubleMapKeysViewTest extends AbstractObjectDoubleMapKeysViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectDoubleMapKeysViewTestCase._Benchmark {
        ...
        private UnmodifiableObjectDoubleMapKeysViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnmodifiableObjectDoubleMapKeysViewTest();
        }

        @java.lang.Override
        public UnmodifiableObjectDoubleMapKeysViewTest implementation() {
