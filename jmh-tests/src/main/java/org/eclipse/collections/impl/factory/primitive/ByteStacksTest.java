...
public class ByteStacksTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_ofAllByteIterable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ofAllByteIterable, this.description("ofAllByteIterable"));
        }
        ...
        private ByteStacksTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ByteStacksTest();
        }

        @java.lang.Override
        public ByteStacksTest implementation() {
