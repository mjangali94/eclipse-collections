...
public class UnmodifiableShortObjectMapValuesTest {
    ...
    public static class _Benchmark {
        ...
        private UnmodifiableShortObjectMapValuesTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> payload) throws java.lang.Throwable {
            this.instance = new UnmodifiableShortObjectMapValuesTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> add;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> addAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> contains;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> containsAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> isEmpty;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> size;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> iterator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> values;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<UnmodifiableShortObjectMapValuesTest> valuesToArray;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.add = new se.chalmers.ju2jmh.api.ExceptionTest<>(UnmodifiableShortObjectMapValuesTest::add, java.lang.UnsupportedOperationException.class);
            this.payloads.addAll = new se.chalmers.ju2jmh.api.ExceptionTest<>(UnmodifiableShortObjectMapValuesTest::addAll, java.lang.UnsupportedOperationException.class);
            this.payloads.contains = UnmodifiableShortObjectMapValuesTest::contains;
            this.payloads.containsAll = UnmodifiableShortObjectMapValuesTest::containsAll;
            this.payloads.isEmpty = UnmodifiableShortObjectMapValuesTest::isEmpty;
            this.payloads.size = UnmodifiableShortObjectMapValuesTest::size;
            this.payloads.iterator = UnmodifiableShortObjectMapValuesTest::iterator;
            this.payloads.values = UnmodifiableShortObjectMapValuesTest::values;
            this.payloads.valuesToArray = UnmodifiableShortObjectMapValuesTest::valuesToArray;
        }
    }
}
