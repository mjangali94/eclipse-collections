...
public class ImmutableLongByteHashMapKeyValuesViewTest extends AbstractLongByteMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractLongByteMapKeyValuesViewTestCase._Benchmark {
        ...
        private ImmutableLongByteHashMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ImmutableLongByteHashMapKeyValuesViewTest();
        }

        @java.lang.Override
        public ImmutableLongByteHashMapKeyValuesViewTest implementation() {
