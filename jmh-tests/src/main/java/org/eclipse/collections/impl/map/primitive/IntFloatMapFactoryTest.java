...
public class IntFloatMapFactoryTest {
    ...
    public static class _Benchmark {
        ...
        private IntFloatMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new IntFloatMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<IntFloatMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = IntFloatMapFactoryTest::of;
            this.payloads.withAll = IntFloatMapFactoryTest::withAll;
            this.payloads.from = IntFloatMapFactoryTest::from;
        }
    }
}
