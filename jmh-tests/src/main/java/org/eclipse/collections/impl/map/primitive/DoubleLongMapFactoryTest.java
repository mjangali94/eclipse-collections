...
/*
    ...
    public static class _Benchmark {
        ...
        private DoubleLongMapFactoryTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleLongMapFactoryTest> payload) throws java.lang.Throwable {
            this.instance = new DoubleLongMapFactoryTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleLongMapFactoryTest> of;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleLongMapFactoryTest> withAll;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<DoubleLongMapFactoryTest> from;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.of = DoubleLongMapFactoryTest::of;
            this.payloads.withAll = DoubleLongMapFactoryTest::withAll;
            this.payloads.from = DoubleLongMapFactoryTest::from;
        }
    }
*/
}
