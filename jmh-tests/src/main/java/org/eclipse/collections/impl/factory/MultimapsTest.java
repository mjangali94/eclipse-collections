...
public class MultimapsTest {
    ...
    public static class _Benchmark {
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> payload) throws java.lang.Throwable {
            this.instance = new MultimapsTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableSortedSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableSortedBagMultimap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableSortedBagMultimapWithoutComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> immutableBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableList;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableSortedSet;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableBag;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableSortedBagMultimap;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> mutableSortedBagMultimapWithComparator;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<MultimapsTest> classIsNonInstantiable;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.immutableList = MultimapsTest::immutableList;
            this.payloads.immutableSet = MultimapsTest::immutableSet;
            this.payloads.immutableSortedSet = MultimapsTest::immutableSortedSet;
            this.payloads.immutableSortedBagMultimap = MultimapsTest::immutableSortedBagMultimap;
            this.payloads.immutableSortedBagMultimapWithoutComparator = MultimapsTest::immutableSortedBagMultimapWithoutComparator;
            this.payloads.immutableBag = MultimapsTest::immutableBag;
            this.payloads.mutableList = MultimapsTest::mutableList;
            this.payloads.mutableSet = MultimapsTest::mutableSet;
            this.payloads.mutableSortedSet = MultimapsTest::mutableSortedSet;
            this.payloads.mutableBag = MultimapsTest::mutableBag;
            this.payloads.mutableSortedBagMultimap = MultimapsTest::mutableSortedBagMultimap;
            this.payloads.mutableSortedBagMultimapWithComparator = MultimapsTest::mutableSortedBagMultimapWithComparator;
