...
public class SynchronizedObjectLongMapKeyValuesViewTest extends AbstractObjectLongMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractObjectLongMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedObjectLongMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedObjectLongMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedObjectLongMapKeyValuesViewTest implementation() {
