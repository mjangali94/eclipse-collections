...
public class SynchronizedIntShortMapKeyValuesViewTest extends AbstractIntShortMapKeyValuesViewTestCase {
    ...
    public static class _Benchmark extends org.eclipse.collections.impl.map.primitive.AbstractIntShortMapKeyValuesViewTestCase._Benchmark {
        ...
        private SynchronizedIntShortMapKeyValuesViewTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SynchronizedIntShortMapKeyValuesViewTest();
        }

        @java.lang.Override
        public SynchronizedIntShortMapKeyValuesViewTest implementation() {
