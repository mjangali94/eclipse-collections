...
/*
    ...
    public static class _Benchmark {
        ...
        private SingletonCharIteratorTest instance;
        ...
        private void runBenchmark(se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonCharIteratorTest> payload) throws java.lang.Throwable {
            this.instance = new SingletonCharIteratorTest();
            payload.accept(this.instance);
        }

        private static class _Payloads {

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonCharIteratorTest> hasNext;

            public se.chalmers.ju2jmh.api.ThrowingConsumer<SingletonCharIteratorTest> next;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.hasNext = SingletonCharIteratorTest::hasNext;
            this.payloads.next = SingletonCharIteratorTest::next;
        }
    }
*/
}
