...
public class MinAndMaxBlocksTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_minBlocks() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::minBlocks, this.description("minBlocks"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_minBlocksNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::minBlocksNull, this.description("minBlocksNull"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maxBlocks() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::maxBlocks, this.description("maxBlocks"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maxBlocksNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::maxBlocksNull, this.description("maxBlocksNull"));
        }

        private MinAndMaxBlocksTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new MinAndMaxBlocksTest();
        }

        @java.lang.Override
        public MinAndMaxBlocksTest implementation() {
