...
public class HashingStrategiesTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_defaultStrategy() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::defaultStrategy, this.description("defaultStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_nullSafeStrategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::nullSafeStrategy, this.description("nullSafeStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_nullSafeFromFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::nullSafeFromFunction, this.description("nullSafeFromFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromFunction, this.description("fromFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_identityHashingStrategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::identityHashingStrategy, this.description("identityHashingStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_chainedHashingStrategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::chainedHashingStrategy, this.description("chainedHashingStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromFunctionsTwoArgs() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromFunctionsTwoArgs, this.description("fromFunctionsTwoArgs"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromFunctionsThreeArgs() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromFunctionsThreeArgs, this.description("fromFunctionsThreeArgs"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromBooleanFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromBooleanFunction, this.description("fromBooleanFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromByteFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromByteFunction, this.description("fromByteFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromCharFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromCharFunction, this.description("fromCharFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromDoubleFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromDoubleFunction, this.description("fromDoubleFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromFloatFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromFloatFunction, this.description("fromFloatFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromIntFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromIntFunction, this.description("fromIntFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromLongFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromLongFunction, this.description("fromLongFunction"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromShortFunction() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromShortFunction, this.description("fromShortFunction"));
        }
        ...
        private HashingStrategiesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new HashingStrategiesTest();
        }

        @java.lang.Override
        public HashingStrategiesTest implementation() {
