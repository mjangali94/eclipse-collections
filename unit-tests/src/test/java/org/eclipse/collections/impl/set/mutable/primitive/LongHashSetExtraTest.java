...
public class LongHashSetExtraTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testManyRemoves() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::testManyRemoves, this.description("testManyRemoves"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testArrayGrowth() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testArrayGrowth, this.description("testArrayGrowth"));
        }

        private LongHashSetExtraTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LongHashSetExtraTest();
        }

        @java.lang.Override
        public LongHashSetExtraTest implementation() {
