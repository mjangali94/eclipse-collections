...
public class ByteHashSetTest extends AbstractByteSetTestCase {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_hashcode() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::hashcode, this.description("hashcode"));
        }
        ...
        public void benchmark_testEqualsContainingElements() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testEqualsContainingElements, this.description("testEqualsContainingElements"));
        }
        ...
        public void benchmark_addDuplicates() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::addDuplicates, this.description("addDuplicates"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_addRemoveAndContainsIntegrationTest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::addRemoveAndContainsIntegrationTest, this.description("addRemoveAndContainsIntegrationTest"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testToArray() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testToArray, this.description("testToArray"));
        }
        ...
        private ByteHashSetTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ByteHashSetTest();
        }

        @java.lang.Override
        public ByteHashSetTest implementation() {
